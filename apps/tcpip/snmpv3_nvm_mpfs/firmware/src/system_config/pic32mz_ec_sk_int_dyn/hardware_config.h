...
#define LED3_TRIS           (LED2_TRIS)  // Ref LED3
#define LED3_IO             (LATBbits.LATB12)
#define LED4_TRIS           (LED2_TRIS)  // Ref LED3
#define LED4_IO             (LATBbits.LATB12)
#define LED5_TRIS           (LED2_TRIS)  // Ref LED3
#define LED5_IO             (LATBbits.LATB12)
#define LED6_TRIS           (LED2_TRIS)  // Ref LED3
#define LED6_IO             (LATBbits.LATB12)
#define LED7_TRIS           (LED2_TRIS)  // Ref LED3
#define LED7_IO             (LATBbits.LATB12)
