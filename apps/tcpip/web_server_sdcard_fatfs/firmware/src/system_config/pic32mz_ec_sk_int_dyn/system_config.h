...
#define SYS_DEBUG_PORT          SYS_MODULE_UART_1
...
#define SYS_CONSOLE_PORT          SYS_MODULE_UART_1
...
#define REF_CLK_FREQ   100000000L

/*****************************************************************************
 * This define is added to activate the code logic for card detect
 *****************************************************************************/
#define DRV_SDCARD_CD_LOGIC_ACTIVE_HIGH 1
