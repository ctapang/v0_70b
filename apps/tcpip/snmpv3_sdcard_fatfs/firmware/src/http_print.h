...
TCP_SOCKET sktHTTP; 
	switch(callbackID)
	{
        ...
        case 0x0000002e:
			...
			break;
        case 0x0000002f:
			HTTPPrint_drive(connHandle);
			break;
        case 0x00000031:
			HTTPPrint_fstype(connHandle);
			break;
        case 0x00000032:
			HTTPPrint_cookiefav(connHandle);
			break;
        case 0x00000033:
			HTTPPrint_ledSelected(connHandle,0,true);
			break;
        case 0x00000034:
			HTTPPrint_ledSelected(connHandle,0,false);
			break;
		default:
