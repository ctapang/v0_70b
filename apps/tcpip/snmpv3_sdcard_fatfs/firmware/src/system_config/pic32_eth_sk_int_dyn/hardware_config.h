...
#define LED3_TRIS           (TRISDbits.TRISD6)  // Ref LED3
#define LED3_IO             (LATDbits.LATD6)
#define LED4_TRIS           (TRISDbits.TRISD6)  // Ref LED3
#define LED4_IO             (LATDbits.LATD6)
#define LED5_TRIS           (TRISDbits.TRISD6)  // Ref LED3
#define LED5_IO             (LATDbits.LATD6)
#define LED6_TRIS           (TRISDbits.TRISD6)  // Ref LED3
#define LED6_IO             (LATDbits.LATD6)
#define LED7_TRIS           (TRISDbits.TRISD6)  // Ref LED3
