...
// 	Adjust accordingly!
#define TCPIP_STORAGE_PARTITION_SIZE    (340)
#define WIFI_STORAGE_PARTITION_SIZE     (140)
const MEDIA_STORAGE_PARTITION_INFO MEDIA_STORAGE_WIFI_STORAGE_PARTITION = 
{
    "wifi_storage",							// partName
    0,										//partStartOffset
    WIFI_STORAGE_PARTITION_SIZE,			//partSize
};
const MEDIA_STORAGE_PARTITION_INFO MEDIA_STORAGE_TCPIP_STORAGE_PARTITION = 
{
    "tcpip_storage",                        // partName
    WIFI_STORAGE_PARTITION_SIZE,           // partStartOffset;
...
{
    "mpfs2",                                // partName
    WIFI_STORAGE_PARTITION_SIZE+TCPIP_STORAGE_PARTITION_SIZE, // partStartOffset;
    0x8000 - (WIFI_STORAGE_PARTITION_SIZE+TCPIP_STORAGE_PARTITION_SIZE),  // partSize; use the whole remainder of the storage
};

const MEDIA_STORAGE_PARTITION_INFO* MEDIA_STORAGE_PARTITION_TABLE[] = 
{
    &MEDIA_STORAGE_WIFI_STORAGE_PARTITION,
...
// 3 client is for mpfsupload
#define     MEDIA_STORAGE_DRV_MEDIA_CLIENTS_NO        3
