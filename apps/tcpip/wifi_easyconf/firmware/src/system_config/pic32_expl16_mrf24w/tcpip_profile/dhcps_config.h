...
#define DHCPS_IP_ADDRESS_RANGE_START		"192.168.1.100"     // Address range is starting from 100, because the from 1 to 100 is reserved. Staart address(192.168.100.1)
