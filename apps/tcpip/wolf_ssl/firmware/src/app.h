...
typedef enum
{
    /* The App is waiting for a routable IP address*/
    APP_GETTING_IP = 0,
    /* The App is opening an SSL connection*/
    APP_OPENING_SSL_CONNECTION,
    /* The app is waiting for a response to the get request*/
    APP_WAITING_RESPONSE,
    /* The app is closing the connection*/
    APP_CLOSING_CONNECTION,
    /* The test is done*/
    APP_DONE,
...
typedef struct
{
    ...
    WOLF_SSL_CONNECTION_INFO sslInfo;

    char receiveBuffer[180];
