/*******************************************************************************
  ...
  Summary:
 UDP server demo application header.

  Description:
    This file the application functions for the UDP server demo
 *******************************************************************************/
...
/*******************************************************************************
 ...
 UDP Server tasks
  ...
  Description:
 Tasks function for the UDP Server Demo.  This function waits for a UDP packet
 and then capitalizes all the letters in it, and then sends it back to the
 transmitter.
