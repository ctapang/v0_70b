...
*********************************************************************************************************
*/
xTaskHandle          DisplayDriverTask_Handle;
...
void SYS_Initialize ( void* data )
{
   ...
   xTaskCreate((pdTASK_CODE) DisplayDriverTask,
                (const signed char*)"Display Driver Task",
                DISPLAYDRIVER_TASK_STK_SIZE,
                NULL,
                DISPLAYDRIVER_TASK_PRIO,
                &DisplayDriverTask_Handle);
