...
// *****************************************************************************
/* Audio codec driver Initialization Data

  Summary:
    Defines the Audio codec driver initialization data
  ...
  Remarks:
    None.
*/
DRV_AK4953A_INIT ak4953AInitData =
{
...
void SYS_Initialize ( void* data )
{
    ...
    //Initialize Audio Codec Driver.
    drvAudioCodecObject = DRV_AK4953A_Initialize(DRV_AK4953A_INDEX_0, ( SYS_MODULE_INIT* )&ak4953AInitData );

    /* check if the object returned by the device layer is valid */
    SYS_ASSERT((SYS_MODULE_OBJ_INVALID != drvAudioCodecObject), "Invalid audio codec object");
}
