...
// *****************************************************************************
/* Function: void BSP_StartTimer(uint32_t period)

  Summary:
    Configures the match register for to obtain the desired period .
