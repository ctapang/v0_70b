...
/* This is defined in system_init.c and contains the
 * System Module Object obtained from the device layer
 * initialization routine. This value is required by
 * the device layer tasks routine.*/
