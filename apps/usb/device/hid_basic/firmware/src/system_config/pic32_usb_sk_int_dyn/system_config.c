...
const uint8_t configDescriptor1[]={
    ...
    ATTRIBUTE_DEFAULT | ATTRIBUTE_SELF_POWERED,               // Attributes, see usb_chapter_9.h
    ...
    HID_EP | EP_DIRECTION_IN,   //EndpointAddress
    ...
    0x07,
    USB_DESCRIPTOR_ENDPOINT,    //Endpoint Descriptor
    HID_EP | EP_DIRECTION_OUT,  //EndpointAddress
    USB_TRANSFER_TYPE_INTERRUPT,    //Attributes
    0x40,0x00,                  //size
    0x01                        //Interval
};
