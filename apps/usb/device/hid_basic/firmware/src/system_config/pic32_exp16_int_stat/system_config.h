/*******************************************************************************
  ...
  Description:
    ...
    application for the explorer-16, PIC32MX, interrupt-driven, static 
    configuration.
*******************************************************************************/
...
#define DRV_ADC_CONFIG_TASKS_MODE_INTERRUPT_ENABLE    true
...
#define DRV_ADC_CONFIG_INDEX                                APP_ADC_INDEX
...
/* TMR Static Index Selection
   ...
   Description
    TMR Static Index selection for the driver object reference

   Remarks:
    This index is required to make a reference to the driver object
*/

#define DRV_TMR_CONFIG_INDEX                                APP_TMR_INDEX
...
#define DRV_USART_CONFIG_TASKS_MODE_INTERRUPT_ENABLE        true
...
/* USART Static Index Selection
   ...
   Description
    This constant defines the USART index incase of static USART driver usage.

   Remarks:
    This index is required to make a reference to the driver object
*/

#define DRV_USART_CONFIG_INDEX                                APP_USART_INDEX
