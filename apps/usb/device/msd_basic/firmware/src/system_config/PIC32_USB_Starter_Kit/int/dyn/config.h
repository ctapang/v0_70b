/*******************************************************************************
  ...
  Summary:
    ...
    PIC32MX, interrupt-driven, dynamic configuration

  Description:
    This file is the ADC data logger demo application configuration header for
    the explorer-16, PIC32MX, interrupt-driven, dynamic configuration.
*******************************************************************************/
...
//#include "tmr/config/drv_tmr_config_dynamic.h"
//#include "adc/config/drv_adc_config_dynamic.h"
//#include "usart/config/drv_usart_config_dynamic.h"
...
#define DRV_ADC_CONFIG_BUILD_TYPE DRV_BUILD_TYPE_DYNAMIC
...
#define DRV_TMR_CONFIG_BUILD_TYPE DRV_BUILD_TYPE_DYNAMIC
...
#define DRV_TMR_CONFIG_NUMBER_OF_INSTANCES      1 // Number of such objects
...
#define DRV_USART_CONFIG_BUILD_TYPE DRV_BUILD_TYPE_DYNAMIC
