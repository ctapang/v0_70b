...
const uint8_t configDescriptor1[]={
    ...
    ATTRIBUTE_DEFAULT | ATTRIBUTE_SELF_POWERED,                 // Attributes, see usbdefs_std_dsc.h
...
{
    {
        ...
        USB_SPEED_FULL | USB_SPEED_HIGH,                 1,      0,              1,
                                ...
                                APP_USBMSD_FUNC_INDEX,     (void*)&msdInit,      &msdFunctionDriver
    }
