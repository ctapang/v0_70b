/*******************************************************************************
  ...
  Summary:
    MPLAB Harmony cn_interrupt application definitions.

  Description:
    This file contains the MPLAB Harmony cn_interrupt application definitions.
 *******************************************************************************/
...
#define APP_LED_BLINK_DELAY_1s     (SYS_FREQUENCY / 4)
...
/*******************************************************************************
  ...
  Description:
    This routine initializes application.  This function opens
