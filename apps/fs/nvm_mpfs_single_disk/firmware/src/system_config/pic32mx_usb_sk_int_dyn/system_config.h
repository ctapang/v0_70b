...
/* This is the max type of file system supported for this application */
#define SYS_FS_MAX_FILE_SYSTEM_TYPE     1  // MPFS

/* This is the max number of files that can be opened simultaneously */
