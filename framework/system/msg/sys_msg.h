...
typedef struct
{
    ...
    /* // Array of qukeue sizes for priorities 0,1,...SYS_MSG_MAX_PRIORITY */
    uint16_t  * nQSizes;
...
/* Function:
  ...
  Description:
    Remmoves an existing message type.
...
// *****************************************************************************
/* Function:
    SYS_OBJ_HANDLE SYS_MSB_MailboxOpen( const SYS_MSG_INSTANCE iSysMsg,
  ...
  <code>
    ...
    hMyMailbox = SYS_MSB_MailboxOpen( iSysMsg, &myCallBackFunction );
...
// *****************************************************************************
/* Function:
    void SYS_MSB_MailboxClose( SYS_OBJ_HANDLE hMailbox )

  Summary:
    Closes (destroys) a mailbox previously opened with SYS_MSB_MailboxOpen.

  Description:
    Closes (destroys) a mailbox previously opened with SYS_MSB_MailboxOpen.

  Precondition:
    hMailbox provided by call to SYS_MSB_MailboxOpen.
  ...
  <code>
    ...
    hMyMailbox = SYS_MSB_MailboxOpen( iSysMsg, &myCallBackFunction );
    SYS_MSB_MailboxClose(hMyMailbox);
  </code>
...
// *****************************************************************************
/* Function:
    void SYS_MSB_MailboxReinit( SYS_OBJ_HANDLE hMailbox,
                                SYS_MSG_RECEIVE_CALLBACK msgCallBackFunction );
  ...
  <code>
    ...
    hMyMailbox = SYS_MSB_MailboxOpen( iSysMsg, &myCallBackFunction );
    SYS_MSB_MailboxReinit(hMyMailbox,&anotherCallBackFunction );
  </code>
...
// *****************************************************************************
// *****************************************************************************
/* These functions return the version information of the sample driver */

// *****************************************************************************
/* Function:
    unsigned int SYS_MSG_VersionGet ( void )

  Summary:
    Gets the System Messaging Service version in numerical format.

  Description:
    This routine gets the System Messaging Service version. The version is
    encoded as major * 10000 + minor * 100 + patch. The stringized version can
    be obtained using SYS_MSG_VersionStrGet()
  ...
  Returns:
    Current System Messaging Service version in numerical format.

  Example:
    <code>
    unsigned int version;

    version = SYS_MSG_VersionGet();
...
// *****************************************************************************
/* Function:
    char * SYS_MSG_VersionStrGet ( void )

  Summary:
    Gets System Messaging Service version in string format.

  Description:
    This routine gets the System Messaging Service version. The version is
    returned as major.minor.path[type], where type is optional. The numerical
    version can be obtained using SYS_MSG_VersionGet()
  ...
  Returns:
    Current System Messaging Service version in the string format.

  Example:
    <code>
    char *version;

    version = SYS_MSG_VersionStrGet();
