...
// *****************************************************************************
// *****************************************************************************
// Section: Version Number Macros
// *****************************************************************************
// *****************************************************************************

// *****************************************************************************
/* System Messaging Version Macros

  Summary:
    System Messaging version information

  Description:
    These constants provide Sample driver version information. The driver
    version is
    SYS_MSG_VERSION_MAJOR.SYS_MSG_VERSION_MINOR.SYS_MSG_VERSION_PATCH.
    It is represented in SYS_MSG_VERSION as
    MAJOR *10000 + MINOR * 100 + PATCH, so as to allow comparisons.
    It is also represented in string format in SYS_MSG_VERSION_STR.
    SYS_MSG_TYPE provides the type of the release when the release is alpha
    or beta. The interfaces SYS_MSG_VersionGet() and
    SYS_MSG_VersionStrGet() provide interfaces to the access the version
    and the version string.

  Remarks:
    Modify the return value of SYS_MSG_VersionStrGet and the
    SYS_MSG_VERSION_MAJOR, SYS_MSG_VERSION_MINOR,
    SYS_MSG_VERSION_PATCH and SYS_MSG_VERSION_TYPE
*/

#define _SYS_MSG_VERSION_MAJOR         0
#define _SYS_MSG_VERSION_MINOR         2
#define _SYS_MSG_VERSION_PATCH         0
#define _SYS_MSG_VERSION_TYPE      "Alpha"
#define _SYS_MSG_VERSION_STR       "0.2.0 Alpha"
