...
/* Application Initialization Routine Pointer
  ...
  Example:
    <code>
    TBD
    called indirectly by the SYS_Initialize function.
    </code>
  ...
  Remarks:
    ...
    static style of implementation. Also in this case the appliaction should
    invoke such routinee explicitly.
*/
...
/* Modules Registration Routine Pointer
  ...
  Remarks:
    ...
    retgistration routine can call a BSP's registration routine).
*/
...
/* System Initialization Data
  ...
  Summary:
    Data structure contains pointers to the initialiation routines and data 
    required to initialize the system

  Description:
    This data structure contains pointers to the initialiation routines and 
...
typedef struct _SYS_INIT_DATA
{
    ...
    // Pointer to the modules registeration routine
...
/*******************************************************************************
  ...
  Example:
    ...
    {
        MyBoard_Initialize, // Board Init routine
        TBD
    };
