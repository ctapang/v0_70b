...
static FATFS_VOLUME_OBJECT FAFFSVolume[SYS_FS_VOLUME_NUMBER];
static
FATFS *FatFs[SYS_FS_VOLUME_NUMBER];	/* Pointer to the file system objects (logical drives) */
#else
#error Number of volumes must not be 0.
#endif

static FATFS_FILE_OBJECT FATFSFileObject[SYS_FS_MAX_FILES];
