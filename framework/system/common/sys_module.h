...
/* System Module De-initialization Routine Pointer
  ...
  Remarks:
    If the module instance has to be used again, the module's "initalize" function
...
/* System Module Tasks data
  ...
  Description:
    This structure contains pointers to module's tasks routine. A module can have 
    an array of such structures depending on number of tasks routines it supports.
...
/* System Module Interface
  ...
  Description:
    ...
    maintain their states using the reinitialize, deinitialize, and status
    routines.
