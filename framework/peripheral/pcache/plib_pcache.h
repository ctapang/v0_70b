/*******************************************************************************
  ...
  Description:
    ...
    Cache (PCACHE) Periheral Library for Microchip microcontrollers. The
...
/*******************************************************************************
  ...
  Remarks:
    At reset, the Pretch Cache module is disabled.
...
/*******************************************************************************
  ...
  Remarks:
    At reset, the Pretch Cache module is disabled and this function will return
    PLIB_PCACHE_DISABLE.
...
/*******************************************************************************
  ...
  Summary:
    Returnes true if cache line previously write-enabled by
