/**************************************************************************
  ...
  Summary:
    Real-Time Clock and Calendar (RTCC) Peripheral Libarary interface header 
...
/* Function:
  ...
  Description:
    The function writes the contents of thes bits in the specific RTCC module's
...
/* Function:
  ...
  Description:
    ...
    register. Please refer to the specific device data sheet for the exact s
    equence of digits.
...
/* Function :  PLIB_RTCC_ExistsSynchronization( RTCC_MODULE_ID index )
  ...
  Description:
    ...
    RTCC module. When this interface returns true, this function is supported
    on the device:
    - PLIB_RTCC_ValueRegistersReadSyncBit
...
//******************************************************************************
/* Function :  PLIB_RTCC_ExistsAlarmSyncronization( RTCC_MODULE_ID index )
...
bool PLIB_RTCC_ExistsAlarmSyncronization( RTCC_MODULE_ID index );
