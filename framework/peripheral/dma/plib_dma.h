/*******************************************************************************
  ...
  Description:
    ...
    Access (DMA) Periheral Library for Microchip microcontrollers.  The
...
/*******************************************************************************
  ...
  Summary:
    Returns the status of the specified collison type for the specified channel.

  Description:
    This function returns the status of the specified collison type for the specified channel.
...
/* Function:
  ...
  Remarks:
	This function implements an operation of the ChannelXChainEnbl feature.
	This feature may not be available on all devices.  Please refer to the
	specfic device data sheet to determine availability or use the the
	PLIB_DMA_ExistsChannelXChainEnbl function in your application to determine
	whether this feature is available.
*/
...
/* Function:
  ...
  Description:
    This function enables the the specified DMA channel trigger.
...
/* Function:
  ...
  Example:
    <code>
	//This code is for PIC24F family
...
/* Function:
  ...
  Description:
	...
	(Transfer mode and operating mode are used interchangably.)
...
/* Function:
  ...
  Summary:
    Assignes the CRC to the specified DMA channel.
...
/* Function:
  ...
  Summary:
    Selects the bit order for checksum caluculation.

  Description:
    This function selects the bit order for checksum caluculation.

  Precondition:
    None.

  Parameters:
    bitOrder - Specifies the bit order for CRC caluculation
