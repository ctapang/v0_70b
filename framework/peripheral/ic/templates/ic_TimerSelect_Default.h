...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _IC_TIMER_SELECT_VREG(index)

  MASKs: 
    _IC_TIMER_SELECT_MASK(index)

  POSs: 
    _IC_TIMER_SELECT_POS(index)

  LENs: 
    _IC_TIMER_SELECT_LEN(index)
...
{
    _SFR_BIT_WRITE(_IC_TIMER_SELECT_VREG(index),
				_IC_TIMER_SELECT_POS(index), tmr);
}
