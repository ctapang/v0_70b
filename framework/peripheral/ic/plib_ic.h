...
/* Function:
  ...
  Summary:
    Selects the 16-bit timer source for the IC module.
...
*/
 void PLIB_IC_TimerSelect( IC_MODULE_ID index, IC_TIMERS tmr );
  ...
  // *****************************************************************************
/* Function:
    void PLIB_IC_ClockSourceSelect(IC_MODULE_ID index, IC_CLOCK_SOURCES src)

  Summary:
    Selects the clock source for the IC module.

  Description:
    This function selects the clock source for the IC module.
  ...
  Parameters:
    index      - Identifies the desired IC module
    src        - Identifies the clock source
  ...
  Example:
    <code>
    #define MY_IC_ID IC_ID_1
    // Clock source of Timer2 is selected as clock source for Input Capture module
    PLIB_IC_ClockSourceSelect(MY_IC_ID,IC_CLOCK_SOURCE_TIMER2);
    </code>

  Remarks:
    This feature may not be available on all devices. Please refer to the
    specific device data sheet to determine availability or use
    PLIB_IC_ExistsClockSource in your application to determine
    whether this feature is available.
*/
 void PLIB_IC_ClockSourceSelect(IC_MODULE_ID index, IC_CLOCK_SOURCES src);
...
//******************************************************************************
/* Function:
    void PLIB_IC_SyncModeSelect(IC_MODULE_ID index, IC_SYNC_MODES syncMode)

  Summary:
   Selects the synchronization mode for Input Capture module.

  Description:
   This function selects the synchronization mode for the IC module. The Synchronous
   or Asynchronous mode of operation can be selected for the IC module timer.
  ...
  Parameters:
    index      - Identifies the desired IC module
    syncMode   - Identifies the mode (Synchronous or Asynchronous)
  ...
  Example:
    <code>
    #define MY_IC_ID IC_ID_1
    // External input triggers Input Capture module asynchronously
    PLIB_IC_SyncModeSelect(MY_IC_ID,IC_MODE_ASYNC);
    </code>

  Remarks:
    This feature may not be available on all devices. Please refer to the
    specific device data sheet to determine availability or use
    PLIB_IC_ExistsSyncMode in your application to determine
    whether this feature is available.
*/
 void PLIB_IC_SyncModeSelect(IC_MODULE_ID index, IC_SYNC_MODES syncMode);
...
//********************************************************************************
/* Function:
    void PLIB_IC_SyncModeInputSelect(IC_MODULE_ID index, IC_SYNC_MODE_INPUTS input)
  ...
  Description:
   This function selects the input source for synchronous or asynchronous (triggered)
  ...
  Parameters:
    index      - Identifies the desired IC module
    input      - Identifies the input source
  Returns:
    None.
  ...
  Example:
    ...
    #define MY_IC_ID IC_ID_1
    //
    PLIB_IC_SyncModeInputSelect(MY_IC_ID,IC_SYNC_MODE_INPUT_OC1);
    </code>

  Remarks:
    This feature may not be available on all devices. Please refer to the
    specific device data sheet to determine availability or use
    PLIB_IC_ExistsSyncModeInput in your application to determine
    whether this feature is available.
*/
 void PLIB_IC_SyncModeInputSelect(IC_MODULE_ID index, IC_SYNC_MODE_INPUTS input);
...
/* Function:
  ...
  Description:
    The IC module can be configured to generate interrupts depending upon the the
...
/* Function:
  ...
  Returns:
   bool         - true  - An overflow of the input capture buffer has occurred
...
/* Function:
  ...
  Returns:
   bool         - true  - The input capture buffer is empty
...
bool PLIB_IC_BufferIsEmpty(IC_MODULE_ID index);
 ...
 // *****************************************************************************
/* Function:
   bool PLIB_IC_TimerIsTriggered(IC_MODULE_ID index)

  Summary:
  Checks whether or not the input capture timer has been triggered.

  Description:
  This function checks whether or not the input capture timer has been triggered.
  This function returns 'true' if the IC timer is triggered and running and returns
  'false' if the IC timer is cleared and stopped.
  ...
  Returns:
   bool         - true  - The IC timer is triggered and running
                - false - The IC timer is stopped and held in clear

  Example:
  <code>
    #define MY_IC_ID IC_ID_1
    if(!PLIB_IC_TimerIsTriggered(MY_IC_ID))
    {
        // Do some operation
    };
    </code>
  ...
  Remarks:
    This feature may not be available on all devices. Please refer to the
    specific device data sheet to determine availability or use
    PLIB_IC_ExistsTimerTriggered in your application to determine
    whether this feature is available.
...
//******************************************************************************
/* Function :  PLIB_IC_ExistsEnable( IC_MODULE_ID index )

  Summary:
    Identifies whether the EnableControl feature exists on the IC module.

  Description:
    This function identifies whether the EnableControl feature is available on the IC module.
...
//******************************************************************************
/* Function :  PLIB_IC_ExistsAlternateClock( IC_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_IC_ExistsStopInIdle( IC_MODULE_ID index )

  Summary:
    Identifies whether the StopInIdle feature exists on the IC module.

  Description:
    This function identifies whether the StopInIdle feature is available on the IC module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_IC_ExistsEdgeCapture( IC_MODULE_ID index )

  Summary:
    Identifies whether the EdgeCapture feature exists on the IC module.

  Description:
    This function identifies whether the EdgeCapture feature is available on the IC module.
...
//******************************************************************************
/* Function :  PLIB_IC_ExistsEventsPerInterruptSelect( IC_MODULE_ID index )

  Summary:
    Identifies whether the EventsPerInterruptSelect feature exists on the IC module.

  Description:
    This function identifies whether the EventsPerInterruptSelect feature is available on the IC module.
...
//******************************************************************************
/* Function :  PLIB_IC_ExistsBufferValue( IC_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_IC_ExistsBufferIsEmptyStatus( IC_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_IC_ExistsBufferOverflowStatus( IC_MODULE_ID index )

  Summary:
    Identifies whether the BufferOverflowStatus feature exists on the IC module.

  Description:
    This function identifies whether the BufferOverflowStatus feature is available on the IC module.
    When this function returns true, this function is supported on the device:
...
//******************************************************************************
/* Function :  PLIB_IC_ExistsCaptureMode( IC_MODULE_ID index )

  Summary:
    Identifies whether the CaptureMode feature exists on the IC module.

  Description:
    This function identifies whether the CaptureMode feature is available on the IC module.
    When this function returns true, this function is supported on the device:
    - PLIB_IC_ModeSelect
...
//******************************************************************************
/* Function :  PLIB_IC_ExistsBufferSize( IC_MODULE_ID index )

  Summary:
    Identifies whether the BufferSize feature exists on the IC module.

  Description:
    This function identifies whether the BufferSize feature is available on the IC module.
    When this function returns true, this function is supported on the device:
...
//******************************************************************************
/* Function :  PLIB_IC_ExistsTimerSelect( IC_MODULE_ID index )

  Summary:
    Identifies whether the TimerSelect feature exists on the IC module.

  Description:
    This function identifies whether the TimerSelect feature is available on the IC module.
    When this function returns true, this function is supported on the device:
    - PLIB_IC_TimerSelect
...
//******************************************************************************
/* Function :  PLIB_IC_ExistsClockSource( IC_MODULE_ID index )

  Summary:
    Identifies whether the ClockSource feature exists on the IC module.

  Description:
    This function identifies whether the ClockSource feature is available on the IC module.
    When this function returns true, this function is supported on the device:
  ...
  Returns:
    - true   - If the ClockSource feature is supported on the device
    - false  - If the ClockSource feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_IC_ExistsClockSource( IC_MODULE_ID index );


//******************************************************************************
/* Function :  PLIB_IC_ExistsSyncMode( IC_MODULE_ID index )

  Summary:
    Identifies whether the SyncMode feature exists on the IC module.

  Description:
    This function identifies whether the SyncMode feature is available on the IC module.
    When this function returns true, tthis function is supported on the device:
  ...
  Returns:
    - true   - If the SyncMode feature is supported on the device
    - false  - If the SyncMode feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_IC_ExistsSyncMode( IC_MODULE_ID index );


//******************************************************************************
/* Function :  PLIB_IC_ExistsSyncModeInput( IC_MODULE_ID index )

  Summary:
    Identifies whether the SyncModeInput feature exists on the IC module.

  Description:
    This function identifies whether the SyncModeInput feature is available on the IC module.
    When this function returns true, this function is supported on the device:
  ...
  Returns:
    - true   - If the SyncModeInput feature is supported on the device
    - false  - If the SyncModeInput feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_IC_ExistsSyncModeInput( IC_MODULE_ID index );


//******************************************************************************
/* Function :  PLIB_IC_ExistsTimerTriggered( IC_MODULE_ID index )

  Summary:
    Identifies whether the TimerTriggered feature exists on the IC module.

  Description:
    This function identifies whether the TimerTriggered feature is available on the IC module.
    When this function returns true, this function is supported on the device:
...
bool PLIB_IC_ExistsTimerTriggered( IC_MODULE_ID index );
