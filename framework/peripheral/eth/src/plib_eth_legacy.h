...
#ifndef _PLIB_ETH_LEGACY_H_
#define _PLIB_ETH_LEGACY_H_
...
/*******************************************************************************
  ...
  Remarks:
    ...
    - void PLIB_ETH_RxFiltersSet (ETH_MODULE_ID index, ETH_RX_FILTERS rxFilters )
    replaces the legacy "Ethernet Controller Library" function:
    - void EthRxFiltersSet(ETH_RX_FILTERS rxFilters)
 *****************************************************************************/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    - void PLIB_ETH_RxFiltersClr (ETH_MODULE_ID index, ETH_RX_FILTERS rxFilters )
    replaces the legacy "Ethernet Controller Library" function:
    - void EthRxFiltersClr(ETH_RX_FILTERS rxFilters)>
 *****************************************************************************/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    - void PLIB_ETH_RxFiltersWrite ( ETH_MODULE_ID index, ETH_RX_FILTERS rxFilters )
    replaces the legacy "Ethernet Controller Library" function:
    - void EthRxFiltersWrite(ETH_RX_FILTERS rxFilters)
 *****************************************************************************/
...
/*******************************************************************************
  ...
  Remarks:
    Please note,
    - void PLIB_ETH_RxFiltersPMSet( ETH_MODULE_ID index, ETH_PMATCH_MODE mode, uint64_t matchMask, unsigned int matchOffs, unsigned int matchChecksum )
    replaces the legacy "Ethernet Controller Library" function:
    - void EthRxFiltersPMSet(ETH_PMATCH_MODE mode,unsigned long long matchMask,unsigned int matchOffs,unsigned int matchChecksum)
 *****************************************************************************/
...
/*******************************************************************************
  ...
  Parameters:
    index    - Identifier for the device instance.
    eEvents  - Events with the significance described in the ETH_LEGACY_EVENTS definition.
...
/*******************************************************************************
  ...
  Returns:
    index   - Identifier for the device instance.
    eEvents - events with the significance described in the ETH_LEGACY_EVENTS
    definition.
...
/*******************************************************************************
  ...
  Returns:
    Events with the significance described in the ETH_LEGACY_EVENTS definition.
...
/****************************************************************************
  ...
  Note:            - This function should be part of the initialization process and shoult NOT be called when the rx process is active!
    ...
    - ETH_RESULT_CODE PLIB_ETH_RxSetBufferSize(ETH_MODULE_ID index, int rxBuffSize)
    replaces the legacy "Ethernet Controller Library" function:
    - ETH_RESULT_CODE EthRxSetBufferSize(int rxBuffSize)
 *****************************************************************************/
