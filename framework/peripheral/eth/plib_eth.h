...
/* ETH Module Interrupt Mask
  ...
  Remarks:
    See also ETH_LEGACY_EVENTS in plib_eth_legacy.h.
*/
...
/* Function:
  ...
  Returns:
    ...
    - false - Ethernet module Autmoatic Flow Control is disabled
...
/* Function:
  ...
  Description:
    ...
    The software controlled RX Buffer Full Wmark Pointer is compared
...
/* Function:
  ...
  Description:
     This function returns a true if any of the specified interupt sources are 
     enabled.
...
/* Function:
  ...
  Description:
    This function gets the value of the the receive packet buffer count.
...
/* Function:
  ...
  Summary:
    Gets the the Ethernet receive logic busy status.
...
/* Function:
  ...
  Summary:
    Enables the EMAC reset receive funtion logic.
...
/* Function:
  ...
  Summary:
    Disables the EMAC reset receive funtion logic.

  Description:
    This function disables the EMAC reset receive funtion logic. The reset receive 
...
/* Function:
  ...
  Summary:
    Enables the the tansmission Pause frames.

  Description:
    This function enables the tansmission Pause frames. The Pause frames are 
...
/* Function:
  ...
  Summary:
    Disables EMAC back pressure/no backo-ff.

  Description:
    This function disables EMAC back pressure/no back-off. The EMAC will back-off 
    when there is backpressure and collisions occur.
...
/* Function:
  ...
  Summary:
    Gets the EMAC back pressure/no back-off enable status.

  Description:
    This function gets the EMAC back pressure/no back-off enable status.
...
/* Function:
  ...
  Summary:
    Enables the EMAC full deuplex operation.
...
/* Function:
  ...
  Summary:
    Disables the EMAC full duplex operatio.
...
/* Function:
  ...
  Description:
    ...
    pause auanta from 64 byte-times to 1 byte-time.
...
/* Function:
  ...
  Returns:
    ...
    - false - The MII Management module link fail has not occured
