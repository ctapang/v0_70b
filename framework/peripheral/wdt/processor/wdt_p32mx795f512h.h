...
#ifndef _WDT_P32MX795F512H_H
#define _WDT_P32MX795F512H_H
...
INLINE_API bool _PLIB_UNSUPPORTED PLIB_WDT_ExistsWindowEnable(WDT_MODULE_ID index)
{
    switch (index) {
        case WDT_ID_0 :
...
INLINE_API void _PLIB_UNSUPPORTED PLIB_WDT_WindowEnable(WDT_MODULE_ID index)
{
    switch (index) {
        case WDT_ID_0 :
...
INLINE_API void _PLIB_UNSUPPORTED PLIB_WDT_WindowDisable(WDT_MODULE_ID index)
{
    switch (index) {
        case WDT_ID_0 :
