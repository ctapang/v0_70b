...
INLINE SFR_TYPE* _WDT_TIMER_CLEAR_KEY_VREG(WDT_MODULE_ID i)
{
    switch (i) {
        case WDT_ID_0 :
            return &WDTCON;
...
INLINE SFR_DATA _WDT_TIMER_CLEAR_KEY_MASK(WDT_MODULE_ID i)
{
    switch (i) {
        case WDT_ID_0 :
...
INLINE SFR_DATA _WDT_TIMER_CLEAR_KEY_POS(WDT_MODULE_ID i)
{
    switch (i) {
        case WDT_ID_0 :
...
INLINE SFR_DATA _WDT_TIMER_CLEAR_KEY_LEN(WDT_MODULE_ID i)
{
    switch (i) {
        case WDT_ID_0 :
...
#include "../templates/wdt_TimerClear_PIC32MZ.h"
...
INLINE_API bool PLIB_WDT_ExistsTimerClear(WDT_MODULE_ID index)
{
    switch (index) {
        case WDT_ID_0 :
            return WDT_ExistsTimerClear_PIC32MZ(index);
        case WDT_NUMBER_OF_MODULES :
        default :
            return (bool)0;
    }
