/*******************************************************************************
  WDT Peripheral Library Interface Header
...
//******************************************************************************
/* Function:
    unsigned char PLIB_WDT_PostscalarValueGet ( WDT_MODULE_ID index )

  Summary:
    Returns the WDT postscalar value.

  Description:
    This function returns the WDT postscalar value. The value will correspond to 
    a division factor.
  ...
  Example:
    ...
    PLIB_WDT_Enable ( WDT_ID_0 );
    value = PLIB_WDT_PostscalarValueGet ( WDT_ID_0 );
    </code>
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the
    specific device data sheet to determine availability or use
    PLIB_WDT_ExistsPostscalarValue in your application to determine whether
    this feature is available.

*/

char PLIB_WDT_PostscalarValueGet ( WDT_MODULE_ID index );
...
//******************************************************************************
/* Function :  PLIB_WDT_ExistsEnableControl( WDT_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_WDT_ExistsWindowEnable( WDT_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_WDT_ExistsTimerClear( WDT_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_WDT_ExistsPostscalarValue( WDT_MODULE_ID index )

  Summary:
    Identifies whether the PostscalarValue feature exists on the WDT module.

  Description:
    This function identifies whether the PostscalarValue feature is available 
  ...
  Returns:
    - true   - The PostscalarValue feature is supported on the device
    - false  - The PostscalarValue feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_WDT_ExistsPostscalarValue( WDT_MODULE_ID index );
