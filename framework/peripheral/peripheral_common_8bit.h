/*******************************************************************************
  Peripheral Library specific for 8 bit parts
  ...
  Summary:
    This file defines the 8 bit specific macros and definitions used by the peripheral
...
#ifndef _PLIB_COMMON_8BIT_H
#define _PLIB_COMMON_8BIT_H
...
/* SFR_TYPE datatype
  ...
  Summary:
    Defines the type for SFR on the 8 bit parts

  Description:
    This type is specific to the SFR type in the 8 bit parts.

*/

typedef volatile uint8_t SFR_TYPE;
...
/* SFR_DATA datatype
  ...
  Summary:
    Defines the type for SFR data on the 8 bit parts

  Description:
    This type is specific to the SFR data in the 8 bit parts.

*/

typedef uint8_t SFR_DATA;
...
#endif /* End of File _PLIB_COMMON_8BIT_H */
