...
INLINE_API bool _PLIB_UNSUPPORTED PLIB_PMP_ExistsDataTransferSize(PMP_MODULE_ID index)
{
    switch (index) {
        case PMP_ID_0 :
...
INLINE_API void _PLIB_UNSUPPORTED PLIB_PMP_DataSizeSelect(PMP_MODULE_ID index, PMP_DATA_SIZE size)
{
    switch (index) {
        case PMP_ID_0 :
