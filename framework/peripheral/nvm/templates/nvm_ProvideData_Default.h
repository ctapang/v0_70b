...
//******************************************************************************
/* Function :  NVM_EEPROMProvideData_Default

  Summary:
    Implements Default variant of PLIB_NVM_EEPROMProvideData 

  Description:
    This template implements the Default variant of the PLIB_NVM_EEPROMProvideData function.
*/

PLIB_TEMPLATE void NVM_EEPROMProvideData_Default( NVM_MODULE_ID index , uint32_t data )
{
    _SFR_WRITE(_NVM_PROVIDE_DATA_VREG(index), data);
}
