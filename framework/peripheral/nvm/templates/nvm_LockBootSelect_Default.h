...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _NVM_LOCK_BOOT_MEM_VREG(index)

  MASKs: 
    _NVM_LOCK_BOOT_MEM_MASK(index)

  POSs: 
    _NVM_LOCK_BOOT_MEM_POS(index)

  LENs: 
    _NVM_LOCK_BOOT_MEM_LEN(index)
...
{
    /* TODO, for now, return "false" to avoid warnings  */
    return false;
}
