...
//******************************************************************************
/* Function :  NVM_EEPROMAddressToModify_Default

  Summary:
    Implements Default variant of PLIB_NVM_EEPROMAddressToModify 

  Description:
    This template implements the Default variant of the PLIB_NVM_EEPROMAddressToModify function.
*/

PLIB_TEMPLATE void NVM_EEPROMAddressToModify_Default( NVM_MODULE_ID index , uint32_t address )
{
    _SFR_WRITE( _NVM_ADDRESS_MODIFY_CONTROL_VREG( index ), address );
}
