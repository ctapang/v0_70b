...
PLIB_TEMPLATE RESET_REASON RESET_ReasonGet_MZ( RESET_MODULE_ID index )
{
        ...
        return((_SFR_READ(_RESET_RESET_REASON_STATUS_EXTR_VREG(index)))& (~_RESET_RESET_PRIMARY_CONFIG_REG_READ_ERROR_MASK(index))
		& (~_RESET_SLEEP_STATUS_MASK(index)) & (~_RESET_IDLE_STATUS_MASK(index)) & (~_RESET_RESET_BOTH_CONFIG_REG_READ_ERROR_MASK(index)));
}
