...
{
    return((_SFR_READ(_RESET_RESET_PRIMARY_CONFIG_REG_READ_ERROR_VREG(index))) & (_RESET_RESET_PRIMARY_CONFIG_REG_READ_ERROR_MASK(index))& (_RESET_RESET_BOTH_CONFIG_REG_READ_ERROR_MASK(index)));
}
