...
// DOM-IGNORE-BEGIN
/*******************************************************************************
Copyright © 2010, 2011, 2012, 2013 released Microchip Technology Inc.  All rights reserved.
...
/*******************************************************************************
  ...
  Remarks:
    ...
    PLIB_BMX_ExistsArbitrationMode in your application to
...
/*******************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the 
    specific device data sheet to determine availability or use 
    PLIB_BMX_ExistsDataRamWaitState in your application to
    to automatically determine whether this feature is available.
*/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the 
    specific device data sheet to determine availability or use 
    PLIB_BMX_ExistsProgramFlashMemoryCacheDma in your application to
    to automatically determine whether this feature is available.
*/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the 
    specific device data sheet to determine availability or use 
    PLIB_BMX_ExistsBusExceptionICD in your application to
    to automatically determine whether this feature is available.
*/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the 
    specific device data sheet to determine availability or use 
    PLIB_BMX_ExistsBusExceptionIXI in your application to
    to automatically determine whether this feature is available.
*/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the 
    specific device data sheet to determine availability or use 
    PLIB_BMX_ExistsBusExceptionDMA in your application to
    to automatically determine whether this feature is available.
*/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the 
    specific device data sheet to determine availability or use 
    PLIB_BMX_ExistsBusExceptionData in your application to
    to automatically determine whether this feature is available.
*/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the 
    specific device data sheet to determine availability or use 
    PLIB_BMX_ExistsBusExceptionInstruction in your application to
    to automatically determine whether this feature is available.
*/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the 
    specific device data sheet to determine availability or use 
    PLIB_BMX_ExistsProgramFlashPartition in your application to
    to automatically determine whether this feature is available.
*/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the 
    specific device data sheet to determine availability or use 
    PLIB_BMX_ExistsDataRAMPartition in your application to
    to automatically determine whether this feature is available.
*/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the 
    specific device data sheet to determine availability or use 
    PLIB_BMX_ExistsProgramFlashMemorySize in your application to
    to automatically determine whether this feature is available.
*/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the 
    specific device data sheet to determine availability or use 
    PLIB_BMX_ExistsDataRAMSize in your application to
    to automatically determine whether this feature is available.
*/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices. Please refer to the 
    specific device data sheet to determine availability or use 
    PLIB_BMX_ExistsProgramFlashBootSize in your application to
    to automatically determine whether this feature is available.
*/
...
/* Function :  PLIB_BMX_ExistsBusExceptionICD( BMX_MODULE_ID index )
  ...
  Returns:
                    ...
                    - false = TheWhen BusExceptionICD feature is not supported on the device
