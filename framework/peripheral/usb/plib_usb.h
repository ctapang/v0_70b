/*******************************************************************************
  ...
  Summary:
    USB PLIB Interface Header for common definitions
...
/* USB OTG Interrupts Enumeration
  ...
  Remarks:
    Not applicable on PIC18 devices or if the USB OTG module is not enabled.
*/
...
typedef enum
{
    ...
    // One millescond timer has expired
...
// *****************************************************************************
/* Enumeration of USB Ping-Pong Modes for PIC18 and PIC24F

  Summary:
    Supports the four modes of ping-pong buffering for PIC18 and PIC24F devices.

  Description:
    This data type supports the four modes of ping-pong buffering for PIC18 and 
    PIC24F devices.

  Remarks:
    For PIC18 and PIC24F devices only.
*/
...
/* Enumeration of Pull-Up and Pull-Down Resistors for OTG
  ...
  Remarks:
    Not applicable for PIC18 devices.
*/
...
/* Function:
  ...
  Remarks:
    Not applicable for PIC18 devices, since USB Host functionality is not available 
    on PIC18 devices.
...
/* Function:
  ...
  Example:
  <code>
#if ( defined(__PIC24E__) || defined(__dsPIC33E__) || defined(__PIC32MX__) )
  ...
  Remarks:
    For PIC24/dsPIC33 and PIC32 devices, the USB module must be in Device mode
...
/* Function:
  ...
  Remarks:
    Not valid on PIC18 devices until a valid clock source is provided to the 
    USB module.
...
/* Function:
  ...
  Remarks:
    For PIC18 devices, use only before the USB module is enabled to select 
    low speed. In addition, an input clock of 6 MHz instead of 48 MHz is required.

    For all others devices: Host mode only.
...
/* Function:
  ...
  Remarks:
    This feature is not available on PIC18, PIC24, and dsPIC33 devices.
...
/* Function:
  ...
  Remarks:
    Not needed on PIC18 devices, since only UPB_OPMODE_DEVICE is supported 
    and there are no other operating modes. Use USB_OPMODE_NONE to disable 
...
/* Function:
  ...
  Remarks:
    For PIC18F and PIC24F devices only.
...
/* Function:
  ...
  Remarks:
    Not available on PIC18, dsPIC or PIC24 devices.
...
/* Function:
  ...
  Remarks:
    Always set to 0x400 for PIC18 devices. Must be set for dsPIC33E/PIC24E,
    PIC24F, and PIC32 devices using PLIB_USB_BDTBaseAddressSet.
...
/* Function:
  ...
  Summary:
    Sets the base address for the Buffer Descriptor Table for PIC24 and PIC32 
    devices.

  Description:
    This function sets the base address for the Buffer Descriptor Table. This 
    function is only available on PIC24 and PIC32 devices.
  ...
  Remarks:
    Available on dsPIC33E/PIC24E, PIC24F, and PIC32. For PIC18 devices the address 
    is fixed at 0x400. The address of the Buffer Descriptor Table must be 
    512 byte-aligned.
    This feature may not be available on all devices. Please refer to the specific 
	device data sheet to determine availability or use PLIB_USB_ExistsBDTBaseAddress in your 
	application to determine whether this feature is available.		
...
/* Function:
  ...
  Remarks:
    Host mode and U1EP0 only. Not applicable for PIC18 devices, since USB Host 
    functionality is not available on PIC18 devices.
    This feature may not be available on all devices. Please refer to the specific 
...
/*  Function:
  ...
  Remarks:
    Host/OTG only. Not applicable for PIC18 devices, since USB Host and OTG
    functionality is not available on PIC18 devices.
    This feature may not be available on all devices. Please refer to the specific 
...
/* Function:
  ...
  Remarks:
    Host/OTG only. Not applicable for PIC18 devices, since USB Host or OTG 
    functionality is not available on PIC18 devices.
    This feature may not be available on all devices. Please refer to the specific 
	device data sheet to determine availability or use PLIB_USB_ExistsEP0NAKRetry in your 
	application to determine whether this feature is available.		
...
/* Function:
  ...
  Example:
  <code>
    // This clears up the endpoint 0 atrributes and thus disables
    // the endpoints
...
/* Function:
  ...
  Example:
  <code>
    // This function disbles the TX direction of endpoint 1
...
/* Function:
  ...
  Remarks:
    Not valid if PIC18 or PIC24F endpoint does not have ping-pong buffering enabled.
    This feature may not be available on all devices. Please refer to the specific 
...
/* Function:
  ...
  Remarks:
    Not applicable for PIC18 devices since PIC18 devices do not support Host mode.
    This feature may not be available on all devices. Please refer to the specific 
...
/* Function:
  ...
  Description:
    This functin returns the Start-of-Frame (SOF) Count bits. (Value represents 
...
/* Function:
  ...
  Summary:
    Disables reset signalling on the USB bus.

  Description:
    This function disables reset signalling on the USB bus.
  ...
  Remarks:
    Not applicable for PIC18, since USB Host functionality is Not available on PIC18 devices.
    This feature may not be available on all devices. Please refer to the specific 
...
/* Function:
  ...
  Summary:
    Enables reset signalling on the USB bus.

  Description:
    This function enables reset signalling on the USB bus.
...
/* Function:
  ...
  Description:
    This function enables resume signalling. Resume allows the peripheral to 
...
/* Function:
  ...
  Remarks:
    Not available on PIC18 or PIC32 devices.
    This feature may not be available on all devices. Please refer to the specific 
...
/* Function:
  ...
  Description:
    This function diables the pull-up on the VBUS pin.
...
/* Function:
  ...
  Returns:
    Returns a logically ORed bit map of active error interutp flags.
...
/* Function:
  ...
  Description:
    This functoin returns a logically ORed bit map of active general USB interrupt
    flags.
  ...
  <code>
    ...
    {
        // Device received reset signalling
    }
  </code>
...
/* Function:
  ...
  Summary:
    Disables an endpoint's abililty to process IN tokens.
