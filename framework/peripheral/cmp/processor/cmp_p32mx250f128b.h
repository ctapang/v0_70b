...
typedef enum {
    ...
    CMP_CVREF_VOLTAGE_SOURCE_INTERNAL = 0x00,
...
} CMP_CVREF_BANDGAP_SELECT;INLINE SFR_TYPE* _CMP_CMP_ENABLE_CONTROL_VREG(CMP_MODULE_ID i)
{
    switch (i) {
        case CMP_ID_1 :
            return &CM1CON;
