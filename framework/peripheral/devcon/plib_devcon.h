...
/* Alternate Clock Targets Enumeration
  ...
  Description:
    Selects Input Capture (IC) or Output Compare (OC) for enabling/disabling alternate clock
...
/* Function:
  ...
  Parameters:
    index - Always DEVCON_ID
    registersToLock - element from DEVCON_REGISTER_SET, which can be OR'd together
...
/* Function:
  ...
  Remarks:
    The feature is not supported on all devices.  Check your device's data sheet.
    Peripherals can be OR'd together.
*/
...
//******************************************************************************
/* Function :  PLIB_DEVCON_ExistsArbitrationPriority( DEVCON_MODULE_ID index )

  Summary:
    Identifies whether the ArbitrationPriority feature exists on the DEVCON module

  Description:
    This function identifies whether the ArbitrationPriority feature is available on the DEVCON module.
    When this function returns true, these functions are supported on the device:
    - PLIB_DEVCON_ArbitrationPrioritySet
    - PLIB_DEVCON_ArbitrationPriorityGet
  ...
  Returns:
    - true   - The ArbitrationPriority feature is supported on the device
    - false  - The ArbitrationPriority feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_DEVCON_ExistsArbitrationPriority( DEVCON_MODULE_ID index );
...
/* Function :  PLIB_DEVCON_ExistsAlternateClock( DEVCON_MODULE_ID index )
  ...
  Description:
    This function identifies whether the AlternateClock feature is available on the DEVCON module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DEVCON_ExistsDeviceRegsLockUnlock( DEVCON_MODULE_ID index )
  ...
  Description:
    This function identifies whether the DeviceRegsLockUnlock feature is available on the DEVCON module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DEVCON_ExistsUSB_PHY_SleepModeSet( DEVCON_MODULE_ID index )
  ...
  Description:
    This function identifies whether the USB_PHY_SleepModeSet feature is available on the DEVCON module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DEVCON_ExistsECCModes( DEVCON_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ECCModes feature is available on the DEVCON module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DEVCON_ExistsJTAGEnable( DEVCON_MODULE_ID index )
  ...
  Description:
    This function identifies whether the JTAGEnable feature is available on the DEVCON module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DEVCON_ExistsTraceOutput( DEVCON_MODULE_ID index )
  ...
  Description:
    This function identifies whether the TraceOutput feature is available on the DEVCON module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DEVCON_ExistsJTAGUsesTDO( DEVCON_MODULE_ID index )
  ...
  Description:
    This function identifies whether the JTAGUsesTDO feature is available on the DEVCON module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DEVCON_ExistsIgnoreDebugFreeze( DEVCON_MODULE_ID index )
  ...
  Description:
    This function identifies whether the IgnoreDebugFreeze feature is available on the DEVCON module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DEVCON_ExistsDeviceVerAndId( DEVCON_MODULE_ID index )
  ...
  Description:
    This function identifies whether the DeviceVerAndId feature is available on the DEVCON module.
    When this function returns true, these functions are supported on the device:
