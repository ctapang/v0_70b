...
{
	_SFR_FIELD_WRITE (_SQI_RECEIEVE_BUFFER_THRESHOLD_VREG(index),
					  _SQI_RECEIEVE_BUFFER_THRESHOLD_MASK(index),
					  _SQI_RECEIEVE_BUFFER_THRESHOLD_POS(index),
					  threshold);
}
...
{
	return (uint8_t) _SFR_FIELD_READ (_SQI_RECEIEVE_BUFFER_THRESHOLD_VREG(index),
					  				  _SQI_RECEIEVE_BUFFER_THRESHOLD_MASK(index),
					  				  _SQI_RECEIEVE_BUFFER_THRESHOLD_POS(index));
}
