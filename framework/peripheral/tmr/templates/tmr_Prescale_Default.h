...
PLIB_TEMPLATE TMR_PRESCALE TMR_PrescaleGet_Default( TMR_MODULE_ID index )
{
	...
	if(index == TMR_ID_1)
	{
		...
		{
			case 0x00: return TMR_PRESCALE_VALUE_1;
										
			case 0x01: return TMR_PRESCALE_VALUE_8; 
										
			case 0x02: return TMR_PRESCALE_VALUE_64;
										
			case 0x03: return TMR_PRESCALE_VALUE_256;								
		}
	}
	else
	{
		return temp_prescaler;
	}
}
