...
// *****************************************************************************
/* Function:
    TMR_PRESCALE PLIB_TMR_PrescaleGet(TMR_MODULE_ID index)

  Summary:
    Gets the prescaler information.

  Description:
    This function gets the prescaler information.
  ...
  Returns:
    One of the possible values of TMR_PRESCALE
...
/* Function:
  ...
  Summary:
    Enables Continous Count mode
    
  Description:
    This function enables Continous Count mode.
