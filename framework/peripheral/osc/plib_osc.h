...
/* Function:
    void PLIB_OSC_ReferenceOscDivisorValueSet ( OSC_MODULE_ID index, OSC_REFERENCE referenceOsc,
    						OSC_REF_DIVISOR_TYPE refOscDiv )
  ...
  Parameters:
  	index    - Identifies the desired oscillator module
	referenceOsc - Identifies the desired reference oscillator
    refOscDiv  	 - One of the possible values of OSC_REF_DIV
...
void PLIB_OSC_ReferenceOscDivisorValueSet ( OSC_MODULE_ID index, OSC_REFERENCE referenceOsc,
					    OSC_REF_DIVISOR_TYPE refOscValue );
...
/* Function:
  ...
  Remarks:
    ...
    This function takes care of the register unlock, which is required per the device
    data sheet. Therefore, the user need not explicity perform the unlock
    sequence.
 */
...
//******************************************************************************
/* Function:
    OSC_FRC_DIV PLIB_OSC_FRCDivisorGet ( OSC_MODULE_ID index )

  Summary:
    Gets the FRC clock divisor.

  Description:
    This function gets the FRC clock divisor.
  ...
  Returns:
    One of the possible values from OSC_FRC_DIV.
...
/* Function:
  ...
  Remarks:
    ...
    This API takes care of the register unlock, which is required per the device
    datasheet. Therefore, the need not explicity perform the unlock sequence.
 */
...
/* Function:
  ...
  Remarks:
    ...
    This function takes care of the register unlock, which is required per the 
    device data sheet. Therefore, the user need not explicitly perform the unlock
    sequence.
 */
...
/* Function:
  ...
  Remarks:
    ...
    This function takes care of the register unlock, which is required per the 
    device data sheet. Therefore, the user need not explicity perform the 
    unlock sequence.
 */
...
/*  Function:
  ...
  Remarks:
    ...
    This function takes care of the register unlock, which is required per 
    the device datasheet. Therefore, the user need not explicitly perform 
    the unlock sequence.
...
/* Function:
  ...
  Remarks:
    ...
    This function takes care of the register unlock, which is required per the
    device datasheet. Therefore, the user need not explicity perform the unlock
    sequence.
...
/* Function:
  ...
  Description:
    This function gets the current oscillater. If the application hasn't changed
...
/* Function:
  ...
  Remarks:
    ...
    This function takes care of the register unlock, which is required per the device
    data sheet. Therefore, the user need not explicity perform the unlock sequence.
*/
...
/* Function:
  ...
  Remarks:
	...
	value of the 'PLLMULT' field. Library behaviour is undefined in case of used 
...
/* Function:
  ...
  Remarks:
	...
	Note: Actual Multipler value will be returned, NOT the 'PLLMULT' field value. 
		  Refer the data sheet of the device for the detail.
 */
...
//******************************************************************************
/* Function:
    OSC_SYSPLL_OUT_DIV PLIB_OSC_SysPLLOutputDivisorGet ( OSC_MODULE_ID index )

  Summary:
    Gets the output divisor for the PLL.

  Description:
    This function gets the output divisor for the PLL.
  ...
  Returns:
    One of the possible values from OSC_SYSPLL_OUT_DIV.
...
/* Function:
  ...
  Parameters:
  	index      - Identifies the desired oscillator module
    PLLInDiv - One of the possible values from OSC_SYSPLL_In_DIV
...
//******************************************************************************
/* Function:
    OSC_SYSPLL_IN_DIV PLIB_OSC_SysPLLInputDivisorGet ( OSC_MODULE_ID index )
  ...
  Returns:
    One of the possible values from OSC_SYSPLL_IN_DIV.
...
/* Function:
  ...
  Summary:
    Sets the frequence range for PLL

  Description:
    This function sets the frequence range for PLL
...
/* Function:
  ...
  Summary:
    Returns the frequence range for PLL

  Description:
    This function returns the frequence range set for PLL
...
/* Function:
  ...
  Remarks:
	...
	value of the 'PBDIV' field. Library behaviour is undefined in case of used 
...
// *****************************************************************************
// *****************************************************************************
// Section: Interface Routines - Clock Fail Monitoing
// *****************************************************************************
// *****************************************************************************
/*  APIs for Clock Fail Monitoing */
