...
PLIB_TEMPLATE void OSC_SysPLLInputDivisorSet_Unsupported( OSC_MODULE_ID index , OSC_SYSPLL_IN_DIV PLLInDiv )
{
...
PLIB_TEMPLATE OSC_SYSPLL_IN_DIV OSC_SysPLLInputDivisorGet_Unsupported( OSC_MODULE_ID index )
{
