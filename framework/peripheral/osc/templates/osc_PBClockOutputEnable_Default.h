...
PLIB_TEMPLATE void OSC_PBOutputClockEnable_Default( OSC_MODULE_ID index , OSC_PERIPHERAL_BUS peripheralBusNumber )
{
	...
	case OSC_PERIPHERAL_BUS_2: 	
		_SFR_BIT_SET(_OSC_OSC_PB_CLOCK_ENABLE_2_VREG(index),
					 _OSC_OSC_PB_CLOCK_ENABLE_2_POS(index) );
		break;
		
	case OSC_PERIPHERAL_BUS_3: 	
		_SFR_BIT_SET(_OSC_OSC_PB_CLOCK_ENABLE_3_VREG(index),
					 _OSC_OSC_PB_CLOCK_ENABLE_3_POS(index) );
		break;
		
	case OSC_PERIPHERAL_BUS_4: 	
		_SFR_BIT_SET(_OSC_OSC_PB_CLOCK_ENABLE_4_VREG(index),
					 _OSC_OSC_PB_CLOCK_ENABLE_4_POS(index) );
		break;
		
	case OSC_PERIPHERAL_BUS_5: 	
		_SFR_BIT_SET(_OSC_OSC_PB_CLOCK_ENABLE_5_VREG(index),
					 _OSC_OSC_PB_CLOCK_ENABLE_5_POS(index) );
		break;
		
	case OSC_PERIPHERAL_BUS_7: 	
		_SFR_BIT_SET(_OSC_OSC_PB_CLOCK_ENABLE_7_VREG(index),
					 _OSC_OSC_PB_CLOCK_ENABLE_7_POS(index) );
		break;
		
	case OSC_PERIPHERAL_BUS_8: 	
		_SFR_BIT_SET(_OSC_OSC_PB_CLOCK_ENABLE_8_VREG(index),
					 _OSC_OSC_PB_CLOCK_ENABLE_8_POS(index) );
		break;
	}
...
PLIB_TEMPLATE void OSC_PBOutputClockDisable_Default( OSC_MODULE_ID index , OSC_PERIPHERAL_BUS peripheralBusNumber )
{
	...
	case OSC_PERIPHERAL_BUS_2: 	
		_SFR_BIT_CLEAR(_OSC_OSC_PB_CLOCK_ENABLE_2_VREG(index),
					   _OSC_OSC_PB_CLOCK_ENABLE_2_POS(index) );
		break;
		
	case OSC_PERIPHERAL_BUS_3: 	
		_SFR_BIT_CLEAR(_OSC_OSC_PB_CLOCK_ENABLE_3_VREG(index),
					   _OSC_OSC_PB_CLOCK_ENABLE_3_POS(index) );
		break;
		
	case OSC_PERIPHERAL_BUS_4: 	
		_SFR_BIT_CLEAR(_OSC_OSC_PB_CLOCK_ENABLE_4_VREG(index),
					   _OSC_OSC_PB_CLOCK_ENABLE_4_POS(index) );
		break;
		
	case OSC_PERIPHERAL_BUS_5: 	
		_SFR_BIT_CLEAR(_OSC_OSC_PB_CLOCK_ENABLE_5_VREG(index),
					   _OSC_OSC_PB_CLOCK_ENABLE_5_POS(index) );
		break;
		
	case OSC_PERIPHERAL_BUS_7: 	
		_SFR_BIT_CLEAR(_OSC_OSC_PB_CLOCK_ENABLE_7_VREG(index),
					   _OSC_OSC_PB_CLOCK_ENABLE_7_POS(index) );
		break;
		
	case OSC_PERIPHERAL_BUS_8: 	
		_SFR_BIT_CLEAR(_OSC_OSC_PB_CLOCK_ENABLE_8_VREG(index),
					   _OSC_OSC_PB_CLOCK_ENABLE_8_POS(index) );
		break;
	}
...
PLIB_TEMPLATE bool OSC_PBOutputClockIsEnabled_Default( OSC_MODULE_ID index , OSC_PERIPHERAL_BUS peripheralBusNumber )
{
	...
	case OSC_PERIPHERAL_BUS_2: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_ENABLE_2_VREG(index),
					   		 _OSC_OSC_PB_CLOCK_ENABLE_2_POS(index) );
		
	case OSC_PERIPHERAL_BUS_3: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_ENABLE_3_VREG(index),
					   		 _OSC_OSC_PB_CLOCK_ENABLE_3_POS(index) );
		
	case OSC_PERIPHERAL_BUS_4: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_ENABLE_4_VREG(index),
					   	 	 _OSC_OSC_PB_CLOCK_ENABLE_4_POS(index) );
		
	case OSC_PERIPHERAL_BUS_5: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_ENABLE_5_VREG(index),
							 _OSC_OSC_PB_CLOCK_ENABLE_5_POS(index) );
		
	case OSC_PERIPHERAL_BUS_7: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_ENABLE_7_VREG(index),
					   		 _OSC_OSC_PB_CLOCK_ENABLE_7_POS(index) );
		
	case OSC_PERIPHERAL_BUS_8: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_ENABLE_8_VREG(index),
					   		 _OSC_OSC_PB_CLOCK_ENABLE_8_POS(index) );
