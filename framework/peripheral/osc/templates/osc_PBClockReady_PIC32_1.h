...
PLIB_TEMPLATE bool OSC_PBClockDivisorIsReady_PIC32_1( OSC_MODULE_ID index , OSC_PERIPHERAL_BUS peripheralBusNumber )
{
    ...
    case OSC_PERIPHERAL_BUS_1: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_READY_1_VREG(index),
					   		 _OSC_OSC_PB_CLOCK_READY_1_POS(index) );
		
	case OSC_PERIPHERAL_BUS_2: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_READY_2_VREG(index),
					   		 _OSC_OSC_PB_CLOCK_READY_2_POS(index) );
		
	case OSC_PERIPHERAL_BUS_3: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_READY_3_VREG(index),
					   		 _OSC_OSC_PB_CLOCK_READY_3_POS(index) );
		
	case OSC_PERIPHERAL_BUS_4: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_READY_4_VREG(index),
					   		 _OSC_OSC_PB_CLOCK_READY_4_POS(index) );
		
	case OSC_PERIPHERAL_BUS_5: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_READY_5_VREG(index),
					   		 _OSC_OSC_PB_CLOCK_READY_5_POS(index) );
		
	case OSC_PERIPHERAL_BUS_7: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_READY_7_VREG(index),
					   		 _OSC_OSC_PB_CLOCK_READY_7_POS(index) );
		
	case OSC_PERIPHERAL_BUS_8: 	
		return _SFR_BIT_READ(_OSC_OSC_PB_CLOCK_READY_8_VREG(index),
					   		 _OSC_OSC_PB_CLOCK_READY_8_POS(index) );
