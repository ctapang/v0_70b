...
INLINE SFR_TYPE* _EBI_CSADDR0_100_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBICS0;
...
INLINE SFR_TYPE* _EBI_REGSEL0_100_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK0;
...
INLINE SFR_TYPE* _EBI_MEMTYPE0_100_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK0;
...
INLINE SFR_TYPE* _EBI_MEMSIZE0_100_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK0;
...
INLINE SFR_TYPE* _EBI_EBICSEN0_100_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
INLINE SFR_DATA _EBI_CSADDR0_100_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_REGSEL0_100_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_MEMTYPE0_100_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_MEMSIZE0_100_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_EBICSEN0_100_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_CSADDR0_100_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_REGSEL0_100_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_MEMTYPE0_100_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_MEMSIZE0_100_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_EBICSEN0_100_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_CSADDR0_100_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_REGSEL0_100_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_MEMTYPE0_100_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_MEMSIZE0_100_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
INLINE SFR_DATA _EBI_EBICSEN0_100_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
#include "../templates/ebi_Base_Address_EBIP32_100_124pin.h"
#include "../templates/ebi_MemoryCharacteristics_EBIP32_100_124pin.h"
...
INLINE_API void PLIB_EBI_BaseAddressSet(EBI_MODULE_ID index, int ChipSelectNumber, uint32_t BaseAddress)
{
    switch (index) {
        case EBI_ID_0 :
            EBI_BaseAddressSet_EBIP32_100_124pin(index, ChipSelectNumber, BaseAddress);
            break;
        case EBI_NUMBER_OF_MODULES :
        default :
            break;
...
INLINE_API uint32_t PLIB_EBI_BaseAddressGet(EBI_MODULE_ID index, int ChipSelectNumber)
{
    switch (index) {
        case EBI_ID_0 :
            return EBI_BaseAddressGet_EBIP32_100_124pin(index, ChipSelectNumber);
        case EBI_NUMBER_OF_MODULES :
        default :
            return (uint32_t)0;
    }
...
INLINE_API bool PLIB_EBI_ExistsBaseAddress(EBI_MODULE_ID index)
{
    switch (index) {
        case EBI_ID_0 :
            return EBI_ExistsBaseAddress_EBIP32_100_124pin(index);
        case EBI_NUMBER_OF_MODULES :
        default :
            return (bool)0;
    }
...
INLINE_API void PLIB_EBI_MemoryCharacteristicsSet(EBI_MODULE_ID index, int ChipSelectNumber, EBI_MEMORY_TYPE MemoryType, EBI_MEMORY_SIZE MemorySize, EBI_CS_TIMING TimingReg)
{
    switch (index) {
        case EBI_ID_0 :
            EBI_MemoryCharacteristicsSet_EBIP32_100_124pin(index, ChipSelectNumber, MemoryType, MemorySize, TimingReg);
            break;
        case EBI_NUMBER_OF_MODULES :
        default :
            break;
...
INLINE_API bool PLIB_EBI_ExistsMemoryCharacteristics(EBI_MODULE_ID index)
{
    switch (index) {
        case EBI_ID_0 :
            return EBI_ExistsMemoryCharacteristics_EBIP32_100_124pin(index);
        case EBI_NUMBER_OF_MODULES :
        default :
            return (bool)0;
    }
