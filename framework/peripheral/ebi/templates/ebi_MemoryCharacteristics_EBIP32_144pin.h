/*******************************************************************************
  ...
  File Name:
    ebi_MemoryCharacteristics_EBIP32_144pin.h
...
#ifndef _EBI_MEMORYCHARACTERISTICS_EBIP32_144PIN_H
#define _EBI_MEMORYCHARACTERISTICS_EBIP32_144PIN_H
...
//******************************************************************************
/* Function :  EBI_MemoryCharacteristicsSet_EBIP32_144pin

  Summary:
    Implements EBIP32_144pin variant of PLIB_EBI_MemoryCharacteristicsSet 

  Description:
    This template implements the EBIP32_144pin variant of the PLIB_EBI_MemoryCharacteristicsSet function.
*/

PLIB_TEMPLATE void EBI_MemoryCharacteristicsSet_EBIP32_144pin( EBI_MODULE_ID index , int ChipSelectNumber , EBI_MEMORY_TYPE MemoryType , EBI_MEMORY_SIZE MemorySize , EBI_CS_TIMING TimingReg )
{
...
//******************************************************************************
/* Function :  EBI_ExistsMemoryCharacteristics_EBIP32_144pin

  Summary:
    Implements EBIP32_144pin variant of PLIB_EBI_ExistsMemoryCharacteristics

  Description:
    This template implements the EBIP32_144pin variant of the PLIB_EBI_ExistsMemoryCharacteristics function.
*/

PLIB_TEMPLATE bool EBI_ExistsMemoryCharacteristics_EBIP32_144pin( EBI_MODULE_ID index )
{
    return true;
}


#endif /*_EBI_MEMORYCHARACTERISTICS_EBIP32_144PIN_H*/
