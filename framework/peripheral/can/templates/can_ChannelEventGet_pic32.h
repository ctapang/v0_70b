...
#ifndef _CAN_CHANNELEVENTGET_PIC32_H
#define _CAN_CHANNELEVENTGET_PIC32_H
...
//******************************************************************************
/* Function :  CAN_ChannelEventGet_pic32

  Summary:
    Implements pic32 variant of PLIB_CAN_ChannelEventGet 

  Description:
    This template implements the pic32 variant of the PLIB_CAN_ChannelEventGet function.
*/

PLIB_TEMPLATE CAN_CHANNEL_EVENT CAN_ChannelEventGet_pic32( CAN_MODULE_ID index , CAN_CHANNEL channel )
{
...
//******************************************************************************
/* Function :  CAN_ChannelEventClear_pic32

  Summary:
    Implements pic32 variant of PLIB_CAN_ChannelEventClear 

  Description:
    This template implements the pic32 variant of the PLIB_CAN_ChannelEventClear function.
*/

PLIB_TEMPLATE void CAN_ChannelEventClear_pic32( CAN_MODULE_ID index , CAN_CHANNEL channel , CAN_CHANNEL_EVENT events )
{
    SFR_TYPE *channelEventControlReg;
...
//******************************************************************************
/* Function :  CAN_ExistsChannelEvent_pic32

  Summary:
    Implements pic32 variant of PLIB_CAN_ExistsChannelEvent

  Description:
    This template implements the pic32 variant of the PLIB_CAN_ExistsChannelEvent function.
*/

PLIB_TEMPLATE bool CAN_ExistsChannelEvent_pic32( CAN_MODULE_ID index )
{
    return true;
}


#endif /*_CAN_CHANNELEVENTGET_PIC32_H*/
