...
/* CAN Transmit and Receive Message Buffer size
  ...
  Description:
    This contant is used as the array size of the CAN transmit and full receive message buffer.
...
/* CAN Data-Only Receive Message Buffer
  ...
  Description:
    This contant is used as the size of the CAN data-only receive message buffer in bytes.
...
/* Function:
  ...
  Remarks:
	The MY_CAN_ID macro in the example above is used as a placeholder for the
...
/* Function:
  ...
  Description:
    This function configures the CAN module to stop operation when the system enters Idle
    mode.
...
// *****************************************************************************
/* Function:
	void PLIB_CAN_MemoryBufferAssign ( CAN_MODULE_ID index, void * buffer, int sizeInBytes )

  Summary:
    Assigns buffer memory to the CAN module.

  Description:
    This function assigns buffer memory to the CAN module. The CAN module uses
  ...
  Example:
    ...
    PLIB_CAN_MemoryBufferAssign(CAN_ID_1, canMemoryBuffer, (3 * 4 *
...
/* Function:
  ...
  Parameters:
    ...
    value   - Start value of the receive message yime stamp timer. This value
...
// *****************************************************************************
/* Function:
    void PLIB_CAN_TimeStampPrescalarSet( CAN_MODULE_ID index, unsigned prescalar )

  Summary:
    Sets the CAN receive message time stamp timer prescalar.

  Description:
    This function sets the CAN receive message time stamp timer prescalar. This
    prescalar determines the rate at the which the time stamp timer is
    incremented. For example, if the prescalar value is 0xFF, the time stamp
  ...
  Parameters:
    ...
    prescalar   - Prescalar for the CAN receive message time stamp timer. This
  ...
  Example:
    ...
    // Set the CAN_ID_1 Receive Message Time Stamp Timer prescalar to increment
    //the Timestamp Timer every 1024 system clock periods.

    PLIB_CAN_TimeStampPrescalarSet(CAN_ID_1, 1024);
  ...
  Remarks:
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsTimeStampPrescalar in your application to determine whether
	this feature is available.
*/
...
// *****************************************************************************
/* Function:
    void PLIB_CAN_PhaseSegment2LengthSet ( CAN_MODULE_ID index,
    	CAN_TIME_SEGMENT_LENGTH length )

  Summary:
    Selects the CAN phase buffer segment2 length.

  Description:
    This function selects the CAN phase buffer segment2 length.
  ...
  Parameters:
	index      - Identifies the desired CAN module
	length     - Desired segment length, select from CAN_TIME_SEGMENT_LENGTH
				 enum
  Returns:
    None.
  ...
  Example:
	...
	if (CAN_CONFIGURATION_MODE != PLIB_CAN_OperationModeGet(MY_CAN_ID))
	{
		...
		PLIB_CAN_PhaseSegment2LengthSet(MY_CAN_ID,
  ...
  Remarks:
	...
	This function will not work if the freely programmable mode is disabled.

	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsPhaseSegment2Length in your application to determine whether
	this feature is available.
*/
...
// *****************************************************************************
/* Function:
    void PLIB_CAN_PhaseSegment1LengthSet ( CAN_MODULE_ID index,
    										CAN_TIME_SEGMENT_LENGTH length )

  Summary:
    Selects the CAN phase buffer segment1 length.

  Description:
    This function selects the CAN phase buffer segment1 length.
  ...
  Example:
	...
	if (CAN_CONFIGURATION_MODE != PLIB_CAN_OperationModeGet(MY_CAN_ID))
	{
		PLIB_CAN_PhaseSegment1LengthSet(MY_CAN_ID, CAN_TIME_SEGMENT_LEN_8TQ);
	}
    </code>
  ...
  Remarks:
	...
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsPhaseSegment1Length in your application to determine whether
	this feature is available.
*/
...
// *****************************************************************************
/* Function:
    void PLIB_CAN_PhaseSegment2LengthFreelyProgrammableEnable
    ( CAN_MODULE_ID index )

  Summary:
    Makes the CAN phase buffer segment2 length freely programmable.

  Description:
    This function makes the CAN phase buffer segment2 length freely programmable.
    If this mode is not set, the segment2 length will be the maximum of the
    segment1 length or information processing time, whichever is greater.
  ...
  Remarks:
	...
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsPhaseSegment2LengthFreelyProgrammable in your application to
...
// *****************************************************************************
/* Function:
    void PLIB_CAN_PhaseSegment2LengthFreelyProgrammableDisable
    ( CAN_MODULE_ID index )

  Summary:
    Disables the CAN phase buffer segment2 length freely programmable mode.

  Description:
    This function disables the CAN phase buffer segment2 length freely
    programmable mode. The segment2 length will be the maximum of the segment1
    length or information processing time, whichever is greater.
  ...
  Example:
	...
	if (CAN_CONFIGURATION_MODE != PLIB_CAN_OperationModeGet(MY_CAN_ID))
	{
		PLIB_CAN_PhaseSegment2LengthFreelyProgrammableDisable(MY_CAN_ID);
	}
    </code>
  ...
  Remarks:
	...
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsPhaseSegment2LengthFreelyProgrammable in your application
...
/* Function:
  ...
  Remarks:
	...
	This API may not function if the baud rate prescalar value is more than a
	certain limit. Refer to the specific device data sheet to determine the maximum
	prescalar that allows three times sampling.
...
/* Function:
  ...
  Description:
	The bus line will be sampled only once at the sampling point.
...
// *****************************************************************************
/* Function:
    void PLIB_CAN_PropagationTimeSegmentSet ( CAN_MODULE_ID index,
    	CAN_TIME_SEGMENT_LENGTH length )

  Summary:
	Selects the propagation time segment.

  Description:
	This function selects the propagation time segment.
  ...
  Example:
	...
	if (CAN_CONFIGURATION_MODE != PLIB_CAN_OperationModeGet(MY_CAN_ID))
	{
		PLIB_CAN_PropagationTimeSegmentSet(MY_CAN_ID, CAN_TIME_SEGMENT_LEN_8TQ);
	}
    </code>
  ...
  Remarks:
	...
	This function works only if the CAN module is in configuration mode. Use
	PLIB_CAN_OperationModeGet function to get the current mode and
	PLIB_CAN_OperationModeSelect function to change the mode.

	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsPropagationTimeSegment in your application to determine
...
/* Function:
  ...
  Summary:
    Selects the synchronization jump width.

  Description:
    This function selects the synchronization jump width.
  ...
  Example:
	...
	if (CAN_CONFIGURATION_MODE != PLIB_CAN_OperationModeGet(MY_CAN_ID))
	{
		PLIB_CAN_SyncJumpWidthSet(MY_CAN_ID,
			CAN_TIME_SEGMENT_LEN_8TQ);
	}
    </code>
  ...
  Remarks:
	...
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsSyncJumpWidthSet in your application to determine whether
	this feature is available.
*/
...
/* Function:
  ...
  Returns:
                 - true  = If channel = CAN_ALL_CHANNELS, Transmit Abort is complete
                         = If channel = CAN_CHANNELx, Transmit Abort was successful
                 - false = If channel = CAN_ALL_CHANNELS, Transmit Abort is in progress
                         = If channel = CAN_CHANNELx, Transmit Abort was not successful
...
/* Function:
  ...
  Description:
    ...
    read from the CAN channel. The routine will return NULL if there are no new
    messages to be read. The PLIB_CAN_ChannelUpdate routine should be called
...
/* Function:
  ...
  Example:
    <code>
    // Disable CAN_ID_1 filter 3 and wait until the
    // filter is disabled.
...
/* Function:
  ...
  Description:
    This function links a filter to a channel. A filter is typically linked to
    a receive channel. This allows the channel to receive messages accepted by
    the filter. A filter can also be linked to a transmit channel if the transmit
    channel is configured for remote request transmit. In this case, a message
    accepted by the filter will automatically cause the linked transmit channel
    to transmit CAN messages that are buffered in the channel. Note that a filter
    should be enabled using the PLIB_CAN_FilterEnable function after the filter
    has been linked to the desired channel.
  ...
  Parameters:
    ...
    channel - Identifies the channel to be linked to this filter. If a transmit
    		  channel is linked, the transmit channel should have it's remote
    		  transmit request feature enabled.
  ...
  Remarks:
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsFilterToChannelLink in your application to determine whether
	this feature is available.
*/
...
// *****************************************************************************
// *****************************************************************************
// Section: Interface Routines - Miscellaneous Functions
// *****************************************************************************
// *****************************************************************************
/*  This section contains functions specific to PIC18 */

// *****************************************************************************
/* Function:
    void PLIB_CAN_FunctionalModeSelect ( CAN_MODULE_ID index, CAN_FUNCTONAL_MODES funcMode )

  Summary:
    Selects the functional mode of the CAN module.

  Description:
    This function selects the functional mode of the CAN module.
  ...
  Parameters:
    ...
    funcMode - Select the functional mode of the CAN module. One of the possible
    			values from CAN_FUNCTIONAL_MODES

  Example:
    <code>
    PLIB_CAN_FunctionalModeSelect(CAN_ID_1, CAN_LEGACY_MODE0);
    </code>
  ...
  Remarks:
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsFunctionalMode in your application to determine whether
	this feature is available.
*/
...
// *****************************************************************************
/* Function:
    CAN_FUNCTONAL_MODES PLIB_CAN_FunctionalModeGet ( CAN_MODULE_ID index )

  Summary:
    Obtains the functional mode of the CAN module.

  Description:
    This function obtains the functional mode of the CAN module.
  ...
  Example:
    <code>
	CAN_FUNCTONAL_MODES funcMode;

    funcMode = PLIB_CAN_FunctionalModeGet(CAN_ID_1);
    </code>
...
// *****************************************************************************
/* Function:
    void PLIB_CAN_RxFIFOOneLeftNotify ( CAN_MODULE_ID index )

  Summary:
    Configures the module to generate an interrupt when the FIFO has only one
    receive buffer left.

  Description:
    This function configures the module to generate an interrupt when the FIFO
    has only one receive buffer left. If this API is not called, the module will
    interrupt if four receive buffers are empty.

  Precondition:
    The functional mode of the module should be configured for
    "CAN_ENHANCED_FIFO_MODE2" using PLIB_CAN_FunctionalModeSelect function.
  ...
  Example:
    <code>
    PLIB_CAN_RxFIFOOneLeftNotify(CAN_ID_1);
    </code>
  ...
  Remarks:
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsRxFIFOOneLeftNotify in your application to determine whether
	this feature is available.
*/
...
// *****************************************************************************
/* Function:
    void PLIB_CAN_RxFIFOFourLeftNotify ( CAN_MODULE_ID index )

  Summary:
    Configures the module to generate an interrupt when the FIFO has four
    receive buffers left.

  Description:
    This function configures the module to generate an interrupt when the FIFO
    has four receive buffers left. If this API is not called, the module will
    interrupt if four receive buffers are empty.
  ...
  Example:
    <code>
    PLIB_CAN_RxFIFOFourLeftNotify(CAN_ID_1);
    </code>
  ...
  Remarks:
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsRxFIFOFourLeftNotify in your application to determine whether
	this feature is available.
*/
...
// *****************************************************************************
/* Function:
    void PLIB_CAN_ReceiveModeSelect ( CAN_MODULE_ID index, CAN_RECEIVE_CHANNEL rcvChannel,
    	CAN_RECEIVE_MODES recMode )

  Summary:
    Selects the receive mode of the CAN module.

  Description:
    This function selects the receive mode of the CAN module.

  Precondition:
    The functional mode should support the 'receive mode' selected.

  Parameters:
    index    	- Identifies the desired CAN module
    rcvChannel  - Receive channel number, one of the possible values from CAN_RECEIVE_CHANNEL
    recMode     - Receive mode, one of the possible values from CAN_RECEIVE_MODES

  Example:
    <code>
	PLIB_CAN_FunctionalModeSelect(CAN_ID_1, CAN_LEGACY_MODE0);

    PLIB_CAN_ReceiveModeSelect(CAN_ID_1, CAN_RECEIVE_CHANNEL0, CAN_RECEIVE_ALL_MSG_MODE);
  ...
  Remarks:
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsReceiveModeSelect in your application to determine whether
	this feature is available.
*/

void PLIB_CAN_ReceiveModeSelect ( CAN_MODULE_ID index, CAN_RECEIVE_CHANNEL rcvChannel, CAN_RECEIVE_MODES recMode );


// *****************************************************************************
/* Function:
    CAN_RECEIVE_MODES PLIB_CAN_ReceiveModeGet ( CAN_MODULE_ID index, CAN_RECEIVE_CHANNEL rcvChannel )

  Summary:
    Obtains the receive mode of the CAN module.

  Description:
    This function obtains the receive mode of the CAN module.
  ...
  Parameters:
    ...
    rcvChannel  - Receive channel number, one of the possible values from
					CAN_RECEIVE_CHANNEL
  ...
  Example:
    ...
    recMode = PLIB_CAN_ReceiveModeGet(CAN_ID_1, CAN_RECEIVE_CHANNEL0);
    </code>

  Returns:
    Receive mode, one of the possible values from CAN_RECEIVE_MODES.
.
  Remarks:
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
...
// *****************************************************************************
/* Function:
    bool PLIB_CAN_MessageIsReceived ( CAN_MODULE_ID index, CAN_RECEIVE_CHANNEL rcvChannel )

  Summary:
    Returns whether a message was received and the receive buffer is not empty.

  Description:
    This function returns 'true' if a message was received and the
  ...
  Example:
	...
	if (PLIB_CAN_MessageIsReceived(CAN_ID_1, CAN_RECEIVE_CHANNEL0))
	{
		//Read the message

		//Acknowlege read; otherwise, it will cause the interrupt to
		//generated again
		PLIB_CAN_ReceiveBufferClear(CAN_ID_1, CAN_RECEIVE_CHANNEL0);
	}
    </code>

  Returns:
             - true  = A message was received for the specified channel
             - false = The receive buffer is not empty for the specified channel

  Remarks:
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsMessageIsReceived in your application to determine whether
	this feature is available.
*/
...
// *****************************************************************************
/* Function:
    bool PLIB_CAN_ReceiveBufferIsEmpty ( CAN_MODULE_ID index, CAN_RECEIVE_CHANNEL rcvChannel )

  Summary:
    Returns whether the receive buffer of the specified channel is empty.

  Description:
    This function returns 'true' if the receive buffer of the specified channel
    is empty.
  ...
  Example:
	...
	if (PLIB_CAN_ReceiveBufferIsEmpty(CAN_ID_1, CAN_RECEIVE_CHANNEL0))
	{
		//Buffer is empty
	}
    </code>
  ...
  Returns:
             - true  = The receive buffer is not empty for the specified channel
             - false = A message was received for the specified channel

  Remarks:
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsReceiveBufferIsEmpty in your application to determine whether
	this feature is available.
*/
...
// *****************************************************************************
/* Function:
    void PLIB_CAN_ReceiveBufferClear ( CAN_MODULE_ID index, CAN_RECEIVE_CHANNEL rcvChannel )

  Summary:
    Clears the received message flag.

  Description:
    This function clears the received message flag.
  ...
  Example:
	...
	if (PLIB_CAN_MessageIsReceived(CAN_ID_1, CAN_RECEIVE_CHANNEL0))
	{
		...
		//Acknowledge read, otherwise it will cause the interrupt to
		//be generated again
		PLIB_CAN_ReceiveBufferClear(CAN_ID_1, CAN_RECEIVE_CHANNEL0);
	}
    </code>
  ...
  Remarks:
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsReceiveBufferClear in your application to determine whether
	this feature is available.

    This API should be called once the receive message buffer is read. This
    function must be called once the receive message buffer has been read or
    the interrupt request will still be active and the interrupt may occur
    again immediately.
*/
...
// *****************************************************************************
/* Function:
    bool PLIB_CAN_RemoteTransmitReqIsReceived ( CAN_MODULE_ID index, CAN_RECEIVE_CHANNEL rcvChannel )

  Summary:
    Returns whether the message received is a remote transmit request.

  Description:
    This function returns 'true' if the message received is a remote
    transmit request.
  ...
  Example:
	...
	if (PLIB_CAN_RemoteTransmitReqIsReceived(CAN_ID_1, CAN_RECEIVE_CHANNEL0))
	{
		//Request for remote transmit
	}
    </code>

  Returns:
  	- true  = Received message is a remote transmission request
	- false = Received message is not a remote transmission request

  Remarks:
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_CAN_ExistsRemoteTransmitReq in your application to determine whether
	this feature is available.
*/
...
/* Function :  PLIB_CAN_ExistsDeviceNet( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the DeviceNet feature is available on the CAN module.
...
/* Function :  PLIB_CAN_ExistsActiveStatus( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ActiveStatus feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
    - PLIB_CAN_IsActive
...
/* Function :  PLIB_CAN_ExistsStopInIdle( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the StopInIdle feature is available on the CAN module.
...
/* Function :  PLIB_CAN_ExistsEnableControl( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the EnableControl feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
    - PLIB_CAN_Enable
    - PLIB_CAN_Disable
...
/* Function :  PLIB_CAN_ExistsTimeStampEnable( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the TimeStampEnable feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_CAN_ExistsTimeStampValue( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the TimeStampValue feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_CAN_ExistsBusActivityWakeup( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the BusActivityWakeup feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_CAN_ExistsMemoryBufferAssign( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the MemoryBufferAssign feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsOperationModeRead( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the OperationModeRead feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsOperationModeWrite( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the OperationModeSet feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
//******************************************************************************
/* Function :  PLIB_CAN_ExistsTimeStampPrescalar( CAN_MODULE_ID index )

  Summary:
    Identifies whether the TimeStampPrescalar feature exists on the CAN module.

  Description:
    This function identifies whether the TimeStampPrescalar feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
  ...
  Returns:
                    - true  = The TimeStampPrescalar feature is supported on the device
                    - false = The TimeStampPrescalar feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_CAN_ExistsTimeStampPrescalar( CAN_MODULE_ID index );


//******************************************************************************
/* Function :  PLIB_CAN_ExistsPhaseSegment2Length( CAN_MODULE_ID index )

  Summary:
    Identifies whether the PhaseSegment2Length feature exists on the CAN module.

  Description:
    This function identifies whether the PhaseSegment2Length feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
  ...
  Returns:
                    - true  = The PhaseSegment2Length feature is supported on the device
                    - false = The PhaseSegment2Length feature is not supported on the device
...
//******************************************************************************
/* Function :  PLIB_CAN_ExistsPhaseSegment1Length( CAN_MODULE_ID index )

  Summary:
    Identifies whether the PhaseSegment1Length feature exists on the CAN module.

  Description:
    This function identifies whether the PhaseSegment1Length feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
  ...
  Returns:
                    - true  = The PhaseSegment1Length feature is supported on the device
                    - false = The PhaseSegment1Length feature is not supported on the device
...
//******************************************************************************
/* Function :  PLIB_CAN_ExistsPhaseSegment2LengthFreelyProgrammable( CAN_MODULE_ID index )

  Summary:
    Identifies whether the PhaseSegment2LengthFreelyProgrammable feature exists on the CAN module.

  Description:
    This function identifies whether the PhaseSegment2LengthFreelyProgrammable feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
  ...
  Returns:
                    - true  = The PhaseSegment2LengthFreelyProgrammable feature is supported on the device
                    - false = The PhaseSegment2LengthFreelyProgrammable feature is not supported on the device
...
/* Function :  PLIB_CAN_ExistsBusLine3TimesSampling( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the BusLine3TimesSampling feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_CAN_ExistsPropagationTimeSegment( CAN_MODULE_ID index )

  Summary:
    Identifies whether the PropagationTimeSegment feature exists on the CAN module.

  Description:
    This function identifies whether the PropagationTimeSegment feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
  ...
  Returns:
                    - true  = The PropagationTimeSegment feature is supported on the device
                    - false = The PropagationTimeSegment feature is not supported on the device
...
//******************************************************************************
/* Function :  PLIB_CAN_ExistsSyncJumpWidthSet( CAN_MODULE_ID index )

  Summary:
    Identifies whether the SyncJumpWidth feature exists on the CAN module.

  Description:
    This function identifies whether the SyncJumpWidth feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
  ...
  Returns:
                    - true  = The SyncJumpWidth feature is supported on the device
                    - false = The SyncJumpWidth feature is not supported on the device
...
/* Function :  PLIB_CAN_ExistsChannelReset( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelReset feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_CAN_ExistsChannelUpdate( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelUpdate feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsModuleEventEnable( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ModuleEventEnable feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_CAN_ExistsModuleEventClear( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ModuleEvents feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_CAN_ExistsChannelEventEnable( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelEventEnable feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_CAN_ExistsPendingEventsGet( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the PendingEventsGet feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsAllChannelEvents( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the AllChannelEvents feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsAllChannelOverflow( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the AllChannelOverflow feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsChannelEvent( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelEventGet feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_CAN_ExistsChannelForTransmitSet( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelForTransmitSet feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsPendingTransmissionsAbort( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the PendingTransmissionsAbort feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsTransmitChannelFlush( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the TransmitChannelFlush feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsTransmitChannelStatus( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the TransmitChannelStatus feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsTransmitBufferGet( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the TransmitBufferGet feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsTransmissionIsAborted( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the TransmissionAbortStatus feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsReceivedMessageGet( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ReceivedMessageGet feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsChannelForReceiveSet( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelForReceiveSet feature is available on the CAN module.
...
/* Function :  PLIB_CAN_ExistsFilterMaskConfigure( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the FilterMaskConfigure feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsFilterConfigure( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the FilterConfigure feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsFilterEnable( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the FilterEnable feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_CAN_ExistsLatestFilterMatchGet( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the LatestFilterMatchGet feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsFilterToChannelLink( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the FilterToChannelLink feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsReceiveErrorCount( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ReceiveErrorCount feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsTransmitErrorCountGet( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the TransmitErrorCountGet feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsErrorState( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ErrorStateGet feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_CAN_ExistsModuleInfo( CAN_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ModuleInformation feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_CAN_ExistsFunctionalMode( CAN_MODULE_ID index )

  Summary:
    Identifies whether the FunctionalModeSelect feature exists on the CAN module.

  Description:
    This function identifies whether the FunctionalModeSelect feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
  ...
  Returns:
                    - true  = The FunctionalModeSelect feature is supported on the device
                    - false = The FunctionalModeSelect feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_CAN_ExistsFunctionalMode( CAN_MODULE_ID index );


//******************************************************************************
/* Function :  PLIB_CAN_ExistsRxFIFOOneLeftNotify( CAN_MODULE_ID index )

  Summary:
    Identifies whether the RxFIFOOneLeftNotify feature exists on the CAN module.

  Description:
    This function identifies whether the RxFIFOOneLeftNotify feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
  ...
  Returns:
                    - true  = The RxFIFOOneLeftNotify feature is supported on the device
                    - false = The RxFIFOOneLeftNotify feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_CAN_ExistsRxFIFOOneLeftNotify( CAN_MODULE_ID index );


//******************************************************************************
/* Function :  PLIB_CAN_ExistsRxFIFOFourLeftNotify( CAN_MODULE_ID index )

  Summary:
    Identifies whether the RxFIFOFourLeftNotify feature exists on the CAN module.

  Description:
    This function identifies whether the RxFIFOFourLeftNotify feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
  ...
  Returns:
                    - true  = The RxFIFOFourLeftNotify feature is supported on the device
                    - false = The RxFIFOFourLeftNotify feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_CAN_ExistsRxFIFOFourLeftNotify( CAN_MODULE_ID index );


//******************************************************************************
/* Function :  PLIB_CAN_ExistsReceiveModeSelect( CAN_MODULE_ID index )

  Summary:
    Identifies whether the ReceiveModeSelect feature exists on the CAN module.

  Description:
    This function identifies whether the ReceiveModeSelect feature is available on the CAN module.
    When this function returns true, these functions are supported on the device:
    - PLIB_CAN_ReceiveModeSelect
    - PLIB_CAN_ReceiveModeGet
  ...
  Returns:
                 - true  = The ReceiveModeSelect feature is supported on the device
                 - false = The ReceiveModeSelect feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_CAN_ExistsReceiveModeSelect( CAN_MODULE_ID index );


//******************************************************************************
/* Function :  PLIB_CAN_ExistsMessageIsReceived( CAN_MODULE_ID index )

  Summary:
    Identifies whether the MessageIsReceived feature exists on the CAN module.

  Description:
    This function identifies whether the MessageIsReceived feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
  ...
  Returns:
                    - true  = The MessageIsReceived feature is supported on the device
                    - false = The MessageIsReceived feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_CAN_ExistsMessageIsReceived( CAN_MODULE_ID index );


//******************************************************************************
/* Function :  PLIB_CAN_ExistsReceiveBufferIsEmpty( CAN_MODULE_ID index )

  Summary:
    Identifies whether the ReceiveBufferIsEmpty feature exists on the CAN module.

  Description:
    This function identifies whether the ReceiveBufferIsEmpty feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
    - PLIB_CAN_ReceiveBufferIsEmpty
  ...
  Returns:
                    - true  = The ReceiveBufferIsEmpty feature is supported on the device
                    - false = The ReceiveBufferIsEmpty feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_CAN_ExistsReceiveBufferIsEmpty( CAN_MODULE_ID index );


//******************************************************************************
/* Function :  PLIB_CAN_ExistsReceiveBufferClear( CAN_MODULE_ID index )

  Summary:
    Identifies whether the ReceiveBufferClear feature exists on the CAN module.

  Description:
    This function identifies whether the ReceiveBufferClear feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
  ...
  Returns:
                    - true  = The ReceiveBufferClear feature is supported on the device
                    - false = The ReceiveBufferClear feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_CAN_ExistsReceiveBufferClear( CAN_MODULE_ID index );


//******************************************************************************
/* Function :  PLIB_CAN_ExistsRemoteTransmitReq( CAN_MODULE_ID index )

  Summary:
    Identifies whether the RemoteTransmitReq feature exists on the CAN module.

  Description:
    This function identifies whether the RemoteTransmitReq feature is available on the CAN module.
    When this function returns true, this function is supported on the device:
    - PLIB_CAN_RemoteTransmitReqIsReceived
  ...
  Returns:
                    - true  = The RemoteTransmitReq feature is supported on the device
                    - false = The RemoteTransmitReq feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_CAN_ExistsRemoteTransmitReq( CAN_MODULE_ID index );
