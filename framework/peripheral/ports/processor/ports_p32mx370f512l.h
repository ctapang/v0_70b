...
INLINE SFR_TYPE* _PORTS_REMAP_PIN_RPD8_VREG(PORTS_MODULE_ID i)
{
    switch (i) {
        case PORTS_ID_0 :
            return &RPD8R;
...
INLINE SFR_TYPE* _PORTS_REMAP_PIN_RPF6_VREG(PORTS_MODULE_ID i)
{
    switch (i) {
        case PORTS_ID_0 :
            return &RPF6R;
...
INLINE SFR_DATA _PORTS_REMAP_PIN_RPD8_MASK(PORTS_MODULE_ID i)
{
    switch (i) {
        case PORTS_ID_0 :
...
INLINE SFR_DATA _PORTS_REMAP_PIN_RPF6_MASK(PORTS_MODULE_ID i)
{
    switch (i) {
        case PORTS_ID_0 :
...
INLINE SFR_DATA _PORTS_REMAP_PIN_RPD8_POS(PORTS_MODULE_ID i)
{
    switch (i) {
        case PORTS_ID_0 :
...
INLINE SFR_DATA _PORTS_REMAP_PIN_RPF6_POS(PORTS_MODULE_ID i)
{
    switch (i) {
        case PORTS_ID_0 :
...
INLINE SFR_DATA _PORTS_REMAP_PIN_RPD8_LEN(PORTS_MODULE_ID i)
{
    switch (i) {
        case PORTS_ID_0 :
...
INLINE SFR_DATA _PORTS_REMAP_PIN_RPF6_LEN(PORTS_MODULE_ID i)
{
    switch (i) {
        case PORTS_ID_0 :
