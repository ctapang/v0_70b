...
PLIB_TEMPLATE void PORTS_RemapOutput_PIC32_2( PORTS_MODULE_ID      index , PORTS_REMAP_OUTPUT_FUNCTION function , PORTS_REMAP_OUTPUT_PIN      remapPin )
{
    _SFR_FIELD_WRITE( _PORTS_REMAP_PIN_RPA0_VREG(index) + remapPin,
					  _PORTS_REMAP_PIN_RPA0_MASK(index),
					  _PORTS_REMAP_PIN_RPA0_POS(index),
					  function );
}
