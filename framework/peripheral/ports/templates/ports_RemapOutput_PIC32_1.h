...
PLIB_TEMPLATE void PORTS_RemapOutput_PIC32_1( PORTS_MODULE_ID      index , PORTS_REMAP_OUTPUT_FUNCTION function , PORTS_REMAP_OUTPUT_PIN      remapPin )
{
    _SFR_FIELD_WRITE( _PORTS_REMAP_PIN_RPB0_VREG(index) - 2 + remapPin,
					  _PORTS_REMAP_PIN_RPB0_MASK(index),
					  _PORTS_REMAP_PIN_RPB0_POS(index),
					  function );
}
