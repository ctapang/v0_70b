...
#ifndef _POWER_P32MX250F128B_H
#define _POWER_P32MX250F128B_H
...
INLINE SFR_TYPE* _POWER_CMP3_CONTROL_VREG(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return &PMD2;
...
INLINE SFR_DATA _POWER_CMP3_CONTROL_MASK(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return _PMD2_CMP3MD_MASK;
        case POWER_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
INLINE SFR_DATA _POWER_CMP3_CONTROL_POS(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return _PMD2_CMP3MD_POSITION;
        case POWER_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
INLINE SFR_DATA _POWER_CMP3_CONTROL_LEN(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return _PMD2_CMP3MD_LENGTH;
        case POWER_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
