...
INLINE SFR_TYPE* _POWER_SPI5_CONTROL_VREG(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return &PMD5;
...
INLINE SFR_TYPE* _POWER_SPI6_CONTROL_VREG(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return &PMD5;
...
INLINE SFR_TYPE* _POWER_CAN1_CONTROL_VREG(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return &PMD5;
...
INLINE SFR_TYPE* _POWER_CAN2_CONTROL_VREG(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return &PMD5;
...
INLINE SFR_TYPE* _POWER_EBI_CONTROL_VREG(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return &PMD6;
...
INLINE SFR_TYPE* _POWER_CRYPTO_CONTROL_VREG(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return &PMD7;
...
INLINE SFR_DATA _POWER_SPI5_CONTROL_MASK(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_SPI6_CONTROL_MASK(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_CAN1_CONTROL_MASK(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_CAN2_CONTROL_MASK(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_EBI_CONTROL_MASK(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_CRYPTO_CONTROL_MASK(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return _PMD7_CRYPTMD_MASK;
        case POWER_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
INLINE SFR_DATA _POWER_SPI5_CONTROL_POS(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_SPI6_CONTROL_POS(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_CAN1_CONTROL_POS(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_CAN2_CONTROL_POS(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_EBI_CONTROL_POS(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_CRYPTO_CONTROL_POS(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return _PMD7_CRYPTMD_POSITION;
        case POWER_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
INLINE SFR_DATA _POWER_SPI5_CONTROL_LEN(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_SPI6_CONTROL_LEN(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_CAN1_CONTROL_LEN(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_CAN2_CONTROL_LEN(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_EBI_CONTROL_LEN(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
...
INLINE SFR_DATA _POWER_CRYPTO_CONTROL_LEN(POWER_MODULE_ID i)
{
    switch (i) {
        case POWER_ID_0 :
            return _PMD7_CRYPTMD_LENGTH;
        case POWER_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
