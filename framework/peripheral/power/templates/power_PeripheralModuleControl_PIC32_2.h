...
pmdPosition = source % 32;
	...
	{
		case 1: 
					return !(_SFR_BIT_READ(&PMD1, pmdPosition));
					
		case 2: 
					return !(_SFR_BIT_READ(&PMD2, pmdPosition));
					
		case 3: 
					return !(_SFR_BIT_READ(&PMD3, pmdPosition));
					
		case 4: 
					return !(_SFR_BIT_READ(&PMD4, pmdPosition));
					
		case 5: 
					return !(_SFR_BIT_READ(&PMD5, pmdPosition));
					
		case 6: 
					return !(_SFR_BIT_READ(&PMD6, pmdPosition));
					
		case 7: 
					return !(_SFR_BIT_READ(&PMD7, pmdPosition));
