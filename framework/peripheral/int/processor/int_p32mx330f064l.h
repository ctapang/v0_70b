...
typedef enum {
    ...
    INT_VECTOR_T2 = 0x40,
    INT_VECTOR_IC2 = 0x48,
    INT_VECTOR_IC2_ERROR = 0x48,
    INT_VECTOR_OC2 = 0x50,
    INT_VECTOR_INT2 = 0x58,
    INT_VECTOR_T3 = 0x60,
    INT_VECTOR_IC3 = 0x68,
    INT_VECTOR_IC3_ERROR = 0x68,
    INT_VECTOR_OC3 = 0x70,
    INT_VECTOR_INT3 = 0x78,
    INT_VECTOR_T4 = 0x80,
    INT_VECTOR_IC4 = 0x88,
    INT_VECTOR_IC4_ERROR = 0x88,
    INT_VECTOR_OC4 = 0x90,
    INT_VECTOR_INT4 = 0x98,
    INT_VECTOR_T5 = 0xA0,
    INT_VECTOR_IC5 = 0xA8,
    INT_VECTOR_IC5_ERROR = 0xA8,
    INT_VECTOR_OC5 = 0xB0,
    INT_VECTOR_SPI1_FAULT = 0xF0,
    INT_VECTOR_SPI1_RX = 0xF0,
    INT_VECTOR_SPI1_TX = 0xF0,
    INT_VECTOR_UART1_FAULT = 0xF8,
    INT_VECTOR_UART1_RX = 0xF8,
    INT_VECTOR_UART1_TX = 0xF8,
    INT_VECTOR_I2C1_BUS = 0x100,
    INT_VECTOR_I2C1_SLAVE = 0x100,
    INT_VECTOR_I2C1_MASTER = 0x100,
    INT_VECTOR_SPI2_FAULT = 0x118,
    INT_VECTOR_SPI2_RX = 0x118,
    INT_VECTOR_SPI2_TX = 0x118,
    INT_VECTOR_UART2_FAULT = 0x120,
    INT_VECTOR_UART2_RX = 0x120,
    INT_VECTOR_UART2_TX = 0x120,
    INT_VECTOR_I2C2_BUS = 0x128,
    INT_VECTOR_I2C2_SLAVE = 0x128,
    INT_VECTOR_I2C2_MASTER = 0x128,
    INT_VECTOR_UART3_FAULT = 0x130,
    INT_VECTOR_UART3_RX = 0x130,
    INT_VECTOR_UART3_TX = 0x130,
    INT_VECTOR_UART4_FAULT = 0x138,
    INT_VECTOR_UART4_RX = 0x138,
    INT_VECTOR_UART4_TX = 0x138,
    INT_VECTOR_UART5_FAULT = 0x140,
    INT_VECTOR_UART5_RX = 0x140,
    INT_VECTOR_UART5_TX = 0x140,
    INT_VECTOR_CHANGE_NOTICE_A = 0X108,
    INT_VECTOR_CHANGE_NOTICE_B = 0x108,
    INT_VECTOR_CHANGE_NOTICE_C = 0x108,
    INT_VECTOR_CHANGE_NOTICE_D = 0x108,
    INT_VECTOR_CHANGE_NOTICE_E = 0x108,
    INT_VECTOR_CHANGE_NOTICE_F = 0x108,
    INT_VECTOR_CHANGE_NOTICE_G = 0x108,
    INT_VECTOR_PMP = 0x110,
    INT_VECTOR_PMP_ERROR = 0x110,
    INT_VECTOR_RTCC = 0xC8,
    INT_VECTOR_AD1 = 0xB8,
    INT_VECTOR_CMP1 = 0xD8,
    INT_VECTOR_CMP2 = 0xE0,
    INT_VECTOR_FSCM = 0xC0,
    INT_VECTOR_DMA0 = 0x150,
    INT_VECTOR_DMA1 = 0x158,
    INT_VECTOR_DMA2 = 0x160,
    INT_VECTOR_DMA3 = 0x168,
    INT_VECTOR_FCE = 0xD0
