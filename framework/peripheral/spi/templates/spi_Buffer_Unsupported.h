...
PLIB_TEMPLATE SPI_DATA_TYPE SPI_BufferRead_Unsupported( SPI_MODULE_ID index )
{
...
PLIB_TEMPLATE void SPI_BufferWrite_Unsupported( SPI_MODULE_ID index , SPI_DATA_TYPE data )
{
