/*******************************************************************************
  ...
  Summary:
    SPI PLIB Interface Header for common definitions
...
//******************************************************************************
/* Function:
    void PLIB_SPI_PrescaleSecondarySelect(SPI_MODULE_ID index,
                                          SPI_SECONDARY_PRESCALE prescale)
    
  Summary:
    Selects the seconday prescale for SPI Master mode.
    
  Description:
    This function selects the seconday prescale for SPI Master mode.
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    prescale        - One of the SPI_SECONDARY_PRESCALE enumeration values as the SPI master
                      secondary prescale
  ...
  Example:
    ...
    // Where MY_SPI_INSTANCE, is the SPI instance selected for use by the
    // application developer.
    PLIB_SPI_PrescaleSecondarySelect( MY_SPI_INSTANCE,
                           SPI_SECONDARY_PRESCALE_3);
    </code>

  Remarks:
    This function implements an operation of the secondary prescale select feature.
    This feature may not be available on all devices.  Please refer to the 
    specific device data sheet to determine availability or use "PLIB_SPI_ExistsSecondaryPrescale" 
    in your application to automatically determine whether this feature is available.
 */

void PLIB_SPI_PrescaleSecondarySelect(SPI_MODULE_ID index,
                                      SPI_PRESCALE_SECONDARY prescale);


//******************************************************************************
/* Function:
    void PLIB_SPI_PrescalePrimarySelect(SPI_MODULE_ID index,
                                        SPI_PRIMARY_PRESCALE prescale)

  Summary:
    Selects the primary prescale for SPI Master mode.
    
  Description:
    This function selects the primary prescale for SPI Master mode.
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    prescale        - One of the SPI_PRIMARY_PRESCALE enumeration values as the SPI master
                      primary prescale
  ...
  Example:
    ...
    // Where MY_SPI_INSTANCE, is the SPI instance selected for use by the
    // application developer.
    PLIB_SPI_PrescalePrimarySelect(MY_SPI_INSTANCE,
                                            SPI_PRIMARY_PRESCALE_4);
    </code>

  Remarks:
    This function implements an operation of the primary prescale select feature.
    This feature may not be available on all devices.  Please refer to the 
    specific device data sheet to determine availability or use "PLIB_SPI_ExistsPrimaryPrescale" 
    in your application to automatically determine whether this feature is available.
 */

void PLIB_SPI_PrescalePrimarySelect(SPI_MODULE_ID index,
                                    SPI_PRESCALE_PRIMARY prescale);
...
/* Function:
  ...
  Returns:
    ...
    - false - SPI shift register is not enpty
...
//******************************************************************************
/* Function:
    SPI_DATA_TYPE PLIB_SPI_BufferRead (SPI_MODULE_ID index)
  ...
  Returns:
     Returns the SPI_DATA_TYPE enumeration value.
...
//******************************************************************************
/* Function:
    void PLIB_SPI_BufferWrite (SPI_MODULE_ID index , SPI_DATA_TYPE data)
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    data            - Data of the type SPI_DATA_TYPE to written to the SPI buffer
...
// *****************************************************************************
// *****************************************************************************
// Section: SPI Peripheral Library Exists API Functions
// *****************************************************************************
// *****************************************************************************
...
/* Function :  PLIB_SPI_ExistsEnableControl( SPI_MODULE_ID index )
  ...
  Description:
    ...
    on the SPI module. When this function returns true, these functions are 
...
/* Function :  PLIB_SPI_ExistsTransmitBufferFullStatus( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the TransmitBufferFullStatus feature is 
    available on the SPI module. When this function returns true, this function 
...
/* Function :  PLIB_SPI_ExistsTransmitBufferEmptyStatus( SPI_MODULE_ID index )
  ...
  Description:
    ...
    on the SPI module. When this function returns true, this function is are
    supported on the device:
...
/* Function :  PLIB_SPI_ExistsPinControl( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the PinControl feature is available
    on the SPI module. When this function returns true, these functions are 
    supported on the device:
    - PLIB_SPI_PinEnable
    - PLIB_SPI_PinDisable
...
/* Function :  PLIB_SPI_ExistsCommunicationWidth( SPI_MODULE_ID index )
  ...
  Description:
    ...
    on the SPI module. When this function returns true, this function is
    supported on the device:
...
/* Function :  PLIB_SPI_ExistsOutputDataPhase( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the OutputDataPhase feature is available
    on the SPI module. When this function returns true, this function is
    supported on the device:
...
/* Function :  PLIB_SPI_ExistsClockPolarity( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ClockPolarity feature is available
    on the SPI module. When this function returns true, this function is
    supported on the device:
...
/* Function :  PLIB_SPI_ExistsMasterControl( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the MasterControl feature is available
    on the SPI module. When this function returns true, these functions are 
    supported on the device:
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsSecondaryPrescale( SPI_MODULE_ID index )

  Summary:
    Identifies whether the SecondaryPrescale feature exists on the SPI module.

  Description:
    This function identifies whether the SecondaryPrescale feature is available
    on the SPI module. When this function returns true, this function is
    supported on the device:
    - PLIB_SPI_PrescaleSecondarySelect
  ...
  Returns:
    - true   - The SecondaryPrescale feature is supported on the device
    - false  - The SecondaryPrescale feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_SPI_ExistsSecondaryPrescale( SPI_MODULE_ID index );


//******************************************************************************
/* Function :  PLIB_SPI_ExistsPrimaryPrescale( SPI_MODULE_ID index )

  Summary:
    Identifies whether the PrimaryPrescale feature exists on the SPI module.

  Description:
    This function identifies whether the PrimaryPrescale feature is available
    on the SPI module. When this function returns true, this function is
    supported on the device:
  ...
  Returns:
    - true   - The PrimaryPrescale feature is supported on the device
    - false  - The PrimaryPrescale feature is not supported on the device

  Remarks:
    None.
*/

bool PLIB_SPI_ExistsPrimaryPrescale( SPI_MODULE_ID index );
...
/* Function :  PLIB_SPI_ExistsBaudRate( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the BaudRate feature is available
    on the SPI module. When this function returns true, this function is
    supported on the device:
...
/* Function :  PLIB_SPI_ExistsBusStatus( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the BusStatus feature is available
    on the SPI module. When this function returns true, this function is
    supported on the device:
    - PLIB_SPI_IsBusy
...
/* Function :  PLIB_SPI_ExistsFIFOControl( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the FIFOControl feature is available
    on the SPI module. When this function returns true, these functions are 
    supported on the device:
    - PLIB_SPI_FIFOEnable
...
/* Function :  PLIB_SPI_ExistsFIFOCount( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the FIFOCount feature is available
    on the SPI module. When this function returns true, this function is
    supported on the device:
...
/* Function :  PLIB_SPI_ExistsFIFOShiftRegisterEmptyStatus( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the FIFOShiftRegisterEmptyStatus feature is available
    on the SPI module. When this function returns true, this function is
    supported on the device:
...
/* Function :  PLIB_SPI_ExistsFrameErrorStatus( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the FrameErrorStatus feature is available
    on the SPI module. When this function returns true, this function is
    supported on the device:
...
/* Function :  PLIB_SPI_ExistsBuffer( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the Buffer feature is available
    on the SPI module. When this function returns true, these functions are 
    supported on the device:
...
/* Function :  PLIB_SPI_ExistsBaudRateClock( SPI_MODULE_ID index )
  ...
  Description:
    This function identifies whether the BaudRateClock feature is available
    on the SPI module. When this function returns true, this function is
    supported on the device:
