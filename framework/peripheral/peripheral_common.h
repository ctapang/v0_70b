...
/* Register Operation:  Bit Read
  ...
  Remarks:
    ...
    boudaries, but if this macro is misused to span an alignment boundary,
    then atomicity is no longer guaranteed.
*/
...
/*******************************************************************************
  ...
  Example:
    ...
    {
        PLIB_ASSERT(NULL != pointer, "NULL Pointer passed ty MyFunc");
...
*/
        ...
        #define PLIB_ASSERT(test,message)   assert(test)
