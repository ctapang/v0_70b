...
/* Function:
  ...
  Summary:
    Enables the featue of generating interrupt on stop condition.

  Description:
    This function enables the featue of generating interrupt on stop condition.
...
/* Function:
  ...
  Summary:
    Disables the featue of generating interrupt on stop condition.

  Description:
    This function disables the featue of generating interrupt on stop condition.
...
/* Function:
  ...
  Summary:
    Enables the featue of generating interrupt on start condition.

  Description:
    This function enables the featue of generating interrupt on start condition.
...
/* Function:
  ...
  Summary:
    Disables the featue of generating interrupt on start condition.

  Description:
    This function disables the featue of generating interrupt on start condition.
...
/* Function:
  ...
  Parameters:
    ...
    sdaHoldTimeNs - SDA hold time in nano secconds.
...
/* Function:
  ...
  Returns:
    The 10-bit slave address to which the mocule is currently set to respond.
...
/*******************************************************************************
  ...
  Returns:
    - true      - If the second byte of the local 10-bit address has been
                  received
    - false     - If the second byte of the local 10-bit address has not been
                  received
...
/* Function:
  ...
  Returns:
    The 7-bit Slave mode address mask that the module is currenty using to
...
/* Function:
  ...
  Remarks:
    ...
    supported.  Refer to the specific device data sheet to determine whether
    his feature is supported for your device.
...
/* Function:
  ...
  Returns:
    The 10-bit slave address mask that the module is currenty using to
    determine to which addresses the module will respond.
...
/* Function:
  ...
  Remarks:
    This flag is set by hardware when an overflow error occurs.  It's status
    can be tested using the PLIB_I2C_TransmitterOverflowHasOccurred function.
    This flag must be cleared be cleared by software after the overflow error
    has been handled.  To handle the error, software must retry the write later
    after the PLIB_I2C_TransmitterByteSend function returns TRUE.
...
/* Function:
  ...
  Returns:
    ...
    - false       - If no receiver overflow occurred when a byte has been
    				received
...
/* Function:
  ...
  Remarks:
    This flag is set by hardware when an overflow error occurs.  It's status
    can be tested using the PLIB_I2C_ReceiverOverflowHasOccurred function.  This
    flag should be cleared be cleared by software after the overflow error has
    been handled by reading the byte in the receiver buffer.
	...
	This feature may not be available on all devices. Please refer to the
	specific device data sheet to determine availability or use
	PLIB_I2C_ExistsReceiverOverflow in your application to determine whether
	this feature is available.
*/
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsClockStretching( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsGeneralCall( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSMBus( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsHighFrequency( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsReservedAddressProtect( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsStopInIdle( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsIPMI( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsModuleEnable( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsStartDetect( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsStopDetect( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsArbitrationLoss( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsBusIsIdle( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsBaudRate( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSlaveAddress7Bit( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSlaveAddress10Bit( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSlaveAddressDetect( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsGeneralCallAddressDetect( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSlaveMask( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSlaveReadRequest( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSlaveDataDetect( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSlaveClockHold( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsMasterStart( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsMasterStartRepeat( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsMasterReceiverClock1Byte( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsMasterStop( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsTransmitterIsBusy( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsTransmitterByteSend( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsTransmitterByteComplete( I2C_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsTransmitterByteAcknowledge( I2C_MODULE_ID index )

  Summary:
    Identifies whether the TransmitterByteAcknowledge feature exists on the I2C module

  Description:
    This function identifies whether the TransmitterByteAcknowledge feature is available on the I2C module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsTransmitterOverflow( I2C_MODULE_ID index )

  Summary:
    Identifies whether the TransmitterOverflow feature exists on the I2C module

  Description:
    This function identifies whether the TransmitterOverflow feature is available on the I2C module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_I2C_ExistsReceivedByteGet( I2C_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ReceivedByteGet feature is available on the I2C module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsReceivedByteAcknowledge( I2C_MODULE_ID index )

  Summary:
    Identifies whether the ReceivedByteAcknowledge feature exists on the I2C module

  Description:
    This function identifies whether the ReceivedByteAcknowledge feature is available on the I2C module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsReceiverOverflow( I2C_MODULE_ID index )

  Summary:
    Identifies whether the ReceiverOverflow feature exists on the I2C module

  Description:
    This function identifies whether the ReceiverOverflow feature is available on the I2C module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSlaveInterruptOnStop( I2C_MODULE_ID index )

  Summary:
    Identifies whether the SlaveInterruptOnStop feature exists on the I2C module

  Description:
    This function identifies whether the SlaveInterruptOnStop feature is available on the I2C module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSlaveInterruptOnStart( I2C_MODULE_ID index )

  Summary:
    Identifies whether the SlaveInterruptOnStart feature exists on the I2C module

  Description:
    This function identifies whether the SlaveInterruptOnStart feature is available on the I2C module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSlaveBufferOverwrite( I2C_MODULE_ID index )

  Summary:
    Identifies whether the SlaveBufferOverwrite feature exists on the I2C module

  Description:
    This function identifies whether the SlaveBufferOverwrite feature is available on the I2C module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsDataLineHoldTime( I2C_MODULE_ID index )

  Summary:
    Identifies whether the DataLineHoldTime feature exists on the I2C module

  Description:
    This function identifies whether the DataLineHoldTime feature is available on the I2C module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSlaveBusCollisionDetect( I2C_MODULE_ID index )

  Summary:
    Identifies whether the SlaveBusCollisionDetect feature exists on the I2C module

  Description:
    This function identifies whether the SlaveBusCollisionDetect feature is available on the I2C module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsSlaveAddressHoldEnable( I2C_MODULE_ID index )

  Summary:
    Identifies whether the SlaveAddressHoldEnable feature exists on the I2C module

  Description:
    This function identifies whether the SlaveAddressHoldEnable feature is available on the I2C module.
    When this function returns true, these functions are supported on the device:
...
//******************************************************************************
/* Function :  PLIB_I2C_ExistsAcksequenceProgress( I2C_MODULE_ID index )

  Summary:
    Identifies whether the AcksequenceIsInProgress feature exists on the I2C module

  Description:
    This function identifies whether the AcksequenceIsInProgress feature is available on the I2C module.
    When this function returns true, these functions are supported on the device:
