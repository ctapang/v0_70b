...
//******************************************************************************
/* Function :  I2C_SlaveAddressWasDetected_Default

  Summary:
    Implements Default variant of PLIB_I2C_SlaveAddressWasDetected 

  Description:
    This template implements the Default variant of the PLIB_I2C_SlaveAddressWasDetected function.
*/

PLIB_TEMPLATE bool I2C_SlaveAddressWasDetected_Default( I2C_MODULE_ID index )
{
    /* TODO  */
}
