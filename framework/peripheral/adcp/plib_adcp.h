/*******************************************************************************
  ADCP - Analog to Digital Converter, Pipelined
  ...
  Summary:
    ADCP PLIB Interface Header for ADCP common definitions
  ...
  Description:
    ...
    this file are common to ADCP peripheral.
 *******************************************************************************/

// DOM-IGNORE-BEGIN
/*******************************************************************************
Copyright (c) 2010-2012 released Microchip Technology Inc.  All rights reserved.
...
/*************************************************************************
  ...
  Description:
    ...
    Structure labels identify the analog inputs associated with each bit
...
/* Function:
  ...
  Description:
    Returns the ready status of the Pipelined ADC.  The ADC must be ready 
    before operation.
...
/*  Function:
  ...
  Description:
    Places the Pipelined ADC module in a low power state. The feature is used
    in lieu of disabling the ADC when power reduction is needed. The Pipelined
    ADC can come out of low power state and be operational much faster
...
/*
  ...
  Description:
    Returns a result indicating which analog inputs have conversion
    results ready.
...
/* Function:
  ...
  Description:
    Returns the specified Pipelined ADC analog input conversion result.
...
/* Function:
  ...
  Description:
    ...
    inclusion in the channel scan sequence. If the input is a Class 1 or
  ...
  Remarks:
    ...
    help documentation for deatils on its use.
 */
...
/*  Function:
  ...
  Description:
    Configures the trigger source for Class 1 or Class 2 inputs. A call to
    this function is not required when the input is being used as part of a
    channel scan as the channel scan configure function also configures all
    trigger sources.
...
/* Function:
  ...
  Summary:
    Initiate a Global Software Trigger on the specified module.  

  Description:
    All inputs or scan list that is configured to trigger on the global 
    software trigger are triggered.
...
/* Function:
  ...
  Description:
    Forces a trigger of an individual Class 1 or Class 2 channel independent 
    of its configured trigger source.
...
/* Function:
  ...
  Description:
    Selects the alternate physical input for the specified S&H.
	
  Precondition:
    The function only applies to dedicated S&Hs (Class 1 Inputs). 
...
/* Function:
  ...
  Description:
    Selects the default physical input for the specified S&H.
...
/*
  ...
  Description:
    Selects the mode (single ended or differential) and encoding (unipolar
    or two's compliment) for the specified S&H.
...
/* Function:
  ...
  Description:
    Selects inputs, as determined by the input mask channel scan list for 
    inclusion in the global or global interrupt.
...
/* Function:
    void PLIB_ADCP_Configure( ADCP_MODULE_ID index, 
            ...
            bool fractionalOutputOn,            // result format fractionl
  ...
  Summary:
    Configures the Pipelined ADC converter including the ADC calibration registers.

  Description:
    Configures all ADC parameters common to all inputs.  This configuration must occur prior to 
    enabling the ADC and therefore must be called when the ADC is disabled.
...
/*
  ...
  Description:
    Configures all parameters for the Digital Comparator module of the
    pipelined ADC.
  ...
  Example:
    ...
    PLIB_ADCP_DigCmpConfig( MY_ADCP_INSTANCE,  	// ADCP module ID
                          ...
                          FALSE,            // no test for greater then equal to high
                          FALSE,            // no test for less than high
                          FALSE,            // no test for greater then equal to low
...
/* Function:
  ...
  Description:
    ...
    Identifier for the input which caused the event or -1 if there was no
  ...
  Returns:
    ...
    which caused the event or -1 if no event has occured.
...
/* Function:
  ...
  Summary:
    Used to determine if the Oversampling Digital Filter has data ready.  

  Description:
    Used to determine if the ADCP digital filter has data ready. A TRUE 
        is returned when data is available which can be fetched using
  ...
  Returns:
    A boolean TRUE if data is ready or FALSE if not. . 
...
/* Function:
  ...
  Summary:
    Used to fetch the data result from the Oversampling Digital Filter.
...
/* Function :  PLIB_ADCP_ExistsChannelScan( ADCP_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelScan feature is available on the ADCP module.
    When this function returns true,    these functions are supported on the device: 
...
/* Function :  PLIB_ADCP_ExistsConversionResults( ADCP_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ConversionResults feature is available on the ADCP module.
    When this function returns true,    these functions are supported on the device: 
...
/* Function :  PLIB_ADCP_ExistsDigCmp( ADCP_MODULE_ID index )
  ...
  Description:
    This function identifies whether the DigitalComparator feature is available on the ADCP module.
    When this function returns true,    these functions are supported on the device: 
...
/* Function :  PLIB_ADCP_ExistsOsampDigFilter( ADCP_MODULE_ID index )
  ...
  Description:
    This function identifies whether the OsampDigitalFilter feature is available on the ADCP module.
    When this function returns true,    these functions are supported on the device: 
