...
#ifndef _ADC_RESULTGETBYINDEX_PIC32_H
#define _ADC_RESULTGETBYINDEX_PIC32_H
...
//******************************************************************************
/* Function :  ADC_ResultGetByIndex_pic32

  Summary:
    Implements pic32 variant of PLIB_ADC_ResultGetByIndex

  Description:
    This template implements the pic32 variant of the PLIB_ADC_ResultGetByIndex function.
*/

PLIB_TEMPLATE ADC_SAMPLE ADC_ResultGetByIndex_pic32( ADC_MODULE_ID index , uint8_t bufferIndex )
{
...
//******************************************************************************
/* Function :  ADC_ExistsResultGetByIndex_pic32

  Summary:
    Implements pic32 variant of PLIB_ADC_ExistsResultGetByIndex

  Description:
    This template implements the pic32 variant of the PLIB_ADC_ExistsResultGetByIndex function.
*/

PLIB_TEMPLATE bool ADC_ExistsResultGetByIndex_pic32( ADC_MODULE_ID index )
{
    return true;
}


#endif /*_ADC_RESULTGETBYINDEX_PIC32_H*/
