/*******************************************************************************
  DMT Peripheral Library Interface Header
  ...
  Summary:
    Dead-man Timer (DMT) Peripheral Library interface header for Dead-man Timer 
    common definitions.

  Description:
    This header file contains the function prototypes and definitions of
    the data types and constants that make up the interface to the Dead-man
    Timer Peripheral Library for all families of Microchip microcontrollers. 
    The definitions in this file are common to the Dead-man Timer peripheral.
**************************************************************************/
...
/* Function:
  ...
  Description:
    This function performs the Step 1 Clearing of the DMT module. The DMT module should be cleared
    in two steps, within the interval determined by the Count Window before the DMT forces an NMI or device reset.
...
/* Function:
  ...
  Description:
    This function performs the Step 2 Clearing of the DMT module. The DMT module should be cleared
    in two steps, within the interval determined by the Count Window before the DMT forces an NMI or device reset.
...
/* Function:
  ...
  Remarks:
    ...
    Refer the datasheet of the specific device.
...
//******************************************************************************
/* Function:
    bool PLIB_DMT_EventOccured( DMT_MODULE_ID index )
  ...
  Example:
    ...
    PLIB_DMT_ClearStep1();
    //user code
    if( PLIB_DMT_EventOccured( DMT_ID_0 ))
    {
       //user code
    }
...
/* Function:
  ...
  Remarks:
    ...
    Refer the datasheet of the specific device to get the division factor
...
/* Function:
  ...
  Description:
    ...
    a total number of instructions for DMT timeout, a value determined by configuration bits.
  ...
  Remarks:
    ...
    Refer the datasheet of the specific device to get the association of the configuration bits
    corresponding to this postscaler value.
...
/* Function:
  ...
  Description:
    This function returns the DMT postscaler interval. The value will correspond to 
    a total number of instructions for DMT window, a value determined by configuration bits.
...
/******************************************************************************
  ...
  Summary:
    Returns the dead-man timer on/off(enable/disable) status.

  Description:
    Returns the 'true', if the dead-man timer is already ON. Otherwise returns
    'false'.
  ...
  Returns:
    true 	- If the dead-man timer is on
    false 	- If the dead-man timer is off
...
//******************************************************************************
/* Function :  PLIB_DMT_ExistsEnableControl( DMT_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_DMT_ExistsStatus( DMT_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_DMT_ExistsStep1( DMT_MODULE_ID index )

  Summary:
    Identifies whether the Step 1 Clear feature exists on the DMT module.
  ...
  Returns:
    - true   - The Step 1 Clear feature is supported on the device
    - false  - The Step 1 Clear feature is not supported on the device
...
/******************************************************************************
/* Function :  PLIB_DMT_ExistsStep2( DMT_MODULE_ID index )

  Summary:
    Identifies whether the Step 2 Clear feature exists on the DMT module.

  Description:
    This function identifies whether the Step 2 Clear feature is available on the 
    DMT module. When this function returns true, this function is supported on 
    the device:
    - PLIB_DMT_ClearStep2
  ...
  Returns:
    - true   - The Step 2 Clear feature is supported on the device
    - false  - The Step 2 Clear feature is not supported on the device
...
//******************************************************************************
/* Function :  PLIB_DMT_ExistsCounter( DMT_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_DMT_ExistsPostscalerValue( DMT_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_DMT_ExistsInterval( DMT_MODULE_ID index )
