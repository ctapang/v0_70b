...
//******************************************************************************
/* Function :  DMT_EventOccured_Default

  Summary:
    Implements Default variant of PLIB_DMT_EventOccured 

  Description:
    This template implements the Default variant of the PLIB_DMT_EventOccured function.
*/

PLIB_TEMPLATE bool DMT_EventOccured_Default( DMT_MODULE_ID index )
{
