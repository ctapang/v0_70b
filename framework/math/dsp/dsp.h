/*******************************************************************************
 Digital Signal Processing (DSP) Library
  ...
  Description:
    The DSP Library provides functions supplied by MIPS and Microchip that are
    optimized for performance on the microAptiv(TM) core of the PIC32MZ family of
    microcontrollers.  The library provides advanced mathematical operations
    for complex numbers, vector and matrix mathematics, digital filtering and
    transforms.
...
/* Function DSP_FilterFIR32:
  ...
  Summary:
    Performs a Finite Infitire Repspose filter on a vector.
...
/* Function DSP_FilterIIR16:
  ...
  Summary:
    Performs a single-sample cascaded biquad Infiite Impulse Response (IIR) filter.
  ...
  Description:
    ...
    elments, and must be set up in order of biquad a1, a2, b1, b2. A binary
...
/* Function DSP_FilterFIRDecim32:
 ...
 #define SKIP 3
  ...
  Remarks:
    Coefs are loaded into the arry with corresponding to the least delay first
        (C0, C(-1), C(-2)).
...
/* Function DSP_FilterFIRInterp32:
  ...
  Description:
    ...
    the input equvalent to (1/2^shift). The function will saturate the output if
...
/* Function DSP_FilterIIRBQ16_fast:
 ...
 //   a2 = 0.8647765642900187
  ...
  Remarks:
    ...
    This function is optimized with microAptive instructions.
*/
...
/* Function DSP_FilterIIRBQ16_parallel8_fast:
  ...
  Remarks:
    ...
    This is a Q15 fractional value.
    Binary gain globally has been applied to the first instance of expgain.
    This function is optimized with microAptive core instructions.
 */
...
/* Function DSP_VectorDivC:
  ...
  Parameters:
    outdata    - pointer to desination array of elements (_Q16)
...
/* Function DSP_VectorNegate:
  ...
  Parameters:
    outdata    - pointer to desination array of elements (int32_t)
    indata     - pointer to source array of elements (int32_t)
    N          - number of samples (int)
...
//                  -1,     1,      0.5,    0.1,    0.75,   0.5,    -1,     0.25
    ...
    DSP_VectorShift(inBufTestA, inBufTestB, Num, shiftVal);
...
/* Function DSP_VectorSumSquares16:
  ...
  Description:
    ...
    values. Scaling is done by binary shifting, after accumlation in a 32 bit
