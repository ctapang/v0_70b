/*******************************************************************************
  ...
  File Name:
    libq.h
  Summary:
    Optimized fixed point math functions for the PIC32MZ microAptiv<sup>TM</sup>
    core platform.
  Description:
    Fixed Point Library

    libq.h provides a library of fixed point math functions for the PIC32MZ
    platform. All functions are optimized for speed. This header file
    specifies characteristics of each function, including execution time,
    memory size, and resolution.
...
/* Function _LIBQ_Q16Div:
  ...
  Example:
    ...
    // quotient now equals 2;  ie.  (_Q16)0x00020000;
