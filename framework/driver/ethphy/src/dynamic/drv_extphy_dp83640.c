...
ETH_RESULT_CODE DRV_EXTPHY_MIIConfigure(DRV_HANDLE hClientObj, ETHPHY_CONFIG_FLAGS cFlags)
{
    ...
    DRV_ETHPHY_SMIWriteStart(hClientObj, PHY_REG_PAGESEL, PHY_ADDRESS, 0);

    DRV_ETHPHY_SMIReadStart(hClientObj, PHY_REG_RMII_BYPASS, PHY_ADDRESS);
    ...
    DRV_ETHPHY_SMIWriteStart(hClientObj, PHY_REG_RMII_BYPASS, PHY_ADDRESS, phyReg);    // update the RMII and Bypass Register
...
ETH_RESULT_CODE DRV_EXTPHY_MDIXConfigure(DRV_HANDLE hClientObj, ETH_OPEN_FLAGS oFlags)
{
    ...
    DRV_ETHPHY_SMIReadStart(hClientObj, PHY_REG_PHY_CTRL, PHY_ADDRESS);
    phyReg = DRV_ETHPHY_SMIReadResultGet(hClientObj);
    ...
    DRV_ETHPHY_SMIWriteStart(hClientObj, PHY_REG_PHY_CTRL, PHY_ADDRESS, phyReg);
