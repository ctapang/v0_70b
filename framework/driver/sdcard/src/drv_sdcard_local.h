...
#define _DRV_SDCARD_VERSION_MINOR         2
#define _DRV_SDCARD_VERSION_PATCH         0
#define _DRV_SDCARD_VERSION_TYPE          "Alpha"
#define _DRV_SDCARD_VERSION_STR           "0.2.0 Alpha"
...
typedef enum
{
    ...
    /* Read back the data till the card is not busy */
