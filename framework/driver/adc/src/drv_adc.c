...
)
{
    ...
    /* Sample acquisition tiem selection */
...
/*******************************************************************************
  ...
  Description:
    ...
    is already initilized and the it wants to change the Initialization. An instance 
...
)
{
    ...
    {
        /* The driver can atmost return the sample set array - 1, 
    ...
    /* nidhi : The next sample set in this case will be clientSampleSet + 1
