...
#define GFX_DRV_SSD1926_COMMANDQUEUESIZE 480
...
// *****************************************************************************
/*
  Function: uint16_t GFX_DRV_SSD1926_PixelPut(uint16_t color,short x, short y)
...
//DOM-IGNORE-END
#endif //defined(GFX_USE_DISPLAY_CONTROLLER_SSD1926)
