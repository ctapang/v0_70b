...
/* TMR driver configuration
  ...
  Summary:
    Sets up the driver functionlity in either split or the unified mode.

  Description:
    This definition sts up the driver functionlity in either split or the 
    unified mode.
...
/* TMR mode configuration
  ...
  Description:
    This macro controls the mode of the Timer, and selects whether the timer
    is to support 8-bit, 16-bit or 32-bit mode. The acceptable values of this
    configuration are:
...
/* TMR Peripheral ID Selection
  ...
  Description:
    This macro selects the Timer peripheral ID. This is an intialization
    override of the tmrID member of the intialization configuration.
...
// *****************************************************************************
// *****************************************************************************
/* This section defines the optional features available in the driver */
...
/* Alarm feature configuration option
  ...
  Remarks:
    This is an optional feature. If the user wants to be called after a time
...
/* Alarm type configuration option
  ...
  Description:
    This macro if defined, makes the alarm periodic. This macro can accept the
    following values:
