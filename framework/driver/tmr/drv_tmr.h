...
/* Function:
  ...
  Parameters:
    ...
    init            - Pointer to a data structure containing any data necessary 
                      to initialize the driver. This pointer may be null if the
                      user wants to provide the information via the respective
  ...
  Returns:
    ...
    argument to DRV_TMR_Reinitialize, DRV_TMR_Deinitialize, DRV_TMR_Tasks and 
...
/* Function:
  ...
  Precondition:
    The DRV_TMR_Initialize functino must have been called before calling this
    function.
...
/* Function:
  ...
  Description:
    This function gets the client-specfic status of the Timer driver associated 
...
/* Function:
  ...
  Summary:
    Updates the 8-bit timer's period
...
/* Function:
  ...
  Summary:
    Provides the 8-bit Timer's period.
...
/* Function:
  ...
  Summary:
    Updates the 8-bit Timer's initial count value
...
/* Function:
  ...
  Summary:
    Provides the 8-bit Timer's current counter value.
...
/* Function:
  ...
  Summary:
    Changes the Timer's synchronization mode.
  ...
  Remarks:
    The caller should stop the Timer/Counter before changing the synchronization
    mode and restart it afterward.
*/

void DRV_TMR_SyncModeSet( DRV_HANDLE handle, DRV_TMR_SYNC_MODE newMode );
...
/* Function:
  ...
  Summary:
    Provides the Timer's current synchronization mode.
...
/* Function:
  ...
  Remarks:
    On most processers, the Timer's base frequency is the same as the peripheral 
    bus clock.
*/
