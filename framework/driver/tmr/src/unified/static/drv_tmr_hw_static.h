/*******************************************************************************
  TMR Driver Build Variant implementation for static driver
  ...
  Summary:
    TMR driver build variant implementation for the static driver.
...
#ifndef _DRV_TMR_HW_STATIC_H
#define _DRV_TMR_HW_STATIC_H
...
#define _DRV_TMR_INDEX_GET(drvIndex)            DRV_TMR_INDEX
...
#define _DRV_TMR_DYN(statement)


// *****************************************************************************
/* Macro: _DRV_TMR_DYN( arg )
...
#define _DRV_TMR_DYN_ARG_COMMA(arg)
...
#define _DRV_TMR_DYN_RETURN_TYPE(type)      void
...
#define _DRV_TMR_DYN_RETURN(retVal)         return
...
#define _DRV_TMR_DYN_PARAM(param)
...
#define _DRV_TMR_DYN_PARAM_COMMA(param)
...
#define _DRV_TMR_ObjectIsValid(dObj)        (true)
...
#define _DRV_TMR_OBJ_ALLOCATE(drvIndex)     DRV_TMR_INDEX
...
/* Macro:
  ...
  Remarks:
     This macro is only defined for static builds when the external clock sync
     feature exists for the instance of the Timer in use.
*/
