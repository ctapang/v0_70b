/*******************************************************************************
  Timer Driver Client Static Handling Interfaces

  Company:
    Microchip Technology Incorported

  FileName:
    drv_tmr_client_single.c
  ...
  Description:
    ...
    DRV_TMR_CLIENTS_NUMBER is not defined in the system
    configuration.
*******************************************************************************/
...
DRV_TMR_CLIENT_OBJECT   _DRV_TMR_OBJ_MAKE_NAME ( gDrvTMRClientObj ) ;
