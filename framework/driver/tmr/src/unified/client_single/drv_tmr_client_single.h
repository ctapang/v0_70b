/*******************************************************************************
  Timer Driver Build Variant implementation for single open static driver

  Company:
    Microchip Technology Inc.

  File Name:
    drv_tmr_client_single.h

  Summary:
    TMR driver build variant implementation for single open static driver.
...
#ifndef _DRV_TMR_CLIENT_SINGLE_H
#define _DRV_TMR_CLIENT_SINGLE_H
...
#define _DRV_TMR_MC_ARG_COMMA(arg)
...
#define _DRV_TMR_MC_RETURN_TYPE(type)   void
...
#define _DRV_TMR_MC_RETURN(handle)  return
...
#define _DRV_TMR_ClientObjectAllocate(drvId)
...
#define  _DRV_TMR_MC_Test(c)    true


#endif // _DRV_TMR_CLIENT_SINGLE_H
