...
#define _DRV_TMR_VERSION_MINOR         2
#define _DRV_TMR_VERSION_PATCH         0
#define _DRV_TMR_VERSION_TYPE          'a'
#define _DRV_TMR_VERSION_STR           "0.02.00a"
...
typedef struct _DRV_TMR_OBJ_STRUCT
{
    ...
    _DRV_TMR_DECLARE_ALARM_COUNTER(uint32_t                 alarmCount);

    /* Alarm callback */
    _DRV_TMR_DECLARE_ALARM_CALLBACK(DRV_TMR_CALLBACK        alarmCallback);

    /* The array index associated with the object*/
    TMR_MODULE_ID                                           tmrId;

    /* Interrupt Source for TMR Interrupt */
    _DRV_TMR_STATIC_INT_SRC(INT_SOURCE                      interruptSource);
    ...
    _DRV_TMR_DECLARE_ALARM_FLAG(bool                        alarmInUse);
