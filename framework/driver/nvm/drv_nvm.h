/*******************************************************************************
  ...
  Description:
    ...
    interface definition for the NVM driver.
*******************************************************************************/
...
/* NVM Driver Buffer Status
  ...
  Summary
    Specifies the status of the buffer for the read, write and erase opeartions.
...
/* Function:
  ...
  Description:
    This routine initializes the NVM driver instance for the specified driver
  ...
  Remarks:
    ...
    unless DRV_NVM_Deinitialize is called to de-initialize the driver
    instance.
    ...
    DRV_NVM_Status operation. The system must use DRV_NVM_Status to find out
...
/* Function:
  ...
  Description:
    Deinitializes the specified instance of the NVM driver module, disabling
    its operation (and any hardware).  Invalidates all the internal data.

  Precondition:
    Function DRV_NVM_Initialize should have been called before calling this
    function.

  Parameters:
    object          - Driver object handle, returned from the
                      DRV_NVM_Initialize routine
  ...
  Remarks:
    ...
    the DRV_NVM_Status operation.  The system has to use DRV_NVM_Status to find
...
/* Function:
  ...
  Remarks:
    ...
    DRV_NVM_ClientStatus operation to find out when the module is in the ready
    state.
...
/* Function:
  ...
  Description:
    This routine gets the client-specfic status of the NVM driver associated
...
/* Function:
  ...
  Description:
    This routine erases the specified number of pages in flash memory. 
    It returns a buffer handle that can be queried by the DRV_NVM_BufferStatus()
    function to check for completion of the operation.  The target address 
    should be aligned on a DRV_NVM_PAGE_SIZE byte boundary.
    The number of bytes to write should be equal to or should be multiples
    of DRV_NVM_PAGE_SIZE.
  ...
  Parameters:
    ...
    numbytes     - Total number of pages to be erased expressed in bytes.
                   This should be equal to or a multiple of DRV_NVM_PAGE_SIZE.
