...
/*******************************************************************************
  Function:    
    void DRV_WIFI_SWMulticastFilterSet(t_wfMultiCastConfig *p_config);
 ...
 void DRV_WIFI_SWMulticastFilterSet(DRV_WIFI_SWMULTICAST_CONFIG *p_config)
{
    ...
    SYS_ASSERT((p_config->action <= DRV_WIFI_MULTICAST_USE_FILTERS), "");
...
void DRV_WIFI_RtsThresholdSet(uint16_t rtsThreshold)
{
    SYS_ASSERT((rtsThreshold <= DRV_WIFI_RTS_THRESHOLD_MAX), "");
