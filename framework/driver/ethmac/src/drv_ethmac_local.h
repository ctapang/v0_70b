...
typedef struct
{
    ...
    SYS_TICK            _linkUpTick;          // tick value when the link up sequence was started
    SYS_TICK            _linkWaitTick;          // tick value to wait for    
    ...
    unsigned int		rxOkPkts;
    unsigned int        rxBadPkts;
    unsigned int		rxFragError;
