...
/*******************************************************************************
  ...
  Remarks:
    ...
    <p>Replaces:<p><c><b>void EthMACOpen(ETH_OPEN_FLAGS oFlags, ETH_PAUSE_TYPE pauseType)</b></c>
 *****************************************************************************/
...
/*******************************************************************************
  ...
  Example:
    <code>
    DRV_ETHMAC_LibClose(DRV_ETHMAC_INSTANCE_DCPT* pMacD, ETH_CLOSE_DEFAULT);
    </code>

  Remarks:
    It does not free any allocated memory.
    <p>Replaces:<p><c><b>void EthClose(ETH_CLOSE_FLAGS cFlags)</b></c>
 *****************************************************************************/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    <p>Replaces:<p><c><b>ETH_RESULT_CODE EthRxBuffersAppend ( void *ppBuff[], int nBuffs, DRV_ETHMAC_BUFF_FLAGS rxFlags )</b></c>
 *****************************************************************************/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    buffer.
    <p>Replaces:<p><c><b>ETH_RESULT_CODE EthTxSendBuffer ( const void *pBuff, unsigned short int nBytes )</b></c>
 *****************************************************************************/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    <p>Replaces:<p><c><b>ETH_RESULT_CODE EthTxSendPacket ( const DRV_ETHMAC_PKT_DCPT *pPkt )</b></c>
 *****************************************************************************/
...
/*******************************************************************************
  ...
  Remarks:
    ...
    multiple buffers.
    <p>Replaces:<p><c><b>ETH_RESULT_CODE EthTxGetBufferStatus ( const void *pBuff, const DRV_ETHMAC_PKT_STAT_TX **pTxStat )</b></c>
 *****************************************************************************/
...
/*******************************************************************************
  Function:
    ETH_RESULT_CODE DRV_ETHMAC_LibTxGetPacketStatus(DRV_ETHMAC_INSTANCE_DCPT* pMacD, const DRV_ETHMAC_PKT_DCPT* pPkt, const DRV_ETHMAC_PKT_STAT_TX** pTxStat)
  ...
  Remarks:
    The returned pointer to the packet status is invalid after the
    DRV_ETHMAC_LibTxAcknowledgeBuffer/DRV_ETHMAC_LibTxAcknowledgePacket is called.
    <p>Replaces:<p><c><b>ETH_RESULT_CODE EthTxGetPacketStatus(const DRV_ETHMAC_PKT_DCPT* pPkt, const DRV_ETHMAC_PKT_STAT_TX** pTxStat)</b></c>
 *****************************************************************************/

ETH_RESULT_CODE DRV_ETHMAC_LibTxGetPacketStatus(DRV_ETHMAC_INSTANCE_DCPT* pMacD, const DRV_ETHMAC_PKT_DCPT* pPkt, const DRV_ETHMAC_PKT_STAT_TX** pTxStat);

// DOM-IGNORE-BEGIN
extern __inline__ ETH_RESULT_CODE __attribute__((always_inline)) DRV_ETHMAC_LibTxGetPacketStatus(DRV_ETHMAC_INSTANCE_DCPT* pMacD, const DRV_ETHMAC_PKT_DCPT* pPkt, const DRV_ETHMAC_PKT_STAT_TX** pTxStat)
{
...
/*******************************************************************************
  ...
  Remarks:
    ...
    <p>Replaces:<p><c><b>ETH_RESULT_CODE EthTxAcknowledgeBuffer ( const void *pBuff, DRV_ETHMAC_BUFF_AckF ackFnc, void* fParam )</b></c>
 *****************************************************************************/
...
/*******************************************************************************
  Function:
    ETH_RESULT_CODE DRV_ETHMAC_LibTxAcknowledgePacket(DRV_ETHMAC_INSTANCE_DCPT* pMacD, const DRV_ETHMAC_PKT_DCPT* pPkt, DRV_ETHMAC_BUFF_AckF ackFnc, void* fParam )
  ...
  Remarks:
    ...
    <p>Replaces:<p><c><b>ETH_RESULT_CODE EthTxAcknowledgePacket(const DRV_ETHMAC_PKT_DCPT* pPkt, DRV_ETHMAC_BUFF_AckF ackFnc, void* fParam )</b></c>
 *****************************************************************************/

ETH_RESULT_CODE DRV_ETHMAC_LibTxAcknowledgePacket(DRV_ETHMAC_INSTANCE_DCPT* pMacD, const DRV_ETHMAC_PKT_DCPT* pPkt, DRV_ETHMAC_BUFF_AckF ackFnc, void* fParam );

// DOM-IGNORE-BEGIN
extern __inline__ ETH_RESULT_CODE __attribute__((always_inline)) DRV_ETHMAC_LibTxAcknowledgePacket(DRV_ETHMAC_INSTANCE_DCPT* pMacD, const DRV_ETHMAC_PKT_DCPT* pPkt, DRV_ETHMAC_BUFF_AckF ackFnc, void* fParam )
{
...
/*******************************************************************************
  ...
  Remarks:
    ...
    <p>Replaces:<p><c><b>ETH_RESULT_CODE EthRxAcknowledgeBuffer ( const void *pBuff, DRV_ETHMAC_BUFF_AckF ackFnc, void* fParam )</b></c>
 *****************************************************************************/
...
/*******************************************************************************
  Function:
    ETH_RESULT_CODE DRV_ETHMAC_LibRxAcknowledgePacket (DRV_ETHMAC_INSTANCE_DCPT* pMacD,  const DRV_ETHMAC_PKT_DCPT* pPkt, DRV_ETHMAC_BUFF_AckF ackFnc, void* fParam )
  ...
  Remarks:
    ...
    ackFnc is just a helper that allows the application to call an acknowledge
    function for each received buffer in turn.
    <p>Replaces:<p><c><b>ETH_RESULT_CODE EthRxAcknowledgePacket ( const DRV_ETHMAC_PKT_DCPT* pPkt, DRV_ETHMAC_BUFF_AckF ackFnc, void* fParam )</b></c>
 *****************************************************************************/

ETH_RESULT_CODE DRV_ETHMAC_LibRxAcknowledgePacket (DRV_ETHMAC_INSTANCE_DCPT* pMacD,  const DRV_ETHMAC_PKT_DCPT* pPkt, DRV_ETHMAC_BUFF_AckF ackFnc, void* fParam );

// DOM-IGNORE-BEGIN
extern __inline__ ETH_RESULT_CODE __attribute__((always_inline)) DRV_ETHMAC_LibRxAcknowledgePacket(DRV_ETHMAC_INSTANCE_DCPT* pMacD, const DRV_ETHMAC_PKT_DCPT* pPkt, DRV_ETHMAC_BUFF_AckF ackFnc, void* fParam )
{
...
/*******************************************************************************
  ...
  Remarks:
    ...
    <p>Replaces:<p><c><b>ETH_RESULT_CODE EthRxGetBuffer ( void **ppBuff, const DRV_ETHMAC_PKT_STAT_RX **pRxStat )</b></c>
 *****************************************************************************/
...
/*******************************************************************************
  Function:
    ETH_RESULT_CODE DRV_ETHMAC_LibRxGetPacket (DRV_ETHMAC_INSTANCE_DCPT* pMacD,  DRV_ETHMAC_PKT_DCPT *pPkt, int *pnBuffs,
  ...
  Remarks:
    ...
    <p>Replaces:<p><c><b>ETH_RESULT_CODE EthRxGetPacket ( DRV_ETHMAC_PKT_DCPT *pPkt, int *pnBuffs, const DRV_ETHMAC_PKT_STAT_RX **pRxStat )</b></c>
 *****************************************************************************/
