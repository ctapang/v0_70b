...
typedef struct _tag_DRV_ETHMAC_DCPT_NODE
{
    ...
    DRV_ETHMAC_HW_DCPT          hwDcpt;     // the associated hw descriptor
...
{
    struct _tag_DRV_ETHMAC_DCPT_NODE*      next;       // next pointer in virtual space
    DRV_ETHMAC_HW_DCPT_TX            hwDcpt;     // the associated hw descriptor
...
{
    struct _tag_DRV_ETHMAC_DCPT_NODE*      next;       // next pointer in virtual space
    DRV_ETHMAC_HW_DCPT_RX            hwDcpt;     // the associated hw descriptor
