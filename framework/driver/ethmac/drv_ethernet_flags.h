/*******************************************************************************
  ...
  Description:
    This file provides the definition of commonly-used configuration enumerations
...
/* Ethernet PHY Configuration Flags
  ...
  Description:
    ...
    Used by: EXTPHY_MIIConfigure, DRV_ETHPHY_INIT structure, DRV_ETHPHY_Setup,
...
/* Ethernet Operation Result Codes
  ...
  Description:
    This enumeration defines the possible results of any of the Ethernet library 
    operations that have the possibilty of failing.  This result should be checked to
