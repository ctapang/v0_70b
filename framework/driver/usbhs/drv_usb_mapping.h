...
#include "driver/usbhs/drv_usb_static.h"
...
*/
     ...
     * means that the static mode is desired */
    ...
    #define _DRV_USB_MAKE_NAME(name)                        _DRV_USB_STATIC_API(DRV_USB_INDEX, name)
        ...
        #warning "Number of clients exceeds driver instances number. A driver instance can support one client only"
    #endif
...
*/
    ...
    #if !defined(DRV_USB_CLIENTS_NUMBER) // single client
        ...
        #define DRV_USB_ClientStatus(handle)                _DRV_USB_MAKE_NAME(ClientStatus)()
        ...
        #define DRV_USB_DEVICE_EndpointStallDisable(w, x)   _DRV_USB_MAKE_NAME(DEVICE_EndpointStallDisable)(x)
        
        #define DRV_USB_DEVICE_EndpointDisableAll(w, x)     _DRV_USB_MAKE_NAME(DEVICE_EndpointDisableAll)(x)
