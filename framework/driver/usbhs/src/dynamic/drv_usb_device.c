...
void DRIVER _DRV_USB_DEVICE_Initialize(DRV_USB_OBJ * drvObj, SYS_MODULE_INDEX index)
{
    ...
    /* At 198 MHz this count should get us
       more than 3 seconds. */
    count = 0x02285E40;
...
bool DRIVER DRV_USB_DEVICE_EndpointIsEnabled(DRV_HANDLE handle,
                                        USB_ENDPOINT endpointAndDirection)
{
...
bool DRIVER DRV_USB_DEVICE_EndpointIsStalled(DRV_HANDLE handle,
                                        USB_ENDPOINT endpointAndDirection)
{
    /* Return the state of the endpoint */
...
USB_ERROR DRIVER DRV_USB_DEVICE_EndpointStall(DRV_HANDLE handle,
                                    USB_ENDPOINT endpointAndDirection)
{
    int     direction;
    bool    interruptWasEnabled = false;
...
USB_ERROR DRIVER DRV_USB_DEVICE_EndpointStallClear(DRV_HANDLE handle,
                                    USB_ENDPOINT endpointAndDirection)
{
    int     direction;
    bool    interruptWasEnabled = false;
