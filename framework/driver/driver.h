/*******************************************************************************
  ...
  Description:
    ...
    peripheral that can be used without operating system support or that can be
    easily ported to a variety of operating systems.
...
#warning "This file to be included only by demo applications, library files should include the correct driver directly"
