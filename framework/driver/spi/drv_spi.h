...
#ifndef SYS_CLK_ClockFrequencyGet
...
#define DRV_SPI_INDEX_0         0  // SPI_ID_1 on PIC32MX250F128B
#define DRV_SPI_INDEX_1         1  // SPI_ID_2 on PIC32MX250F128B
...
/* Function:
  ...
  Remarks:
    ...
    unless DRV_SPI_Deinitialize is called to de-initialize the driver
...
/* Function:
  ...
  Description:
    De-initializes the specified instance of the SPI driver module, disabling
    its operation (and any hardware) and invalidates all of the internal data.
  ...
  Remarks:
    ...
    the DRV_SPI_Status operation.  The system has to use DRV_SPI_Status to find
...
/* Function:
  ...
  Precondition:
    The DRV_SPI_Initialize function must have been called before calling this
    function.
  ...
  Remarks:
    ...
    calling the reinitialize operation.  If that fails, the de-initialize
...
/* Function:
  ...
  Description:
    This function sets up the device communication parameters. Using this API
	user can have configurations like chip select and baud rate specific to a
	client. The driver will be able to switch the between clients dynamically.
	'DRV_SPI_CLIENT_SPECIFIC_CONTROL' must be defined in 'system_config.h'.
	This function is only useful for instance which has got multiple slaves.
...
/* Function:
  ...
  Summary:
    Registers a buffer for a read operation. Actual transfer will happen in the
    Task function.

  Description:
	Registers a buffer for a read operation. Actual transfer will happen in the
	Task function. The status of this operation can be monitored using
