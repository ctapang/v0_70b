/*******************************************************************************
  SPI Driver Client Static Handling Interfaces

  Company:
    Microchip Technology Incorported

  File Name:
    drv_spi_client_single.c
  ...
  Description:
    ...
    DRV_SPI_CLIENTS_NUMBER is not defined in the system configuration.
*******************************************************************************/
...
DRV_SPI_CLIENT_OBJECT   _DRV_SPI_OBJ_MAKE_NAME ( gDrvSPIClientObj ) ;
