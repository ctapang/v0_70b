...
#ifndef _DRV_SPI_HW_DYNAMIC_H
#define _DRV_SPI_HW_DYNAMIC_H
...
#define _DRV_SPI_OBJ( obj,mem )                         gDrvSPIObj[obj].mem
...
#define _DRV_SPI_INDEX_GET( drvIndex )                  ( drvIndex )
...
#define _DRV_SPI_DYN( statement )                       statement


// *****************************************************************************
/* Macro: _DRV_SPI_DYN_ARG( arg )
...
#define _DRV_SPI_DYN_ARG( arg )                         arg
...
#define _DRV_SPI_DYN_ARG_COMMA( arg )                   arg,
...
#define _DRV_SPI_DYN_RETURN_TYPE( type )                type
...
#define _DRV_SPI_DYN_RETURN( retVal )                   return( retVal )
...
#define _DRV_SPI_DYN_PARAM( param )                     param
...
#define _DRV_SPI_DYN_PARAM_COMMA( param )               param,
...
#define _DRV_SPI_DYN_Test( condition )                  ( condition )
...
#define _DRV_SPI_OBJ_ALLOCATE( drvIndex )               drvIndex
...
#define _DRV_SPI_BYTEQ( index )                         gDrvByteQ[index]


#endif // _DRV_SPI_HW_DYNAMIC_H
