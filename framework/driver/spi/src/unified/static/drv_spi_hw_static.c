/*******************************************************************************
  ...
  Description:
    ...
    DRV_SPI_INSTANCES_NUMBER is not defined in system configuration.
*******************************************************************************/
...
DRV_SPI_OBJECT   _DRV_SPI_OBJ_MAKE_NAME ( gDrvSPIObj ) ;
...
SPI_BUFFER   _DRV_SPI_OBJ_MAKE_NAME ( gDrvByteQ )[DRV_SPI_CONFIG_BYTE_Q_SIZE] ;
