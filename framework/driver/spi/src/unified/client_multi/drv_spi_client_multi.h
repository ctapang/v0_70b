/*******************************************************************************
  ...
  File Name:
    drv_spi_client_multi.h

  Summary:
    SPI Driver Build Variant implementation for dynamic driver configurations
...
#ifndef _DRV_SPI_CLIENT_MULTI_H
#define _DRV_SPI_CLIENT_MULTI_H
...
//#define _DRV_SPI_CLIENT_OBJ(obj,mem)                    gDrvSPIClientObj[obj].mem
...
#define _DRV_SPI_MC(statement)                          statement
...
#define _DRV_SPI_MC_ARG(arg)                            arg
...
#define _DRV_SPI_MC_ARG_COMMA(arg)                      arg,


// *****************************************************************************
/* Macro: _DRV_SPI_MC_PARAM(param)
...
#define _DRV_SPI_MC_PARAM(param)                        param


// *****************************************************************************
/* Macro: _DRV_SPI_MC_PARAM_COMMA(param)
...
#define _DRV_SPI_MC_PARAM_COMMA(param)                  param,
...
#define _DRV_SPI_MC_RETURN_TYPE(type)                   type
...
#define _DRV_SPI_MC_RETURN(handle)                      return(handle)


// *****************************************************************************
/* Macro: _DRV_SPI_MC_Test( condition )
...
#define _DRV_SPI_MC_Test( condition )                   ( condition )


// *****************************************************************************
/* Macro: _DRV_SPI_CLIENT_OBJ(index, clientObj)
...
#define _DRV_SPI_CLIENT_OBJ_ALLOCATE(drvId, clientObj)  (clientObj = drvId)


#endif // _DRV_SPI_CLIENT_MULTI_H
