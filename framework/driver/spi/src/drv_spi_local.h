...
#include "../drv_spi.h"
#include "drv_spi_variant_mapping.h"
...
#define _DRV_SPI_VERSION_MINOR         2
#define _DRV_SPI_VERSION_PATCH         0
#define _DRV_SPI_VERSION_TYPE          "Alpha"
#define _DRV_SPI_VERSION_STR           "0.2.0 Alpha"
...
typedef struct _DRV_SPI_OBJ
{
    ...
    /* Flag to inhibit further reception
    unless, a data is received */
    uint32_t                    		rxInhibit;
