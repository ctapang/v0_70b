...
/* SPI maximum number of clients
  ...
  Description:
    This definition selects the maximum number of clients that the SPI driver can
    support at run time.
...
/* SPI peripheral ID selection
  ...
  Description:
    This macro selects the SPI peripheral ID selection. This is an intialization
    override of the spiID member of the intialization configuration.

  Remarks:
    Note: Some devices also support SPI_ID_0.
*/
