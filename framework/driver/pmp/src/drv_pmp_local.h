...
// *****************************************************************************
/* PMP Driver Version Macros

  Summary:
    PMP driver version.

  Description:
    These constants provide PMP driver version information. The driver
    version is:
    DRV_PMP_VERSION_MAJOR.DRV_PMP_VERSION_MINOR.DRV_PMP_VERSION_PATCH.
    It is represented in DRV_PMP_VERSION as:
    MAJOR *10000 + MINOR * 100 + PATCH, so as to allow comparisons.
    It is also represented in string format in DRV_PMP_VERSION_STR.
    DRV_PMP_TYPE provides the type of the release when the release is alpha
    or beta. The functions DRV_PMP_VersionGet and DRV_PMP_VersionStrGet 
    provide interfaces to the access the version and the version string.

  Remarks:
    Modify the return value of DRV_PMP_VersionStrGet and the
    DRV_PMP_VERSION_MAJOR, DRV_PMP_VERSION_MINOR, DRV_PMP_VERSION_PATCH 
    and DRV_PMP_VERSION_TYPE.
*/

#define _DRV_PMP_VERSION_MAJOR         0
#define _DRV_PMP_VERSION_MINOR         1
#define _DRV_PMP_VERSION_PATCH         0
#define _DRV_PMP_VERSION_TYPE          "Alpha"
#define _DRV_PMP_VERSION_STR           "0.1.0 Alpha"
