/*******************************************************************************
  FTP private Defs for Microchip TCP/IP Stack
...
// FTP timeout, seconds
#define TCPIP_FTP_TIMEOUT                 	(180ul * SYS_TICKS_PER_SECOND)
...
typedef enum _TCPIP_FTP_CMD_SM
{
    ...
    TCPIP_FTP_CMD_SM_SEND_FINDFIRST,
    TCPIP_FTP_CMD_SM_SEND_FINDNEXT,
...
//FTP command state machine
	...
	SYS_TICK        	ftpSysTicklastActivity;   // Timeout keeper.
