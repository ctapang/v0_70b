...
TCPIP_MAC_RES 		ENC28_MACInitialize(TCPIP_MAC_MODULE_CTRL* const stackData, const TCPIP_MODULE_MAC_ENCJ60_CONFIG* initData);
TCPIP_MAC_RES 		ENC28_MACDeinitialize(const TCPIP_MAC_MODULE_CTRL* const stackData );
TCPIP_MAC_HANDLE 	ENC28_MACOpen( TCPIP_STACK_MODULE macId );

TCPIP_MAC_RES 		ENCX24_MACInitialize(TCPIP_MAC_MODULE_CTRL* const stackData, const TCPIP_MODULE_MAC_ENCJ600_CONFIG* initData);
TCPIP_MAC_RES 		ENCX24_MACDeinitialize(const TCPIP_MAC_MODULE_CTRL* const stackData );
