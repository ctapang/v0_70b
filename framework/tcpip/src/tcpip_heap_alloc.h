...
typedef enum
{
    ...
    TCPIP_HEAP_RES_IN_USE           = -5,   // heap in use, cannot be de-allocated
 ...
 *
 * Note:            The handler could be a signalling function, short
...
/*********************************************************************
 * Function:      bool  TCPIP_HEAP_TraceGetEntry(TCPIP_HEAP_HANDLE heapH, int entryIx, HEAP_TRACE_ENTRY* tEntry)
 *
 * PreCondition:    None
 *
 * Input:           heapH       - handle of a heap
 *                  entryIx     - index of the requested heap trace entry
 *                  tEntry      - address of a HEAP_TRACE_ENTRY taht will be updated with corresponding info
 *
 ...
 *                  big enough to accomodate all the modules.
 *
 *                  The moduleId is the one from tcpip.h::TCPIP_STACK_MODULE
 ********************************************************************/
...
/*********************************************************************
 * Function:      int  TCPIP_HEAP_TraceGetEntriesNo(TCPIP_HEAP_HANDLE heapH, bool getUsed)
 *
 * PreCondition:    None
 *
 * Input:           heapH       - handle of a heap
