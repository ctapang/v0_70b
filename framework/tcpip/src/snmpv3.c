...
static bool _SNMPv3_CheckIfValidInt(uint32_t* val);
static bool _SNMPv3_CheckIfv3ValidStructure(uint16_t* dataLen);
...
static bool _SNMPv3_CheckIfv3ValidOID(uint8_t* oid, uint8_t* len);
static bool _SNMPv3_CheckIfv3ASNNull(void);
...
static bool _SNMPv3_CheckIfValidIntDataType(uint8_t* wholeMsgPtr,uint16_t* pos, uint32_t* val );
static bool _SNMPv3_CheckIfValidV3StructAnd4ByteDataLen(uint8_t* wholeMsgPtr,uint16_t* pos, uint16_t* dataLen );
static uint8_t _SNMPv3_CheckIfValidAuthStructure(uint16_t* dataLen);
static void _SNMPv3_EngnIDFormulate(uint8_t fifthOctectIdentifier,TCPIP_NET_IF* snmpIntf);
...
/****************************************************************************
  ...
  Remarks:
  	None
***************************************************************************/
void TCPIP_SNMPv3_Initialize(TCPIP_NET_IF* netIf)
{
    ...
    _SNMPv3_EngnIDFormulate(fifthOctectIdentifier,netIf);
...
{
    Snmpv3StackDcptStubPtr->SnmpEngineTime.Val=TCPIP_SNMPv3_AuthEngineTimeTickGet()-Snmpv3StackDcptStubPtr->SnmpEngineTimeOffset;
...
***************************************************************************/	
uint8_t TCPIP_SNMPv3_WholeMsgBufferDataGet(uint8_t* getbuf, uint16_t* pos)
{
uint8_t* testPtr;
uint16_t* posPtr;
...
SNMP_ERR_STATUS TCPIP_SNMPv3_MsgProcessingModelProcessPDU(INOUT_SNMP_PDU inOutPdu)
{
	...
	if(inOutPdu == SNMP_REQUEST_PDU)
	{
        ...
        if (!_SNMPv3_CheckIfValidV3StructAnd4ByteDataLen(Snmpv3StackDcptStubPtr->InPduWholeMsgBuf.snmpMsgHead,&tempPos,(uint16_t*)&tempLen.w[0]))
			return SNMP_NO_CREATION;
		
		//Check and collect "msgID"
        if(! _SNMPv3_CheckIfValidIntDataType(Snmpv3StackDcptStubPtr->InPduWholeMsgBuf.snmpMsgHead,&tempPos,&tempLen.Val))
			return SNMP_NO_CREATION;	
        ...
        tempData = TCPIP_SNMPv3_WholeMsgBufferDataGet(Snmpv3StackDcptStubPtr->InPduWholeMsgBuf.snmpMsgHead,&tempPos);
		
		if ( !IS_OCTET_STRING(tempData) )
			return false;

        tempData=TCPIP_SNMPv3_WholeMsgBufferDataGet(Snmpv3StackDcptStubPtr->InPduWholeMsgBuf.snmpMsgHead,&tempPos);//Length byte of "msgFlags"
        tempData=TCPIP_SNMPv3_WholeMsgBufferDataGet(Snmpv3StackDcptStubPtr->InPduWholeMsgBuf.snmpMsgHead,&tempPos);//"msgFlag"
        ...
        if(! _SNMPv3_CheckIfValidIntDataType(Snmpv3StackDcptStubPtr->InPduWholeMsgBuf.snmpMsgHead,&tempPos,(uint32_t*)&tempLen.Val))
			return SNMP_NO_CREATION;	
	...
	else if(inOutPdu == SNMP_RESPONSE_PDU)
	{
        ...
        TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->IncmngSnmpPduMsgID.v[3],&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->IncmngSnmpPduMsgID.v[2],&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->IncmngSnmpPduMsgID.v[1],&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->IncmngSnmpPduMsgID.v[0],&Snmpv3StackDcptStubPtr->PduHeaderBuf);

		//Put "msgMaxSize"  type ASN_INT of length 4 bytes
        TCPIP_SNMPv3_DataCopyToProcessBuff(ASN_INT,&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(0x04,&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngnMaxMsgSize.v[3],&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngnMaxMsgSize.v[2],&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngnMaxMsgSize.v[1],&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngnMaxMsgSize.v[0],&Snmpv3StackDcptStubPtr->PduHeaderBuf);
...
SNMP_ERR_STATUS TCPIP_SNMPv3_UserSecurityModelProcessPDU(INOUT_SNMP_PDU inOutPdu)
{
	...
	if(inOutPdu == SNMP_REQUEST_PDU)
	{
        ...
        tempLen.Val=TCPIP_SNMPv3_WholeMsgBufferDataGet(Snmpv3StackDcptStubPtr->InPduWholeMsgBuf.snmpMsgHead,&tempPos);
		...
		else
		{
			...
			while( tempData--)
			{
               *ptr++ = TCPIP_SNMPv3_WholeMsgBufferDataGet(Snmpv3StackDcptStubPtr->InPduWholeMsgBuf.snmpMsgHead,&tempPos);
			}	
		}
        ...
        Snmpv3StackDcptStubPtr->SnmpInMsgAuthParamLen=tempData= TCPIP_SNMPv3_WholeMsgBufferDataGet(Snmpv3StackDcptStubPtr->InPduWholeMsgBuf.snmpMsgHead,&tempPos);
        ...
        Snmpv3StackDcptStubPtr->SnmpInMsgPrivParmLen=tempData =TCPIP_SNMPv3_WholeMsgBufferDataGet(Snmpv3StackDcptStubPtr->InPduWholeMsgBuf.snmpMsgHead,&tempPos);
	...
	else if(inOutPdu == SNMP_RESPONSE_PDU)
	{
        ...
        TCPIP_SNMPv3_DataCopyToProcessBuff(ASN_INT,&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(0x04,&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngineTime.v[3],&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngineTime.v[2],&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngineTime.v[1],&Snmpv3StackDcptStubPtr->PduHeaderBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngineTime.v[0],&Snmpv3StackDcptStubPtr->PduHeaderBuf);
		...
		{
            TCPIP_SNMPv3_DataCopyToProcessBuff(0x00,&Snmpv3StackDcptStubPtr->PduHeaderBuf); //Not supported with the Alpha Release.
		}
		putCntr = 0;
		...
		{
            TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpOutMsgPrivParmLen,&Snmpv3StackDcptStubPtr->PduHeaderBuf); //Not supported with the Alpha Release
...
SNMP_ERR_STATUS TCPIP_SNMPv3_ScopedPDUProcessing(INOUT_SNMP_PDU inOutPdu)
{
	...
	{		
		...
		if((Snmpv3StackDcptStubPtr->SnmpSecurityLevel & 0x02)==0x02)
		{
            contextIDlen=TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,Snmpv3StackDcptStubPtr->ScopedPduDataPos++) ;
            contextIDlen=TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,Snmpv3StackDcptStubPtr->ScopedPduDataPos++) ;
			if(contextIDlen == 0x81)
			{
                TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,Snmpv3StackDcptStubPtr->ScopedPduDataPos++) ;
			}
        ...
        if (!IS_OCTET_STRING(TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,Snmpv3StackDcptStubPtr->ScopedPduDataPos) ))
		{
			return SNMP_NO_CREATION;
		}
		...
		else
		{
            ...
            TCPIP_SNMPv3_DataCopyToProcessBuff(contextIDlen,&scopedPtr);
			while(contextIDlen!=0)	
			{
                TCPIP_SNMPv3_DataCopyToProcessBuff(TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos),&scopedPtr);
				contextIDlen-=1;
			}
		}
        ...
        TCPIP_SNMPv3_DataCopyToProcessBuff(OCTET_STRING,&scopedPtr);
        contextNameLength = (uint16_t)TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos);
		...
		{
            TCPIP_SNMPv3_DataCopyToProcessBuff(contextNameLength,&scopedPtr);
...
/****************************************************************************
  ...
  Remarks:
	None
 ***************************************************************************/
bool TCPIP_SNMPv3_V3MsgDataProcess(PDU_INFO* pduDbPtr)
{
	...
	while(1)
	{
		switch(smSnmp)
		{
			...
			// Before each variables are processed, prepare necessary header.
                ...
                pduDbPtr->pduType = TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos);
                pduLength = TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos);
				if(pduLength == 0x81)
				{
                    pduLength = TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos);
				}
			...
			case SM_RESPONSE_PDU_LEN_OFFSET:
                ...
                if(_SNMPv3_CheckIfValidInt(&tempVal.Val) != true)
				{					
                    TCPIP_SNMPv3_DynAllocMemFree();
					return false;
				}
			...
			case SM_ERROR_STATUS_OFFSET :
				...
				if(pduDbPtr->pduType != GET_BULK_REQUEST)
				{
					...
					tempVal.Val = 0;
                    if(! _SNMPv3_CheckIfValidInt(&tempVal.Val))
						return false;
			...
			case SM_FIND_NO_OF_REQUESTED_VARBINDS:
                ...
                if ( _SNMPv3_CheckIfv3ValidStructure(&varBindHeaderLen) == false)
				{
					noOfVarbindreq = 0;						
				}
			...
			case SM_POPULATE_REQ_OID:
				for(OIDlen=0;OIDlen<sizeof(OIDValue);OIDlen++)
					OIDValue[OIDlen]=0;
				OIDlen=0;
                if(_SNMPv3_CheckIfv3ValidOID(OIDValue,&OIDlen) == false)
				{
                    _SNMPv3_SetErrorStatus(errorStatusOffset,errorIndexOffset,SNMP_GEN_ERR,varIndex,dynScopedBufPtr);
                    bSnmpv3GenError = true;
                    break;
			...
			case SM_FIND_OID_IN_MIB:
				...
				oidLookUpRet = TCPIP_SNMP_OIDFindInMgmtInfoBase(pduDbPtr,OIDValue, OIDlen, &OIDInfo);	
				...
				case SM_MAX_REPETITIONS:
					...
					for(repeatCntr=0;repeatCntr<Getbulk_M;repeatCntr++)
					{
						...
						for(varBindCntr=0;varBindCntr<Getbulk_R;varBindCntr++)
						{
							...
							// Decode next object
                            if ( !_SNMPv3_CheckIfv3ValidOID(OIDValue, &OIDlen) )
							{
                                _SNMPv3_SetErrorStatus(errorStatusOffset,errorIndexOffset,SNMP_GEN_ERR,varIndex,dynScopedBufPtr);
                                bSnmpv3GenError = true;
                                break;
							...
							{
								tempRet = TCPIP_SNMP_NextLeafGet(&OIDInfo);
							}
							if(oidLookUpRet == false)
							{
								...
								if(snmpStkDcptMemStubPtr->appendZeroToOID)
								{
                                    ...
                                    if(TCPIP_SNMPv3_DataCopyToProcessBuff(OIDlen,dynScopedBufPtr) != true)
                                    {    
                                        bSnmpV3GetBulkResError = true;
                                        break;
                                    }
	...
	/* pass the data to wire*/
	{
		...
		*outBufPtr++=tempScopedData.head[i++];//0x30
		...
		{	
			TCPIP_SNMP_PutByte(snmpPktProcsMemPtrsInfo.snmpDcptPtr[intfIdx].skt,*(outBufPtr+i));
		}
...
static bool _SNMPv3_CheckIfValidInt(uint32_t* val)
{
    ...
    // Get variable type
    if (!IS_ASN_INT(TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos)))
        return false;

	// Integer length of more than 32-bit is not supported.
    tempLen = TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos);
    if ( tempLen > 4u)
        return false;
    ...
    tempData.Val = 0;
    while( tempLen-- )
        tempData.v[tempLen] = TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,
...
static bool _SNMPv3_CheckIfValidIntDataType(uint8_t * wholeMsgPtr,uint16_t* pos, uint32_t* val )
{
    ...
    // Get variable type
    if (!IS_ASN_INT(TCPIP_SNMPv3_WholeMsgBufferDataGet(lclWholeMsgPtr,pos)))
        return false;

	// Integer length of more than 32-bit is not supported.
    tempLen = TCPIP_SNMPv3_WholeMsgBufferDataGet(lclWholeMsgPtr,pos);
    if ( tempLen > 4u)
        return false;
    ...
    tempData.Val = 0;
    while( tempLen-- )
        tempData.v[tempLen] = TCPIP_SNMPv3_WholeMsgBufferDataGet(lclWholeMsgPtr,pos);
...
static bool _SNMPv3_CheckIfv3ValidStructure(uint16_t* dataLen)
{
    ...
    if ( !IS_STRUCTURE(TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos)) )
        return false;

    tempLen.Val = TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos);
    if ( tempLen.Val == 0x81) 
    {
        tempLen.Val = TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos);
    }
	...
	{
        tempLen.v[1] = TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos);
        tempLen.v[0] = TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos);
	}
...
static bool _SNMPv3_CheckIfValidV3StructAnd4ByteDataLen(uint8_t* wholeMsgPtr,uint16_t* pos, uint16_t* dataLen )
{
    ...
    if ( !IS_STRUCTURE(TCPIP_SNMPv3_WholeMsgBufferDataGet(wholeMsgPtr,pos)) )
        return false;


    tempLen.Val = TCPIP_SNMPv3_WholeMsgBufferDataGet(wholeMsgPtr,pos);
    if ( tempLen.Val == 0x81) 
    {
        tempLen.Val = TCPIP_SNMPv3_WholeMsgBufferDataGet(wholeMsgPtr,pos);
    }
	...
	{
        tempLen.v[1] = TCPIP_SNMPv3_WholeMsgBufferDataGet(wholeMsgPtr,pos);
        tempLen.v[0] = TCPIP_SNMPv3_WholeMsgBufferDataGet(wholeMsgPtr,pos);
	}
	else if(tempLen.Val == 0)
		return false;
    // Since we are using UDP as our transport and UDP are not fragmented,
...
uint16_t snmpPduLen;
	...
	while(snmpPduLen)
	{
        ...
        if(!_SNMPv3_CheckIfv3ValidStructure(&varBindLen))
			return false;
...
/* put engine ID stat value */	
    ...
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->UsmStatsEngineID.v[3],dynScopedBufPtr);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->UsmStatsEngineID.v[2],dynScopedBufPtr);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->UsmStatsEngineID.v[1],dynScopedBufPtr);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->UsmStatsEngineID.v[0],dynScopedBufPtr);
...
static bool _SNMPv3_CheckIfv3ValidOID(uint8_t* oid, uint8_t* len)
{
    ...
    if ( !IS_OID(TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos)) )
        return false;
    ...
    *len = tempLen;
	...
	while( tempLen-- )
	{
       *oid++ = TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos);
	}
	*oid=0xff;
    return true;
}
...
static bool _SNMPv3_CheckIfv3ASNNull(void)
{
    ...
    a = TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos);

	if (!IS_ASN_NULL(a))
			return false;

    // Fetch and verify that length value is zero.
    return (TCPIP_SNMPv3_ProcessBuffDataGet(Snmpv3StackDcptStubPtr->ScopedPduRequstBuf,++Snmpv3StackDcptStubPtr->ScopedPduDataPos) == 0u );
}
...
static uint8_t _SNMPv3_CheckIfValidAuthStructure(uint16_t* dataLen)
{
	...
	tempPos=Snmpv3StackDcptStubPtr->SnmpMsgBufSeekPos;
    authStructure = TCPIP_SNMPv3_WholeMsgBufferDataGet(Snmpv3StackDcptStubPtr->InPduWholeMsgBuf.snmpMsgHead,&tempPos);
...
bool TCPIP_SNMPv3_TrapMsgHeaderPDU(unsigned int targetIndex)
{
    ...
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->IncmngSnmpPduMsgID.v[3],&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->IncmngSnmpPduMsgID.v[2],&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->IncmngSnmpPduMsgID.v[1],&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->IncmngSnmpPduMsgID.v[0],&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);

	//Put "msgMaxSize"  type ASN_INT of length 4 bytes
    TCPIP_SNMPv3_DataCopyToProcessBuff(ASN_INT,&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(0x04,&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngnMaxMsgSize.v[3],&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngnMaxMsgSize.v[2],&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngnMaxMsgSize.v[1],&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngnMaxMsgSize.v[0],&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
	...
	*/
    ...
    TCPIP_SNMPv3_DataCopyToProcessBuff(ASN_INT,&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(0x04,&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngineTime.v[3],&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngineTime.v[2],&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngineTime.v[1],&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
    TCPIP_SNMPv3_DataCopyToProcessBuff(Snmpv3StackDcptStubPtr->SnmpEngineTime.v[0],&Snmpv3StackDcptStubPtr->TrapMsgHeaderBuf);
...
uint8_t TCPIP_SNMPv3_TrapScopedPDU(SNMP_ID var, SNMP_VAL val, SNMP_INDEX index,uint8_t targetIndex)
{	
    uint8_t 			*ptr=NULL;
    uint8_t			contextName[]="";
	...
	pduStructLenOffset = dynTrapScopedPduBuf->length;
        ...
        TCPIP_SNMPv3_DataCopyToProcessBuff(4,dynTrapScopedPduBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(snmpStkDcptMemStubPtr->SNMPNotifyInfo.timestamp.v[3],dynTrapScopedPduBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(snmpStkDcptMemStubPtr->SNMPNotifyInfo.timestamp.v[2],dynTrapScopedPduBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(snmpStkDcptMemStubPtr->SNMPNotifyInfo.timestamp.v[1],dynTrapScopedPduBuf);
        TCPIP_SNMPv3_DataCopyToProcessBuff(snmpStkDcptMemStubPtr->SNMPNotifyInfo.timestamp.v[0],dynTrapScopedPduBuf);
        ...
        if (!TCPIP_SNMP_OIDStringFindByID(snmpStkDcptMemStubPtr->SNMPNotifyInfo.trapIDVar, &rec, OIDValue, &OIDLen) )
        {
#if defined (HARMONY_FS)		
            SYS_FS_FileClose(Snmpv3FileDescrptr);
#else
            SYS_FS_close(Snmpv3FileDescrptr);
#endif			
            TCPIP_UDP_Close(snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket);
            return false;
        }
        TCPIP_SNMPv3_DataCopyToProcessBuff(ASN_OID,dynTrapScopedPduBuf);
        len = OIDLen;
        ...
        if(!TCPIP_SNMP_OIDStringFindByID(snmpStkDcptMemStubPtr->SNMPNotifyInfo.agentIDVar,&rec, OIDValue, &OIDLen))
        {
                return false;
        }
...
#if defined (HARMONY_FS)
        SYS_FS_FileSeek(Snmpv3FileDescrptr, rec.hData, SYS_FS_SEEK_SET);
#else
        ...
        TCPIP_SNMPv3_DataCopyToProcessBuff(ASN_OID,dynTrapScopedPduBuf);
#if defined (HARMONY_FS)		
        SYS_FS_FileRead(&len,1,Snmpv3FileDescrptr);
#else
        ...
        while( len-- )
        {
            uint8_t c;
#if defined (HARMONY_FS)			
            SYS_FS_FileRead(&c,1, Snmpv3FileDescrptr);
#else
        ...
        // Get complete notification variable OID string.
        if ( !TCPIP_SNMP_OIDStringFindByID(var, &rec, OIDValue, &OIDLen) )
        {
           return false;
	}
...
bool TCPIP_SNMPv3_Notify(SNMP_ID var, SNMP_VAL val, SNMP_INDEX index,uint8_t targetIndex)
{
...
#if defined (HARMONY_FS)
    Snmpv3FileDescrptr = SYS_FS_FileOpen_Wrapper((const char*)SNMP_BIB_FILE_NAME,SYS_FS_FILE_OPEN_READ);
    if(Snmpv3FileDescrptr == SYS_FS_HANDLE_INVALID)
#else
    ...
    // set the SNMPv3 trap file descriptor to the SNMP file descriptor
    TCPIP_SNMP_FileDescrSet(Snmpv3FileDescrptr);
    ...
    *outBufPtr++=Snmpv3StackDcptStubPtr->TrapScopdPduRespnsBuf.head[i++];//0x30
    ...
    TCPIP_SNMP_PDUProcessDuplexInit(snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket);

    //total length number of bytes need to be passed to the wire
    Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgLen.Val = outBufPtr - Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgHead;

    i=0;
    TCPIP_SNMP_PutByte(snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket,Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgHead[i++]);		//0x30

    if(Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgHead[i] == 0x81)
    {
        TCPIP_SNMP_PutByte(snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket,Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgHead[i++]);//0x81
        TCPIP_SNMP_PutByte(snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket,Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgHead[i++]);//len_0
    }
    else if(Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgHead[i] == 0x82)
    {
        TCPIP_SNMP_PutByte(snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket,Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgHead[i++]); //0x82
        TCPIP_SNMP_PutByte(snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket,Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgHead[i++]); //len_1
        TCPIP_SNMP_PutByte(snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket,Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgHead[i++]); //len_0
    }
    else
        TCPIP_SNMP_PutByte(snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket,Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgHead[i++]);//len_o

    for(;i<Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgLen.Val;i++)
    {
        TCPIP_SNMP_PutByte(snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket,Snmpv3StackDcptStubPtr->TrapOUTPduWholeMsgBuf.wholeMsgHead[i]);
    }
    ...
    SYS_FS_close(Snmpv3FileDescrptr);
#endif
    TCPIP_UDP_Flush(snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket);
    TCPIP_UDP_Close(snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket);
    snmpStkDcptMemStubPtr->SNMPNotifyInfo.socket =  INVALID_UDP_SOCKET;
