...
#if defined(MEDIA_STORAGE_SPIRAM)

#include "tcpip/src/system/drivers/spi_ram.h"
...
void SPIRAMInit(void)
{
    ...
    #elif defined(__C32__)
        SPIRAM_SPIBRG = (SYS_CLK_PeripheralClockGet()-1ul)/2ul/SPIRAM_MAX_SPI_FREQ;
...
/*********************************************************************
 * Function:        void SPIRAMPutArray(uint16_t wAddress, const uint8_t *vData, uint16_t wLength)
 *
 * PreCondition:
 *
 * Input:
...
#endif //#if defined(MEDIA_STORAGE_SPIRAM)
