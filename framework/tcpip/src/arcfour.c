...
/*****************************************************************************
  Function:
	void TCPIP_ARC4_Initialize(ARCFOUR_CTX* ctx, uint8_t* key, uint16_t len)
...
/*****************************************************************************
  Function:
	void TCPIP_ARC4_Crypt(ARCFOUR_CTX* ctx, uint8_t* data, uint16_t len)
  ...
  Precondition:
	The encryption context ctx has been initialized with TCPIP_ARC4_Initialize.
