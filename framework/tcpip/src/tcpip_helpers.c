...
// returns a pointer to the current location in the packet segment for further copy
uint8_t* TCPIP_Helper_PacketCopy(TCPIP_MAC_PACKET* pPkt, uint8_t* pDest, uint8_t* startAdd, uint16_t len)
{
    TCPIP_MAC_DATA_SEGMENT* pSeg;
