...
static const TCPIP_STACK_MODULE_ENTRY  TCPIP_STACK_MODULE_ENTRY_TBL [] =
{
    ...
    {TCPIP_MODULE_DHCP_SERVER,   (tcpipModuleInitFunc)TCPIP_DHCPS_Initialize,           TCPIP_DHCPS_Deinitilize},              // TCPIP_MODULE_DHCP_SERVER,
#endif
    ...
    {TCPIP_MODULE_DNS_SERVER,    (tcpipModuleInitFunc)TCPIP_DNSS_Intialize,            TCPIP_DNSS_Deintialize},               // TCPIP_MODULE_DNS_SERVER,
#endif
...
#endif
#if defined(TCPIP_STACK_USE_DNS_SERVER)
    {temp_synch(TCPIP_DNSS_Task)},                        // TCPIP_MODULE_DNS_SERVER,
#endif
#if defined(TCPIP_STACK_USE_DYNAMICDNS_CLIENT)
