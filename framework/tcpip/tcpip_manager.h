 ...
 * Side Effects:    None
 *
 * Description:     This function performs the de-initialization of the TCPIP stack
 *
 * Note:            None
 */
...
/*********************************************************************
 * Function:        bool TCPIP_STACK_NetAddressSet(TCPIP_NET_HANDLE netH, IPV4_ADDR* ipAddress, IPV4_ADDR* mask, bool setDefault)
 *
 * PreCondition:    TCPIP stack should have been initialized by TCPIP_STACK_Initialize()
 *
 ...
 *
 * Example:			TCPIP_NET_HANDLE netH = TCPIP_STACK_NetHandleGet("PIC32INT");
 * 					TCPIP_STACK_NetAddressSet(netH, &myIPAddress);
 *
