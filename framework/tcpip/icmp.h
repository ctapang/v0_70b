...
/* Function:
  ...
  Returns:
    ...
    false otherwise (interface not ready for transmission)
  ...
  <code>
    ...
    if(TCPIP_ICMP_EchoRequestSend(&remoteAddress, mySequenceNumber, myId) )
    {
  ...
  Description:
    ...
    The callback will contain as parameters:
        ...
        - a 32 bit value containing the sequence number in the low 16 bit part
          and the identifier value in th ehigh 16 bit part.
...
/* Function:
  ...
  <code>
    ...
    if(hIcmp != 0)
    {
        ...
        // ...
        // later on, once ew're done, remove the notification handler
