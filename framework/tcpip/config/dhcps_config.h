...
#define DHCPS_IP_ADDRESS_RANGE_START		"192.168.100.100" // Address range is starting from 100, because the from 1 to 100 is reserved. Start address(192.168.100.1)
...
// DHCP server run time configuration details.
/*
typedef struct
{
