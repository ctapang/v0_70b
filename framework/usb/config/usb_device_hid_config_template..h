...
/* USB Device HID Maximum Number of Instances
  ...
  Description:
    ...
    with two HID function driver instances, HID 1 has a receive queue size of 2 and
    send queue size of 3, HID 2 has a receive queue size of 4 and send queue size
...
*/
#define USB_DEVICE_HID_QUEUE_DEPTH_COMINED /*DOM-IGONORE-BEGIN*/ 2 /*DOM-IGNORE_END*/
