...
/* CDC control line state.
  ...
  Description:
    This type identifies the CDC control line state information. This structure is 
    as per the USB protocol. Used for SET_CONTROL_LINE_STATE/GET_CONTROL_LINE_STATE
...
/* CDC serial response available information.
  ...
  Description:
    This type forms the CDC serial response available. Sent via the interrupt 
    IN end-point whenever there is a response available.
...
/* CDC ACM functional descriptor.
  ...
  Description:
    This type identifies the CDC ACM functional descriptor. This structure 
    is as per the USB protocol.
...
/* CDC Call Management functional descriptor.
  ...
  Description:
    This type identifies the CDC Call Management functional descriptor. 
