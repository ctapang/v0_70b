...
typedef enum
{
    ...
    /* This event occurs when a CDC Class Driver Write operation has completed
       ...
       event is generated after the application calls the USB_HOST_CDC_Wrte()
       function. The eventData parameter in the event call back function will be
...
/* USB Host CDC Class Driver Event Handler Function Pointer Type.
  ...
  Description:
    ...
    register a pointer to a CDC Class Driver events handling function who's
...
USB_HOST_CDC_RESULT USB_HOST_CDC_EventHandlerSet
    (USB_HOST_CDC_INDEX index, USB_HOST_CDC_EVENT_HANDLER eventHandler, uintptr_t context);
...
/* Function:
  ...
  Summary:
    This function requests serial state noitification data from the attached 
    CDC device.

  Description:
    This function requests serial state noitification data from the attached CDC
...
/* Function:
  ...
  Summary:
    This function sends a request to the attached to update it's break duration.

  Description:
    This function sends a request to the attached to update it's break duration.
    The function schedules a SEND BREAK control transfer.  If successful, the
    transferHandle parameter will contain a valid transfer handle, else it will
    contain USB_HOST_CDC_TRANSFER_HANDLE_INVALID. When completed, the CDC class
    driver will generate a USB_HOST_CDC_EVENT_SEND_BREAK_COMPLETE event.  The
    CDC Class driver does not support queuing of control transfers.  If a
    control transfer is in progress, this function will return with an error.
