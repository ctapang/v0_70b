...
//******************************************************************************
    ...
    #define GRID_MAX_COLUMNS(rw, cw)    ((rw - (GFX_OBJ_EMBOSS_SIZE * 2) + 1) / (cw + 1))
    #define GRID_MAX_ROWS(rh, ch)       ((rh - (GFX_OBJ_EMBOSS_SIZE * 2) + 1) / (ch + 1))
    #define GRID_WIDTH(c, cw)           ((GFX_OBJ_EMBOSS_SIZE * 2) + (c * (cw + 1)) - 1)
    #define GRID_HEIGHT(r, ch)          ((GFX_OBJ_EMBOSS_SIZE * 2) + (r * (ch + 1)) - 1)
...
typedef struct
{
    ...
    uint16_t    status;								// indicates the status of the Grid Item
} GRIDITEM;
...
/*********************************************************************
* Function: GRID *GridCreate(uint16_t ID, short left, short top, short right, short bottom, 
*			                 uint16_t state, short numColumns, short numRows, 
*							 short cellWidth, short cellHeight, GFX_OBJ_SCHEME *pScheme)
*
...
/*********************************************************************
* Function: GridClearCellState(GRID *pGrid, short column, short row, uint16_t state)
*
...
*
********************************************************************/
void    GridClearCellState(GRID *pGrid, short column, short row, uint16_t state);


/*********************************************************************
* Function: uint16_t GridDraw(void *pObj)
*
...
/*********************************************************************
* Function: *GridGetCell(GRID *pGrid, short column, short row, uint16_t *cellType)
*
* Overview: This function removes all grid items for the given Grid
*			and frees the memory used.
*			
...
*
********************************************************************/
void    *GridGetCell(GRID *pGrid, short column, short row, uint16_t *cellType);
...
/*********************************************************************
* Function: GridMsgDefault(uint16_t translatedMsg, void *pObj, GFX_GOL_MESSAGE *pMsg)
*
...
*
********************************************************************/
void    GridMsgDefault(uint16_t translatedMsg, void *pObj, GFX_GOL_MESSAGE *pMsg);

/*********************************************************************
* Function: GridTranslateMsg(void *pObj, GFX_GOL_MESSAGE *pMsg)
*
...
*
********************************************************************/
uint16_t    GridTranslateMsg(void *pObj, GFX_GOL_MESSAGE *pMsg);

/*********************************************************************
* Function: uint16_t    GridSetCell(GRID *pGrid, short column, short row, uint16_t state, void *data)
*
...
*
********************************************************************/
uint16_t    GridSetCell(GRID *pGrid, short column, short row, uint16_t state, void *data);

/*********************************************************************
* Function: GridSetCellState(GRID *pGrid, short column, short row, uint16_t state)
*
...
*
********************************************************************/
void    GridSetCellState(GRID *pGrid, short column, short row, uint16_t state);
