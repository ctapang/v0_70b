...
typedef enum
{
    GFX_GOL_BUTTON_FOCUSED_STATE    = 0x0001,  // Bit for focus state.
    GFX_GOL_BUTTON_DISABLED_STATE   = 0x0002,  // Bit for disabled state.
    GFX_GOL_BUTTON_PRESSED_STATE    = 0x0004,  // Bit for press state.
    GFX_GOL_BUTTON_TOGGLE_STATE     = 0x0008,  // Bit to indicate object will have a toggle behavior.
    GFX_GOL_BUTTON_TWOTONE_STATE    = 0x0100,  // Bit to indicate the object is a two tone type.
    GFX_GOL_BUTTON_NOPANEL_STATE    = 0x0200,  // Bit to indicate the object will be drawn without a panel
    ...
    GFX_GOL_BUTTON_DRAW_FOCUS_STATE = 0x2000,  // Bit to indicate focus must be redrawn.
    GFX_GOL_BUTTON_DRAW_STATE       = 0x4000,  // Bit to indicate object must be redrawn.
    GFX_GOL_BUTTON_HIDE_STATE       = 0x8000,  // Bit to indicate object must be removed from screen.
} GFX_GOL_BUTTON_STATE;

/*********************************************************************
* Overview: Defines the parameters required for a GFX_GOL_BUTTON Object.
*           The following relationships of the parameters determines
*           the general shape of the GFX_GOL_BUTTON:
