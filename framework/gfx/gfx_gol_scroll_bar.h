...
typedef enum
{
    GFX_GOL_SCROLLBAR_FOCUSED_STATE     = 0x0001,  // Bit for focus state.
    GFX_GOL_SCROLLBAR_DISABLED_STATE    = 0x0002,  // Bit for disabled state.
    GFX_GOL_SCROLLBAR_VERTICAL_STATE    = 0x0004,  // Bit to indicate the scroll bar is drawn with vertical orientation
    GFX_GOL_SCROLLBAR_SLIDER_MODE_STATE = 0x0010,  // Bit to indicate the scroll bar is in slider mode.

    GFX_GOL_SCROLLBAR_DRAW_THUMB_STATE  = 0x1000,  // Bit to indicate that only the thumb area will be redrawn
    GFX_GOL_SCROLLBAR_DRAW_FOCUS_STATE  = 0x2000,  // Bit to indicate focus must be redrawn.
    GFX_GOL_SCROLLBAR_DRAW_STATE        = 0x4000,  // Bit to indicate object must be redrawn.
    GFX_GOL_SCROLLBAR_HIDE_STATE        = 0x8000,  // Bit to indicate object must be removed from screen.
} GFX_GOL_SCROLLBAR_STATE;

/*********************************************************************
* Overview: Defines the parameters required for a slider/scrollbar Object.
*           Depending on the GFX_GOL_SCROLLBAR_SLIDER_MODE_STATE state bit slider or scrollbar mode
*           is set. If GFX_GOL_SCROLLBAR_SLIDER_MODE_STATE is set, mode is slider; if not set
*           mode is scroll bar. For scrollbar mode, focus rectangle is not drawn.
*
*********************************************************************/
typedef struct
{
...
// *****************************************************************************
/*  Function:
    void GFX_GOL_ScrollBarActionSet(uint16_t translatedMsg,
                                void *pObject,
                                GFX_GOL_MESSAGE *pMessage)
