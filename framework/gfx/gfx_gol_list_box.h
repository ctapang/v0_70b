...
typedef enum
{
    GFX_GOL_LISTBOX_FOCUSED_STATE        = 0x0001,  // Bit for focus state.
    GFX_GOL_LISTBOX_DISABLED_STATE       = 0x0002,  // Bit for disabled state.
    GFX_GOL_LISTBOX_SINGLE_SELECT_STATE  = 0x0010,  // Bit to indicate only one item can be selected.
    GFX_GOL_LISTBOX_DRAW_ITEMS_STATE     = 0x1000,  // Bit to indicate selected items of the object must be redrawn.
    GFX_GOL_LISTBOX_DRAW_FOCUS_STATE     = 0x2000,  // Bit to indicate focus must be redrawn.
    GFX_GOL_LISTBOX_DRAW_STATE           = 0x4000,  // Bit to indicate object must be redrawn.
    GFX_GOL_LISTBOX_HIDE_STATE           = 0x8000,  // Bit to indicate object must be removed from screen.
...
typedef enum
{
    GFX_GOL_LISTBOX_ITEM_STATUS_SELECTED = 0x0001, //#define LB_STS_SELECTED 0x0001  // Item is selected.
    GFX_GOL_LISTBOX_ITEM_STATUS_REDRAW   = 0x0002, //#define LB_STS_REDRAW   0x0002  // Item is to be redrawn.
...
// *****************************************************************************
/*  Function:
    int16_t GFX_GOL_ListBoxItemFocusSet(
                                GFX_GOL_LISTBOX *pObject,
                                uint16_t index)
