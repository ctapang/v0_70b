/*******************************************************************************
 Board support configuration file for PIC32 USB Digital Audio
 ...
 Summary:      
    PIC32 USB Digital Audio Accessory Board support configuration file.

 Description:
    This contains all the configuration that is required to be done for the 
    application running on PIC32 USB Digital Audio Accessory Board
*******************************************************************************/
...
/* BSP Switch.
  ...
  Description:
    This enumeration defines the Switch numbers for each switch on the PIC32 USB
    Digital Audio board.
...
{
    /* SWITCH 1 */
     SWITCH_1 = 1,//PORTS_BIT_POS_2,

    /* SWITCH 2 */
     SWITCH_2 = 2,//PORTS_BIT_POS_3,

    /* SWITCH 3 */
     SWITCH_3 = 3//PORTS_BIT_POS_7
}BSP_SWITCH;
...
/* BSP Switch state.
  ...
  Description:
    This enumeration defines the switch states.
...
/* LED Number.
  ...
  Description:
    This enumeration defines the LED numbers for each LED on the PIC32 USB
    Digital Audio Board.
...
{
    /* LED 1 */
    LED_1 = 1,//PORTS_BIT_POS_0,

    /* LED 2 */
    LED_2 = 2,//PORTS_BIT_POS_15,

    /* LED 3 */
    LED_3 = 3//PORTS_BIT_POS_13,
}BSP_LED;
